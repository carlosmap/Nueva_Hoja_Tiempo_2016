...
<form action="hdetiempoAnt.php" name=reporte method="post">
<?
...
//	$vacaciones[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'vac0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$enfermedad[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'enf0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$acciddetrabajo[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'acc0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$permisospacto[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'per0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$licencias[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'lic0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$sanciones[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'san0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//	$ausencias[1]="1";
	...
	$sql="SELECT * FROM Horas15Oct2009 WHERE cargo = 'aus0' AND unidad = $laUnidad AND fecha between $cadfecha";
...
//echo $encabSql . "<br>" ;
	...
	$sql="SELECT estadoAprobDivision, comentariosDivision, revisadoPorDivision, estadoAprobProyecto, comentariosProyecto,
		revisadoPorProyecto, RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto,
		 horas_registradas, clase_tiempo, resumen_trabajo, day(fecha) as dia, id_actividad, id_proyecto FROM Horas15Oct2009
...
<input name="verhoja" type="submit" class="Boton" value="Consultar" />
      ...
      <td align="right"><input name="Submit2" type="submit" class="Boton" onclick="MM_goToURL('parent','frm-GrabaTiempo.php');return document.MM_returnValue" value="P&aacute;gina principal Hoja  de tiempo" />        <?
...
<?php
	...
	$sql = "SELECT DISTINCT cargo AS Cargo FROM Horas15Oct2009
	...
	$sql="SELECT     distinct Horas15Oct2009.cargo, Proyectos.nombre AS NombreProyecto,  Horas15Oct2009.fecha,
	Horas15Oct2009.id_proyecto,Horas15Oct2009.resumen_trabajo
	FROM Horas15Oct2009 INNER JOIN Proyectos ON Horas15Oct2009.id_proyecto = Proyectos.id_proyecto
	WHERE     (Horas15Oct2009.unidad = $laUnidad) AND (Horas15Oct2009.fecha BETWEEN $cadfecha)
	ORDER BY Horas15Oct2009.fecha asc";
