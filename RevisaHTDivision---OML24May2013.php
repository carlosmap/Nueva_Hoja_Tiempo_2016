...
$sql="Select month(U.fechaIngreso) mesIngreso, year(U.fechaIngreso) anioIngreso, 
		U.fechaIngreso, U.fechaRetiro, U.retirado, U.unidad, U.nombre, U.apellidos, U.id_departamento, U.id_categoria, ";
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="TituloTabla2">
        ...
        <td width="5%" rowspan="2">Feca de ingreso y retiro</td>
	  ...
	  while ($reg=mssql_fetch_array($cursor)) {
		  ...
		  if( $pMes != '' && $pAno != '' ){
			  ...
			  if( $reg[anioIngreso] <= date('Y') && $reg[mesIngreso] <= date('m') )
				$ing = 1;
	  ...
	  <tr class="TxtTabla">
		...
		<td width="5%" align="center"><?	
			if( $reg[retirado] != '' || $reg[fechaRetiro] != '' )	
				...
				echo "Activo";
		?></td>
		<td width="10%" align="left"><b>Ingreso : </b>
