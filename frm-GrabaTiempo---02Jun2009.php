      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td width="22%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
			...
			//Gonzalo Rodriguez, Patricia Barón, Camilo Marulanda, Fernando Manjarrés, Fabio Sánchez
			if (($laUnidad == 12974) OR ($laUnidad == 15712) OR ($laUnidad == 14384) OR ($laUnidad == 11733) OR ($laUnidad == 13829) ) { ?>
			<tr>
			  <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
...
//			if (($_SESSION["sesUnidadUsuario"] == 12974 ) OR ($_SESSION["sesUnidadUsuario"] == 15712 ) ) {
			...
			if ( ($laUnidad == 12974) OR ($laUnidad == 15712) OR ($laUnidad == 14384) OR ($laUnidad == 14888) OR ($laUnidad == 15195) OR ($laUnidad == 14020) OR ($laUnidad == 3212) ) { 
