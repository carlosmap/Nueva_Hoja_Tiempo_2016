...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla"><select name="pDepto" class="CajaTexto" id="select" onChange="MM_callJS('document.form1.submit();')">
      ...
      <?
			  if (trim($pDivision) == "") {
				$qSql2="Select * from departamentos where id_division = 1 and estadoDpto = 'A'"  ;
			  }
			  else {
				$qSql2="Select * from departamentos where id_division =" . $pDivision . "  and estadoDpto = 'A' ";			  
			  }
  ...
  <tr>
	...
	?>
	<input name="usuVer" type="radio" value="A" onClick="MM_callJS('document.form1.submit();')" <? echo $selVusuA; ?> >
      Usuarios Activos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="usuVer" type="radio" value="R" onClick="MM_callJS('document.form1.submit();')" <? echo $selVusuR; ?> >
      Usuarios Retirados </td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr class="TituloTabla2">
        ...
        <td width="1%"><div align="center">Asigna<br>
          HT</div></td>
      </tr>
	  <?
      ...
      <tr class="TxtTabla">
		...
		','vAddA','scrollbars=yes,resizable=yes,width=500,height=430')" /></a>
		<? } ?>
		        </td>
        <td width="1%" align="center">
		<? if (trim($usuVer) == "A" ) { ?>
		<a href="#"><img src="img/images/No.gif" alt="Retirar usuario" width="12" height="16" border="0" onClick="MM_openBrWindow('upUsuariosRetira.php?cualUnidad=<? echo $reg[unidad] ; ?>','vRUsu','scrollbars=yes,resizable=yes,width=500,height=325')"></a>
		<? } ?>
		</td>
        <td width="1%" align="center">
		<? if (trim($usuVer) == "A" ) { ?>
		<a href="#"><img src="img/images/icoCuantia.gif" alt="Actualizar Salario" width="16" height="16" border="0" onClick="MM_openBrWindow('verSalarioUsuario.php?cualUnidad=<? echo $reg[unidad] ; ?>','winSalarioUsu','scrollbars=yes,resizable=yes,width=500,height=400')"></a>
		<? } ?>
		</td>
        <td width="1%" align="center">
		<? //if ($laUnidad == 12974) { ?>
		<a href="#"><img src="img/images/icoHT.gif" alt="Asignar Hoja de tiempo para diligenciar" width="14" height="16" border="0" onClick="MM_openBrWindow('addAsignaHT.php?cualUnidad=<? echo $reg[unidad] ; ?>','winSalarioUsu','scrollbars=yes,resizable=yes,width=500,height=400')"></a>		
		<? //} ?>
		</td>
      </tr>
	  <?
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <? if (trim($usuVer) == "A" ) { ?>
		  <input name="Submit3" type="submit" class="Boton" onClick="MM_goToURL('parent','ProgMantenimiento.php');return document.MM_returnValue" value="Mantenimiento">
          <input name="InsertarUsr" type="button" class="Boton" onClick="MM_openBrWindow('addUsuariosHT.php','addUsr','scrollbars=yes,resizable=yes,width=600,height=450')" value="Insertar">
		  <? } ?>
          &nbsp;</td>
        </tr>
      </table></td>
