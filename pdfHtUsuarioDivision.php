<?php
	...
	$sqlNombre = 'SELECT A.nombre, A.apellidos FROM Hojadetiempo.dbo.Usuarios A WHERE unidad ='.$unidad;
	...
	$fName = $unidad.'-'.ucfirst($info['nombre']).' '.ucfirst($info['apellidos']).'-'.$mesesFile[$cualMes].'_'.$cualVigencia;
	...
	*/
	...
	##	***
	$html = cabecera($unidad, $cualMes, $cualVigencia);
	
	$pdf->writeHTML($html, true, false, true, false, '');

	$tabla = infoHTUsuario($unidad, $cualMes, $cualVigencia);
	$pdf->writeHTML($tabla, true, false, true, false, '');
	
	$firmas = firmasHt($unidad, $cualMes, $cualVigencia);
	...
	$detalle = detalleHt($unidad, $cualMes, $cualVigencia);
