...
function validaFila(fila, horasValidaDia, numDeDia, diaSemanaF, horasFactPrevias){ 
...
//		alert(d);
	...
	//				alert(msg1);
				...
				alert (parseFloat(document.Form1.elements[campoCT].value);
				if ((parseFloat(document.Form1.elements[campoCT].value) > 4) && (parseFloat(document.Form1.elements[campoCT].value) != 11)) {
					...
					if ((parseFloat(diaSemanaF) >= 2) || (parseFloat(diaSemanaF) <= 5) ) {
						alert (diaSemanaF);
						//Verifica si hay registro de facturación para Clase de tiempo 1, 2 y/o 3 
						if (parseFloat(horasFactPrevias) == 0) {
							alert (horasFactPrevias);
							document.Form1.elements[d].value = "";
							alert("No puede grabar tiempo extra si previamente no se ha registrado tiempo normal. Por favor corrija la información. Debe registrar previamente facturación en clase de tiempo 1, 2 y/o 3 para registrar tiemp extra.");
						}
...
//					}
            ...
            <table width="100%"  border="0" cellspacing="1" cellpadding="0">
			  ...
			  ?>
				...
				<input name="<? echo $d2; ?>regDia<? echo $r; ?>" type="text" class="CajaTexto" id="<? echo $d2; ?>regDia<? echo $r; ?>" onBlur="validaFila(<? echo $r;?>, <? echo $horasAvalidarDia; ?>, <? echo $d2; ?>, <? echo $esDia; ?>, <? echo $horasFactCT_1_2_3; ?> )" onKeyPress="return acceptNum(event)" value="<? echo ${$mitxtregDia}; ?>" size="1">
				<? 
