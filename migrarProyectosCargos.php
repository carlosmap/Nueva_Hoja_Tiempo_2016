  ...
  <tr>
    <td >	<table width="100%"  cellspacing="1" class="fondo">
      ...
      <tr class="TxtTabla">
        <?
			  /***********
			  Inicio de la transacci&oacute;n de migraci&oacute;n para usuarios de Proyecto
			  ***********/
			  $okGuardarHT = "Si";
			  $okGuardarPD = "Si";
			  if($_POST["recarga"] == 2){
			  	$mssql_query(" BEGIN TRANSACTION ");	// Inicio de la Transacci&oacute;n en SQL Server
				$mysql_query(" START TRANSACTION "); // Inicio de la Transacci&oacute;n en MySQL
			  }
			  ?>
        <td><? echo $reg1a['unidad'] . " - " . ucwords(strtolower($reg1a['nombre'] . " " . $reg1a['apellidos'])); ?></td>
        <td align="center"><?
			  /*************************
			  Migraci&oacute;n del Usuario a Autorizados Impresi&oacute;n
			  *************************/
				...
				*************************/
				...
				if($elIdUsuario == 0){
					...
					//Toma el &uacute;ltimo user_id generado por MySql para pc_user en la sesi&oacute;n activa (evita problemas de concurrencia)
        ...
        <td align="center"><?
			  ...
			  while($reg1b = mssql_fetch_array($cursor1b)){
			  		/*************************
				    Migraci&oacute;n del Usuario a Autorizados Impresi&oacute;n (Cargos)
				    *************************/
					...
					/*************************
				    Migraci&oacute;n de los Cargos a Page Device
				    *************************/
        ...
        <?
			  /***********
			  Finalizaci&oacute;n de la transacci&oacute;n de migraci&oacute;n para usuarios de Proyecto
			  ***********/
				if($_POST["recarga"] == 2 ){
					if($okGuardarHT == "Si" && $okGuardarPD == "Si"){
