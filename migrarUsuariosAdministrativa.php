...
*/
/*
11 y 46: Div Administrativa
14: Gerencia General
*/
$sql1 = " select email, unidad
 from HojaDeTiempo.dbo.usuarios u, HojaDeTiempo.dbo.Departamentos D
 where u.id_departamento = D.id_departamento
 and (D.id_division = 11 or D.id_division = 46 or D.id_division = 14 )
 and U.retirado is null ";
			  ...
			  /*************************
				...
				*************************/
				if($_POST["recarga"] == 2){
					...
					//Se migra el usuario a pc_user_bcode si pretenece a la división administrativa
					$sqlMy2 = " INSERT INTO pc_user_bcode ( bil_id, user_id ) ";
					$sqlMy2 = $sqlMy2 . " VALUES ( ";
					$sqlMy2 = $sqlMy2 . " 34, ";
					$sqlMy2 = $sqlMy2 . " " . $elIdUsuario . " ";
					$sqlMy2 = $sqlMy2 . " ) ";
