	...
	?>			
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <input name="Submit5" type="submit" class="Boton" onclick="MM_openBrWindow('delHTtodaHT.php?cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winDelHTHT','scrollbars=yes,resizable=yes,width=1400,height=500')" value="Eliminar toda la Hoja de tiempo" />              </td>
            </tr>
          </table></td>
      </tr>
    </table>
