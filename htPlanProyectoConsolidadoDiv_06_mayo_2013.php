...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="TxtNota2" style="position:absolute; left:3px; top:55px; width: 639px; height: 30px;"> CONSOLIDADO POR DIVISION
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr>
	        <td width="15%" height="20" class="FichaInAct">Divisi&Oacute;n VS Proyectos    	    <td width="15%" height="20" class="FichaAct" > <a href="htPlanProyectoConsolidadoProy.php" class="FichaInAct1" >Usuarios por Proyecto</a></td>
...
?>
          <tr class="TxtTabla" >
            <td colspan="2" align="right" class="TxtTabla"><table width="100%" border="0">
              <tr>
                <td width="15%" class="TituloTabla2">Desde</td>
...
?>
                ...
                <td width="15%" class="TituloTabla2"> Hasta</td>
...
?>
          ...
          <tr class="TxtTabla" >
            <td width="20%" align="right" class="TituloTabla2">Empleado</td>
