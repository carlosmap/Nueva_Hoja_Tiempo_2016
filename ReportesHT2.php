...
$sql=$sql." 	UNION " ;
$sql=$sql." 	select id_proyecto " ;
$sql=$sql." 	from HojaDeTiempo.dbo.AutorizaVerFact " ;
$sql=$sql." 	where unidad = " . $laUnidad ;
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr class="TxtTabla">
        ...
        <td width="5%" align="center"><input name="Submit" type="submit" class="Boton" onClick="MM_goToURL('parent','rptcargaProyecto.php?cualProy=<? echo $reg["id_proyecto"] ?>');return document.MM_returnValue" value="Reporte Solicitudes y Vi&aacute;ticos"></td>
	  </tr>
	  <? } ?>
    </table>
