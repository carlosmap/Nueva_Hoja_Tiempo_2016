<?php
	...
	##	***
	$sql = 'Select dpt.nombre nDpt, dep.nombre nDep, sec.nombre nSec, dv.nombre nDiv, A.* From Hojadetiempo.dbo.Usuarios A
				...
				where A.Unidad = '.$laUnidad;
	$info = mssql_fetch_array(mssql_query($sql));	
	#	**
	$html = cabecera($laUnidad);
