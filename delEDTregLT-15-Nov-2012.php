...
//	$num_filas=mssql_num_rows($cur_des);
	...
	$sql_reg_desp="select COUNT(*)as cant from Actividades where id_proyecto=".$cualProyecto." and dependeDe=".$cualLC."  and ".$cualLT." < id_actividad";
