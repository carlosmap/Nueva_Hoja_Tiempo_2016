...
//12May2008
//Trae el nombre de los proyectos en los que el usuario tiene que autorizar horas solicitadas
$sql="Select S.*, P.nombre, P.codigo, P.cargo_defecto,  P.especial ";
$sql=$sql." from SolicitudHoras S, Proyectos P " ;
$sql=$sql." where S.id_proyecto = P.id_proyecto " ;
$sql=$sql." and S.unidadJefe = " . $laUnidad  ;
$sql=$sql." and S.mes = " . $pMes ;
$sql=$sql." and S.vigencia = " . $pAno ;
...
Especial</td>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">   VoBo para la solicitud de programaci&oacute;n a cargo de <? echo strtoupper($nombreempleado." ".$apellidoempleado); 	?></td>
  </tr>
</table>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="TituloTabla2">
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="TituloTabla2">
            ...
            <td width="5%">Cant. <br />
              Horas </td>
            <td width="12%">Comentarios solicitante </td>
            <td width="5%">Aprob</td>
            <td width="18%">Observaciones</td>
            <td width="5%">Para<br />
              Firma</td>
            <td width="7%">VoBo</td>
            <td width="12%">              Comentarios<br />
              VoBo </td>
            <td width="1%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
        </table>			</td>
	  ...
	  ?>
	   <tr class="TxtTabla">
		...
		$sSql=$sSql." and S.unidadJefe =" . $laUnidad ;
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="TxtTabla">
            ...
            <td width="4%" align="right"><? echo $sReg[cantidadHoras]; ?></td>
            <td width="12%">
...
<? }  ?></td>
            <td width="18%"><? echo $sReg[comentaDirector]; ?>&nbsp;</td>
...
<? }  ?>
			...
			<td width="1%">
			<? if ($sReg[validaJefe] != "1") {  ?>
			<a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upsolProgramacionJefe.php?cualMes=<? echo $pMes; ?>&cualAno=<? echo $pAno; ?>&cualSec=<? echo $sReg[secuencia]; ?>','solDir','scrollbars=yes,resizable=yes,width=725,height=350')" /></a>
			<? } ?>
			</td>
			<? } ?>
          </tr>
