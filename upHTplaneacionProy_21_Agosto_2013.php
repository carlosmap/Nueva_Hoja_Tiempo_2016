...
//	echo ("<script>window.close();MM_openBrWindow('htPlanProyectos03.php?cualProyecto=$miProyecto&lstLC=$fldLoteC&lstLT=$fldLoteT&lstDiv=$fldLoteDiv&opcID=$miActividad','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');
}
