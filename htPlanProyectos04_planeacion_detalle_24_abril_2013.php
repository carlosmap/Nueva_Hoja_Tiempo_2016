	...
	<form name="Form1" id="Form1" method="post" action="">
      ...
      <tr>
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla" >
            <td width="30%"  align="center"></td>
            <td colspan="2" rowspan="2"  align="center" ><table width="100%" border="0" cellpadding="0" cellspacing="1">
...
?>
                      <tr class="TxtTabla">
                        <td width="3%" rowspan="2" align="center" ><? if(trim($datos_parti["fechaRetiro"])!="") { ?> <img src="imagenes/Inactivo.gif" /> <? } ?></td>
