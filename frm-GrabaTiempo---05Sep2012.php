      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td width="22%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
			...
			//26Jul2012
			//Gonzalo Rodriguez, Patricia Barón, Camilo Marulanda, Fernando Manjarrés, Fabio Sánchez, Katherine Pinilla, Mary Guevara, María Angelica Cárdenas
			if ( ($linkRHT > 0) OR ($laUnidad == 12974) OR ($laUnidad == 15712) OR ($laUnidad == 14384) OR ($laUnidad == 11733) OR ($laUnidad == 13829) OR ($laUnidad == 900384) OR ($laUnidad == 18164) OR ($laUnidad == 17063)) { 
			?>
			<tr>
			  <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
