  ...
  <tr>
    ...
    MM_openBrWindow('pdfHtUsuario.php?laUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $reg[mes]; ?>&cualVigencia=<? echo $reg[vigencia]; ?>', 'winHTPdf', 'scrollbars=yes, resizable=yes, width=620, height=500')
      ...
      <?
		...
		#*/
	  ?>
      <input name="consultar" type="submit" class="Boton" id="consultar" value="Proyectos de aprobaci&oacute;n" onclick="MM_openBrWindow('lstHTProyectosVBPendiente.php?cualMes=<? echo $pMes; ?>&cualVigencia=<? echo $pAno; ?>', 'winHTPdf', 'scrollbars=yes, resizable=yes, width=470, height=650')" />
    </td>
  </tr>
  <tr>
...
HT?</td>
	  ...
	  <tr valign="top" class="TxtTabla">
        ...
        -->
        <input name="Submit" type="button" class="Boton" onclick="MM_openBrWindow('pdfHtUsuario.php?laUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $reg[mes]; ?>&cualVigencia=<? echo $reg[vigencia]; ?>', 'winHTPdf', 'scrollbars=yes, resizable=yes, width=620, height=500')" value="Generar PDF" />
        </td>
        </tr>
        <? }	#Cierrra if	?>
	  <? } ?>
