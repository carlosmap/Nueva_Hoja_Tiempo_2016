        ...
        <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="0">
		  ...
		  <table width="100%"  border="0" cellspacing="1" cellpadding="0">
            <tr class="TituloTabla2">
              ...
              <td width="33%">VoBo EDT  del proyecto </td>
            ...
            <tr valign="top" class="TxtTabla">
              ...
              <br />
              Fecha de VoBo: <? echo date("M d Y ", strtotime($reg05[fechaVoBo])); ?><br />
              VoBo. 
				<? 
				$muestraVoBoEDT = "NO";
              ...
              <td><? echo date("M d Y ", strtotime($reg05[fechaIniProy])); ?></td>
            </tr>
			<? } // while Reg5 ?>
            <tr class="TxtTabla">
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>Falta Perfilamiento de los botones </td>
            </tr>
            <tr>
              <td>Implementaci&oacute;n de la EDT con la plantilla </td>
            </tr>
            <tr>
              <td>Importaci&oacute;n de los datos </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right" class="TxtTabla">              <input name="Submit3" type="submit" class="Boton" onclick="MM_openBrWindow('pnfaddImport.php','winImport','width=500,height=250')" value="Importar EDT a partir de XLS" />
                <input name="Submit2" type="submit" class="Boton" onclick="MM_openBrWindow('addHtLoteControl.php','winHH','scrollbars=yes,resizable=yes,width=900,height=400')" value="Nuevo Lote de control" /></td></tr>
          </table>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="TxtTabla">&nbsp;</td>
