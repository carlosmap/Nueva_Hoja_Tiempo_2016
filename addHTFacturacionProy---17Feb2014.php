...
function validaFila(fila, horasValidaDia, numDeDia, diaSemanaF, horasFactPrevias, horasFact1o2o11, horasMaxHorarios, fechaAGrabar, diaFestivo){ 
	var v1,v2,v3, totVar, i, CantCampos, msg1, msg2, msg3, mensaje;
	var camposFijosEstaticos, camposDinamicosPre, camposDinamicos, camposDinamicosPost, totalCamposDinamicos, numPrimerResumen, CantCampos ;
	v1='s';
	v2='s';
...
//	alert(rDhasta);
	...
	alert ('Excogio clas de tiempo 6 7 8 o 9')
...
//					}
            ...
            <table width="100%"  border="0" cellspacing="1" cellpadding="0">
			  ...
			  ?>
				...
				$numHorasCT6=0;
				$sql22="SELECT SUM(horasMesF) horasCT6  ";
