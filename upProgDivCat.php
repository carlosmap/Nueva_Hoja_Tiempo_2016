...
if ($lValor != "") {
	...
	if ($lValor == 0) {
		...
		$query = "UPDATE ProgAsignaRecursosCat SET valorItem = " . $lValor ;	
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="lValor" type="text" class="CajaTexto" id="lValor" value="<? echo $zvalorItem; ?>"></td>
  </tr>
</table>
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
