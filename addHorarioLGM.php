...
if ($recarga == 2) {
	...
	$query = "INSERT INTO  Horarios (NomHorario, Lunes, Martes, Miercoles, Jueves, Viernes, Sabado, Domingo, localiza) " ;
...
//Valida que se haya ingresado el nombre del horario
	if (document.Form1.lNombre.value == '') {
		...
		mensaje = 'El campo Nombre de horario es obligatorio. \n'
//		alert('El campo Nombre de horario es obligatorio. \n');
	}
	if (document.Form1.lLocaliza.value == '') {
		document.Form1.recarga.value="1";
		mensaje = 'El código de localización es obligatorio. \n'
//		alert('El código de localización es obligatorio. \n');
	}
	if (mensaje=='') {
	  ...
	  <form action="" method="post" name="Form1" >
	    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr>
            ...
            <td colspan="8" class="TxtTabla"><input name="lNombre" type="text" class="CajaTexto" id="lNombre" size="100">
          ...
          <tr align="center" class="TxtTabla">
            <td width="14%"><input name="lLocaliza" type="text" class="CajaTexto" id="lLocaliza" size="10"></td>
	    ...
	    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td width="25%" align="right" class="TxtTabla"><input name="Submit" type="button" class="Boton" value="Grabar" onClick="enviar()"></td>
    </tr>
</table>
      </form>
  	</td>
