...
<form action="hdetiempoUP.php" name=reporte method="post">
<?
...
/*********************************************IMPRIME LAS HORAS FACTURADAS***********************************************/
		...
		while($filas){
			...
			//echo "<td nowrap><font face='Arial' size=1>$codproy <br> $nLocalizaActiv <br> $nElCodigoProyecto <br> $nCargoActiv </font>$imgMuestra</td>";
			...
			//echo "<td nowrap><font face='Arial' size=1>XX$codproy [$act] $nProyecto</font>$imgMuestra</td>";
