...
if ($recarga == "2") {
	...
	while ($s <= $cantItems) {
		...
		*/
		...
		if(${$elhProg} > 0) {		
			//Inserta y/o modifica el registro de acuerdo al valor establecido en $queHacer
			//ProgSumaGlobalUsu
			...
			if (${$queHacer} == "UP") {
				$query = "UPDATE ProgSumaGlobalUsu SET " ;
				$query = $query . " horasProgramadas = " . ${$elhProg}. ", ";	
				$query = $query . " valorProgramado =" . ${$elhCosto} . ", ";	
				$query = $query . " salarioBase =" . $pSalario ;
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr class="TxtTabla">
		  ...
		  <?
			...
			$sqlP="select * from ProgSumaGlobalUsu ";
		  ...
		  <input name="hProg<? echo $e; ?>" type="text" class="CajaTexto" id="hProg<? echo $e; ?>" value="<? echo $phorasProg; ?>" size="10" onBlur="calcularCosto(<? echo $e; ?>)">
          ...
          <td width="30%" align="center"><input name="hCosto<? echo $e; ?>" type="text" class="CajaTexto" value="<? echo $pvalorProg; ?>" size="25">
