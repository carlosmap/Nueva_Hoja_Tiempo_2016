...
?>
		...
		?>
          ...
          <tr class="TxtTabla" >
            <td colspan="2"  align="center" class="TxtTabla">&nbsp;  <input type="hidden" name="recarga" value="0" id="recarga" /></td>
            </tr>
          <tr class="TxtTabla" >


        	    <td  align="right">&nbsp; </td>
        	    <td colspan="2"  align="right"><input name="Consultar" onclick="envia0();" type="submit" class="Boton" id="Consultar" value="Consultar" /></td>
        	    <td  align="right">&nbsp;</td>
       	      </tr>
...
?>	
	<form name="Form2" id="Form2" method="post" action="http://www.ingetec.com.co/NuevaHojaTiempo/htPlanProyectos04_planeacion_detalle.php?cualProyecto=<?=$cualProyecto; ?>&LC=<?=$Lote_control; ?>&DIV=<?=$Division; ?>&ACT=<?=$Actividad; ?>&V=<?=$lstVigencia; ?>&T=<?=$Lote_trabajo; ?>">
                        <td width="5%" align="center" rowspan="<?=mssql_num_rows($cur_parti) ?>">
