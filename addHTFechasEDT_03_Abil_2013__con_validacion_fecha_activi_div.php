...
//			alert("ecntro");
			...
			for (i=1;i<=pCantItems;i++)
			{
				...
				//cuando el nivel de la actividad es 3, se almacena la fecha de ingreso y la de finalizacion, para validar la fecha de las actividades
				if(document.getElementById(nivels).value==3)
				{
	...
	//, por favor verifique las fechas ingresadas
						...
						else if (compare_fecha("<? echo $datos_fecha_ini_proyecto[mes]."/".$datos_fecha_ini_proyecto[dia]."/".$datos_fecha_ini_proyecto[ano]; ?>",document.getElementById(fechai).value))
						{  
	...
	//, por favor verifique las fechas ingresadas
						...
						{
							if(compare_fecha(fecha_inicio_div,document.getElementById(fechai).value))
							{
							...
							if(compare_fecha(document.getElementById(fechaf).value,fecha_final_div))
							{
								alert("La fecha de finalizaci\xf3n de la actividad "+document.getElementById(macros).value+" no debe ser superior a la fecha de finalizaci\xf3n de la división");
								error="si";
								break;
							}
