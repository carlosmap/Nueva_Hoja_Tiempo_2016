...
if(trim($recarga) == "")
{
	...
	$sql_total_act_divi="
	select SUM(valorActiv) as total_actividades FROM HojaDeTiempo.dbo.ActividadesRecursos where id_proyecto=683 and id_actividad in (
...
if(trim($recarga) == "2")
{
		...
		$sql_up_act="update Actividades set nombre='".$nom_division."', id_division=".$division." ";
		if($valo!=$valor)
		{
