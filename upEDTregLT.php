...
if(trim($recarga) == "2")
{
		...
		//actualizamos el LT
		$sql_up_lt="update Actividades set nombre='".$nombre."', id_encargado=".$encargado.",usuarioMod=".$_SESSION["sesUnidadUsuario"].",fechaMod=getdate() where id_proyecto=".$cualProyecto." and id_actividad=".$cualLT." and dependeDe=".$cualLC." and nivel=2";
		$cur_up_lt=mssql_query($sql_up_lt);
//echo $sql_up_lt." --- ".mssql_get_last_message(); 
		if  (trim($cur_up_lt) == "")  
		{
			$error="si";
		}	
