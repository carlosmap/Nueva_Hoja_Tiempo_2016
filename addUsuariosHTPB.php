...
//Realiza las validaciones de rigor
	...
	//SitioTrabajo, TipoContrato, Seccion, NombreCorto, unidadJefe, fechaIngreso, fechaRetiro, idEmpresa
	...
	$insertaUsr = $insertaUsr. " Seccion, NombreCorto, unidadJefe, fechaIngreso, idEmpresa )";
...
//	$insertaUsr = $insertaUsr. " NULL, NULL, '$SitioContrato', '$SitioTrabajo', '$TipoContrato', '$Seccion', '$NombreCorto', $pJefe ) ";
	...
	$insertaUsr = $insertaUsr. " '$Seccion', '$NombreCorto', $pJefe, '$lFechaInicio', $pEmpresa ) ";
	$cursorIns = mssql_query($insertaUsr) ;
	echo "Insertó Usuarios " . $cursorIns . "<br>";
   ...
   echo "Insertó Perfil " . $cursorPerfil . "<br>";
   ...
   echo "Insertó Salario " . $cursorSalario . "<br>";
	...
	function AgregarUsuarioIlimitadoActividad ($IdProy, $IdActiv, $Unidad, $clase){
		...
		echo "Insertó usuario ilimitado: " . $sql . "<br>";
		mssql_query($sql);
	}
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" bgcolor="#EAEAEA">
  ...
  <form action="addUsuariosHTPB.php" method="post" name = "addUsr" onSubmit="MM_validateForm('Unidad','','RisNum','Nombres','','R','Apellidos','','R','SitioContrato','','R','SitioTrabajo','','R','Email','','R','NombreCorto','','R','Salario','','RisNum','lFechaInicio','','R');return document.MM_returnValue">
  
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Ingreso de Usuarios Nuevos INGETEC S.A.X</td>
  </tr>
</table>
