...
//		echo "<br> Horas Mesr=" .  $horasLabMes;
		if ($nuevoTotalHoras > $horasLabMes) {
			echo ("<script>alert('No puede sobrepasar la cantidad de horas de oficina para el mes. Por favor corrija la información.');</script>");
		}
	//cierra 09Oct2008
		else {
...
<?
  ...
  <tr>
	...
	?>
    <input name="horasLabMes" type="hidden" id="horasLabMes" value="<? echo $horasLaboralesB; ?>">	</td>
  </tr>
  <tr>
