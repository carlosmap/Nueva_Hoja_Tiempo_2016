  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr class="TxtTabla">
        ...
        <td width="5%">
		<?  if ($muestraJefe == "1") { ?>
		<a href="#"><img src="imagenes/imgPrint.gif" alt="Estado Impresi&oacute;n" width="14" height="14" border="0" onClick="MM_openBrWindow('upAutorizaHTimprime.php?cualUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $miMesHT; ?>&cualAno=<? echo $MiAnnoHT; ?>','verUPImp','scrollbars=yes,resizable=yes,width=400,height=200')"></a>
		<? if ($cualImprimio == "1") {
				echo "OK";
			}
		 ?>		
