...
include ("../jpgraph/jpgraph_bar.php");
	...
	//calcula cual es el valor mayor
	function cal_val($val1,$val2)
	{
		$val1= (int) $val1;
		$val2=(int) $val2;
		if($val1<$val2)
...
//////////////////////////GRAFICO BARRAS "VALORES DEL PROYECTO" EN (htPlanProyectos04.PHP)
	function graficos_barra($val_proy,$val_fact,$val_planea,$titulo)
	{
...
//$val_planea=15000;
		...
		$datay3=array($val_planea,0);



		// Create the graph. These two calls are always required
		$graph = new Graph(695,289,'auto');
		...
		$b3plot->SetFillGradient('#963d3d',"#cd2323",GRAD_WIDE_MIDVER);
...
//	$valoresY=escala1($valoresY);
	...
	graficos_barra($val_proy,$val_fact,$val_planea,$titulo);
