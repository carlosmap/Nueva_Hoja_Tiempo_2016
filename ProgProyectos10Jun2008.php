...
if (($_SESSION["sesPerfilUsuario"] != "1") AND ($laUnidad != "14384")) {
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  ?>
	   <tr class="TxtTabla">
        ...
        <td width="10%"><? echo  trim($reg[codigo]) . "." . $reg[cargo_defecto] ; ?></td>
...
//PARA QUE CAMILO MARULANDA PUEDA REVISAR LA PROGRAMACIÓN DE TODO EL MUNDO
		...
		?>
		<input name="Submit5" type="submit" class="Boton" onclick="MM_openBrWindow('ProgProyectosGeneral.php?cualProyecto=<? echo $reg[id_proyecto]; ?>','winProgProyectos','scrollbars=yes,resizable=yes,width=700,height=500')" value="Prog. Divisi&oacute;n" />
		<? } ?>		</td>
	   </tr>
	  <? } ?>
	<? 
	...
	if ($laUnidad == 15320) { ?>
	  <tr class="TxtTabla">
	    <td width="1%">&nbsp;</td>
	     <td width="5%">594</td>
	     <td>Revision y Ajuste Tecnico del Estudio de Factibilidad del Proyecto Central Hidroelectrica el Quimbo</td>
	     <td width="10%">71.5</td>
	     <td width="20%">Gerardo Buitrago G&oacute;mez<br />
          Carlos Arturo Acero Bautista </td>
	     <td><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','ProgProyectosActiv.php?cualProyecto=594');return document.MM_returnValue" value="Actividades" /></td>
	     <td><input name="Submit4" type="submit" class="Boton" onclick="MM_goToURL('parent','ProgProyectosST.php?cualProyecto=594');return document.MM_returnValue" value="Sitios de trabajo" /></td>
	     <td>&nbsp;</td>
	     <td>&nbsp;</td>
	     <td>&nbsp;</td>
	     <td>&nbsp;</td>
