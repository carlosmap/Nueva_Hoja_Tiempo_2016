...
if(trim($recarga) == "2")
{
		...
		$sql_up_lc="update Actividades set nombre=upper('".$nombre."'), id_encargado=".$encargado.",usuarioMod=".$_SESSION["sesUnidadUsuario"].",fechaMod=getdate() where id_proyecto=".$cualProyecto." and id_actividad=".$cualLC." and nivel=1";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="TituloUsuario">Actualizar Lote de control</td>
  </tr>
</table>
