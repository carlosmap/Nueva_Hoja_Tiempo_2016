...
//	$insertaUsr = $insertaUsr. " '$Seccion', '$NombreCorto', $pJefe, '$lFechaInicio', $pEmpresa, '$lFechaNacimiento' ) ";
   ...
   //Cierra 31May2010
	...
	function AgregarUsuarioIlimitadoActividad ($IdProy, $IdActiv, $Unidad, $clase){
		...
		//especiales
		$sql = "EXEC spAgregarUsuarioIlimitadolocaliza " ;
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" bgcolor="#EAEAEA">
  ...
  <form action="addUsuariosHTlocaliza.php" method="post" name = "addUsr" onSubmit="MM_validateForm('Unidad','','RisNum','Nombres','','R','Apellidos','','R','SitioContrato','','R','SitioTrabajo','','R','Email','','R','NombreCorto','','R','lFechaInicio','','R','Salario','','RisNum','lFechaNacimiento','','R','Documento','','RisNum');return document.MM_returnValue">
