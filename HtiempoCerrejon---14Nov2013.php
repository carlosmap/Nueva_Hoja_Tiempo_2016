...
?>
<?php
if (($_SESSION["sesUnidadUsuario"] == 15712) OR ($_SESSION["sesUnidadUsuario"] == 12974) OR ($_SESSION["sesUnidadUsuario"] == 14386) OR ($_SESSION["sesUnidadUsuario"] == 14987) ) {
?>

<form action="HtiempoCerrejon.php" method="post" name="frm">
...
echo "<tr ><td class='tituloTabla'><b>Proyecto:</td><td class='txtTabla'>Proyecto Desviación Río Ranchería</td></tr>";
...
$sql="SELECT RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto, cargo,
		...
		WHERE     (fecha BETWEEN $cadfecha) AND (unidad = '$laUnidad') and id_proyecto = 19  and (cargo='170' or cargo='177' ) order by dia";
