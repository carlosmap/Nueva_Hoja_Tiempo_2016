...
$sql="Select H.unidad, U.nombre, U.apellidos, C.nombre nomCat, sum(horas_registradas) as totalHorasR  ";
$sql=$sql." from horas H, usuarios U , Categorias C " ;
...
$sql=$sql." group by H.unidad, U.nombre, U.apellidos, C.nombre  " ;
...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
      <tr>
        ...
        Usuarios Vs Actividades </td>
        <td width="15%" class="FichaInAct"><a href="ReportesHT4Det.php?cualProyecto=<? echo $cualProyecto; ?>&pMes=<? echo $pMes; ?>&pAno=<? echo $pAno; ?>" class="FichaInAct1" >Facturaci&oacute;n del Proyecto<br />
        Actividades Vs Usuarios </a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr class="TxtTabla">
        ...
        <td align="center"><? echo $reg[nomCat]; ?></td>
