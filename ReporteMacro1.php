...
$sql=$sql." from divisiones D, Usuarios U, Departamentos E  " ;
$sql=$sql."where D.id_division = E.id_division 
	       and E.id_departamento=U.id_departamento " ;
...
$sql00=$sql00." H.id_proyecto, P.nombre nomProyecto, H.clase_tiempo, sum(H.horas_registradas) hFacturadas, A.salarioBase, U.id_categoria, C.nombre nomCat, P.codigo, P.cargo_defecto,A.tiempo_asignado ";
$sql00=$sql00." , H.cargo ";
$sql00=$sql00." from Horas H, Proyectos P, Asignaciones A, Usuarios U, Departamentos D, Divisiones Z, Categorias C ";
...
$sql00=$sql00." and U.id_categoria = C.id_categoria ";
...
$sql00=$sql00." group by H.unidad, U.nombre, U.apellidos, D.nombre, D.id_departamento, Z.nombre, Z.id_division, H.id_proyecto, P.nombre, H.clase_tiempo, A.salarioBase, U.id_categoria, C.nombre, P.codigo, P.cargo_defecto,A.tiempo_asignado ";
$sql00=$sql00." , H.cargo ";
$sql00=$sql00." UNION ";
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
      <tr class="TituloTabla2">
        ...
        <td width="5%">Clase de tiempo </td>
		 <td width="5%">Horas Programadas </td>
      ...
      <tr class="TxtTabla">
        ...
        <td><? echo ucwords(strtolower($reg00[apellidos] . " " . $reg00[nombre] )); ?>
		<? 
		$elNomUsuario= ucwords(strtolower($reg00[apellidos] . " " . $reg00[nombre] )); 
		$excel.="$elNomUsuario\t"; 
		?>
		</td>
        <td width="3%"><? echo $reg00[nomCat]; ?>
		<? $excel.="'$reg00[nomCat]\t"; ?>
		</td>
        <td width="10%"><? echo $reg00[nomDpto]; ?>
		<? $excel.="$reg00[nomDpto]\t"; ?>
		</td>
        <td width="25%"><? echo "[" . $reg00[codigo] . "."  . $reg00[cargo_defecto] . "] " . $reg00[nomProyecto] . " (" . $reg00[cargo] . ") ";  ?>
		<? $excel.="[" . $reg00[codigo] . "."  . $reg00[cargo_defecto] . "] " . $reg00[nomProyecto] . " (" . $reg00[cargo] . ") \t" ; ?>
		</td>
		...
		$elhProgramadas = number_format($reg00[tiempo_asignado], 0, ",", ".") ;
		$excel.="$elhProgramadas\t"; ?>
        <td width="10%" align="right"><? echo number_format($reg00[tiempo_asignado], 0, ",", "."); ?>
