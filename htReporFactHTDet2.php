...
$mensaje= array('Cantidad planeados ','Cantidad facturados','Planeados con facturación','Facturación sin planeación','Planeados que no facturaron','Usuarios que sobrepasan lo planeado','Usuarios que estan por debajo de lo planeado');
		...
		$sql_usu_plane="select distinct PlaneacionProyectos.unidad, Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division from PlaneacionProyectos 
...
//echo $sql_usu_plane." <br>";
		...
		$sql_factu=" select  distinct FacturacionProyectos.unidad, Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division  from FacturacionProyectos 
...
//echo $sql_factu." <br>";
		...
		$sql_planea_fac="select  distinct PlaneacionProyectos.unidad, Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division  from PlaneacionProyectos 
		inner join Actividades on PlaneacionProyectos.id_proyecto=Actividades.id_proyecto and PlaneacionProyectos.id_actividad=Actividades.id_actividad
		...
		$sql_fac_sin_plan=" select distinct FacturacionProyectos.unidad , Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division from FacturacionProyectos 
...
//echo "<br>".$sql_fac_sin_plan."---- <br>";
		...
		$sql_plane_no_fac="select distinct PlaneacionProyectos.unidad , Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division from PlaneacionProyectos 
        inner join Usuarios on PlaneacionProyectos.unidad=Usuarios.unidad
		...
		(
			...
			from (
				select SUM(hombresMes) hombresMes , PlaneacionProyectos.unidad, mes, vigencia, Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado , Divisiones.id_division ";
				if(trim($cualProyecto)!="")
				{
				...
				group by PlaneacionProyectos.unidad,mes, vigencia, Usuarios.nombre, Usuarios.apellidos,Usuarios.fechaRetiro,Usuarios.retirado, Divisiones.id_division ";
				if(trim($cualProyecto)!="")
				{
					$sql_abajo=$sql_abajo." ,PlaneacionProyectos.id_proyecto ";
				}
...
<table width="100%"  border="0"  bgcolor="#FFFFFF" >
          <tr>
            <td  class="TituloUsuario" width="1%">&nbsp;</td>
            <td  class="TituloUsuario" width="10%">Unidad</td>
            <td  class="TituloUsuario" width="24%">Usuario</td>
            <td  class="TituloUsuario" width="2%"></td>
            <td width="63%" class="TituloUsuario">
...
<?
					//SI EL USUARIO NO PERTENECE A LA DIVISIÓN
					if($datos_usu["id_division"]!=$pDivision)
						echo "<img src='imagenes/alertaPlane.gif' alt='Usuario que no pertenece a la división.' title='Usuario que no pertenece a la división.' > ";
?>
					</td>
...
?>
		  <tr>
			<td colspan="13" align="right" class="TxtTabla">&nbsp;</td>
		  </tr>
<?
	}//del for
?>
