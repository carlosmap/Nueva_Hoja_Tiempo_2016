...
function ejecutarQuery($query, $nombreProyecto){
	...
	if($numRegs == 0){
		$contenido = $contenido . "<tr><td colspan='10'>La Consulta no produjo Resultados.</td></tr>\n";
	} else {
		$contenido = $contenido . "<tr><td colspan='10'><strong>Reporte de Facturación. - Proyecto: " . $nombreProyecto . "<strong></td></tr>\n";
		$contenido = $contenido . "<tr>\n";
		$contenido = $contenido . "<td><strong>Unidad</strong></td>\n";
		$contenido = $contenido . "<td><strong>Nombre Completo</strong></td>\n";
		$contenido = $contenido . "<td><strong>Nombre Corto</strong></td>\n";
		...
		while($reg = mssql_fetch_array($cursor)){
			...
			$contenido = $contenido . "<td>" . strtoupper($reg['NombreCorto']) . "</td>\n";
