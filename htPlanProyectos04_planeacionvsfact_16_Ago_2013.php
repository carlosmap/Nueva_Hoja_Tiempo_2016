				...
				<td>
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr class="TxtTabla">
                        ...
                        <td align="leftt" width="30%"><img src="imagenes/ico1.gif" width="77" height="16">Facturado</td>
...
//echo $sql_parti." <br><br>".mssql_get_last_message();
		...
		//		if( ( (isset ( $Lote_control))&&( isset($Lote_trabajo))&&( isset($Division))&&( isset($Actividad)) )   )
			...
			?>
				...
				<form name="Form2" id="Form2" method="post" action="http://www.ingetec.com.co/NuevaHojaTiempo/htPlanProyectos04_planeacionvsfact_det.php?cualProyecto=<?=$cualProyecto; ?>&V=<?=$lstVigencia; ?>&personal=<?=$personal; ?>">
...
?>
                        <td width="4%"  height="100%" ><table width="100%" height="100%"  border="0">
                          <tr>
                            <td   background="<?  echo $ima; ?>"></td>
                          </tr>

                          <tr>
                            <td  background="<?  echo $ima2; ?>" > </td>
                          </tr>
                        </table></td>                        
