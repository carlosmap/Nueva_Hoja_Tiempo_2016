...
//FALTA EL VALOR DE LA VARIABLE $miCargoAdicional , RELACIONADO EN LA TABLA  viaticosproyecto  EN EL CAMPO cargo
...
//alert(document.RViaticos.tipoViatico.value);
...
/*
		if( (document.RViaticos.fechaFinalViatico.value==document.RViaticos.fechaInicialViatico.value) && (document.RViaticos.diaCompleto[1].checked))
		{
//			notificacion(); 		PENSIENTE ********************************
		}
...
<form name="RViaticos" action="addHtViaticosP.php" method="post">
...
<tr>
  <td class="TituloTabla2">Es d&iacute;a de regreso? </td>
  <td>
  <?
	//PBM - 13Sep2007
...
<td>
<input name="fechaInicialViatico" id="fechaInicialViatico" type=text size= 30 class="CajaTexto" onKeyPress="return acceptNum(event)" onChange="cambiarDisplay('row2')" onBlur="valFecha(this);"   value="<? echo $fechaInicialViatico; ?>"  >
		<a href="javascript:void(0)" onClick="gfPop.fPopCalendar(document.RViaticos.fechaInicialViatico);  return false;" onBlur="cambiarDisplay('row2'); return false;"  HIDEFOCUS><img name="popcal"
...
<td>
<input name="fechaFinalViatico" id="fechaFinalViatico" type=text size=30 class="CajaTexto"  onKeyPress="return acceptNum(event)" onChange="cambiarDisplay('row2')" onBlur="valFecha(this);" value="<? echo $fechaFinalViatico; ?>"  >

		<a href="javascript:void(0)" onClick="gfPop.fPopCalendar(document.RViaticos.fechaFinalViatico);return false;" onBlur="cambiarDisplay('row2'); return false;"  HIDEFOCUS><img name="popcal"
		 align="absmiddle" src="calbtn.gif" width="34" height="22" border="0" alt="Seleccione una fecha"></a>
...
<td>
<input name="trayectoViatico" id="trayectoViatico" type=text size="30" class="CajaTexto" value=<?php echo $trayectoViatico;?> >
...
<td>
<textarea name="trabajoRealizado" id="trabajoRealizado" rows="4" cols= 30 class="CajaTexto">
...
<tr   align="left"> 
	<td colspan="2" >
        <div  style="display:none" id="row2"  class="TxtTablaRpt" >
<img src="../NuevaHojaTiempo/imagenes/icoDetalleInf.gif" title="Atención">
        La Fecha Inicial y  Final son iguales, y ha marcado dia de regreso en No. Para este caso, deberia marcar dia de regreso en Si.
        </div>
	</td>
</tr>
<tr><td></td><td><input name="Enviar1" type="button" class="Boton" value=" Grabar Viatico" onClick="valida()" >
...
//	exit;
	...
	while($mktFiv <= $mktFfv){
		...
		$sql="SELECT rtrim(localizacion)+ '-' +rtrim(cargo) AS codigo, DAY(fechaIni) AS diaIni, DAY(fechaFin) AS diaFin, IDTipoViatico, id_proyecto, IDSitio ";
			$sql1="FROM ViaticosProyecto WHERE  ((fechaIni BETWEEN $fechaActual) and (fechaFin BETWEEN $fechaActual)) AND(unidad = '$laUnidad') ";
...
//	$sqla = "insert into viaticosproyecto values($cualProyecto,$sitioTrabajo,$multiViatico, $tipoViatico, $sesUnidadUsuario, ";
	...
	$multiViatico=1;
	$sqla = "insert into viaticosproyecto values($cualProyecto,$sitioTrabajo,$multiViatico, $tipoViatico, $laUnidad, ";
	$sqlb = "$cualActiv, $cualLocaliza, '$miCargoAdicional', '$fechaInicialViatico', '$fechaFinalViatico', '$trayectoViatico','$trabajoRealizado', '$diaCompleto')";
