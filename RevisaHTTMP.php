...
//**********************
//si el filtro es por unidad o nombre , no lleva a cabo el filtro por los demás criterios.

if ((trim($lUnidad) == "") AND (trim($lNombre) == "")) {
	...
	if (trim($lUnidad) != "") {
		$sql=$sql." and U.unidad =  " . $lUnidad ;
	}
	if (trim($lNombre) != "") {
		$sql=$sql." and (U.nombre like '%" . $lNombre . "%' OR U.apellidos like '%". $lNombre ."%')";
	}
...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="TxtNota1" style="position:absolute; left:258px; top:11px; width: 365px;">
		<div align="center">Hojas de tiempo Temporales por División</div>
	</div>
...
<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" class="TxtTabla"><input name="lUnidad" type="text" class="CajaTexto" id="lUnidad" /></td>
    <td class="TxtTabla">&nbsp;</td>
  </tr>
  <tr>
    <td align="right" class="TituloTabla">Nombre:</td>
    <td colspan="3" class="TxtTabla"><input name="lNombre" type="text" class="CajaTexto" id="lNombre" size="50" /></td>
    <td class="TxtTabla">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr class="TxtTabla">
        ...
        <td width="5%"><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','verHTTMP.php?zUnidad=<? echo $reg[unidad]; ?>&Flmes=<? echo $reg[mes]; ?>&Flano=<? echo $reg[vigencia]; ?>');return document.MM_returnValue" value="Ver Hoja" /></td>
        </tr>
	  <? } ?>
    </table>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="TxtTabla"><input name="BotonReg" type="submit" class="Boton" id="BotonReg" onclick="MM_callJS('window.close()')" value="Cerrar" /></td>
          </tr>
        </table></td>
      </tr>
    </table>
