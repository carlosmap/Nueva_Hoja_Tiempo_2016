...
<table width="100%"  border="1" cellspacing="1" >
  <tr>
    <td align="center" valign="middle" class="LetraIngetecForm"  width="149" height="49"><img src="http://www.ingetec.com.co/NuevaHojaTiempo/imagenes/logoIngetec.gif" width="200px" height="41px" align="absmiddle"></td>
    <td colspan="5" align="center" valign="middle" class="TituloFormato">Reporte Facturaci&oacute;n por Proyectos</td>
    <td width="18" colspan="<?php echo $cantidad_meses-2; ?>" align="center" valign="middle" class="LetraFormato">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td width="215" colspan="<?php echo 5+($cantidad_meses-4); ?>">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td align="right"><?php  echo $fecha_inicial_excel; ?></td>
  	<td width="211">Hasta</td> 
    <td width="132" align="right"><?php echo $fech_final_excel; ?></td>    
    <td width="30" colspan="<?php echo $cantidad_meses-2 ?>">&nbsp;</td>           
  </tr>
...
//						$valores_facturacion[0][0]= $cantidad_meses;  
  ...
  <tr>
  	<td width="28%">Proyecto</td>
	<td width="51%" >Departamento</td>   
	...
	?>
    										<td width="16%" align="center"><? echo substr($meses[$mes11],0,3)."<br>".$anio11;?></td>
     <?php
											$mes11=1;
											$anio11++;
										}
										...
										{	
		?>				
										 <td width="5%" align="center"><? echo substr($meses[$mes11],0,3)."<br>".$anio11;?></td>                    
                <? 												
										 $mes11++;
										}	 
									}
  ...
  <tr>
  	...
  	<td rowspan="<?php echo $num_filas; ?>"><?php echo $regProy2[nomProyecto]; ?> [ <?php echo $regProy2[codigo].".".$regProy2[cargo_defecto]; ?>]</td>
    <?php 
								$num_filas=mssql_num_rows($cursorDpto);
								$num_columnas=$cantidad_meses;
								$fila=0;			
