...
<div id="tblDm"></div>
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
      <tr class="TituloTabla2">
        ...
        <?php
			#
			#	COLUMNAS REPORTE MES A MES
			#	CAPTURA LOS AÑOS PARA DAR LA CANTIDAD DE MESES.
			$anio1;
			$anio2;
			#	CAPTURA LOS MESES
			$mes1;
			...
			for( $i = 0; $i < $tcol; $i++ ){
				...
				#else{
				$mes1 = $mes1 + $i;
				echo "<td> ". $nmes[$mes1] ."</td>";
				#}
			}
			#echo "<td> Año 1 : ".$anio1."; Año 2 : ".$anio2."; Mes 1 : ".$mes1."; Mes 2 : ".$mes2."; <br /> SUMA MESES : ".$mes."; Total Columna : ".$tcol."</td>";
		?>
      ...
      <tr class="TxtTabla">
        ...
        <?php
			...
			#echo "<td> Año 1 : ".$anio1."; Año 2 : ".$anio2."; Mes 1 : ".$mes1."; Mes 2 : ".$mes2."; Total Columna : ".$tcol."</td>";
		?>
      ...
      <? } ?>
      <tr class="TituloTabla2">
        <td width="15%" align="right">VALOR TOTAL FACTURADO</td>
        <?php
			#echo "<td> Mes XXX </td>";
			$mes1 = $nmes[$mes1];
			for( $i = 0; $i < $tcol; $i++ ){
