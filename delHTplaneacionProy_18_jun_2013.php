...
function envia2(unidad, nombre,tipo)
{
	
	//Si todas las validaciones fueron correctas, el formulario hace submit y permite grabar
	  if (confirm("Desea eliminar la planeaci\xf3n para el usuario: ["+unidad+"] "+nombre) ) 
		{
			document.Form1.recarga.value="2";
			document.Form1.usu_eliminar.value=unidad;
			document.Form1.tipo_usu.value=tipo;
			document.Form1.submit();
		}
...
-->
		  <select name="lstUnidadP<? echo $r; ?>" class="CajaTexto" id="lstUnidadP<? echo $r; ?>" style='width:200px; ' disabled  >
