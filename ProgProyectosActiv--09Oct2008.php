	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla">
			<input name="Submit4" type="button" class="Boton" onclick="MM_openBrWindow('addProgramaR.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $cualActividad ; ?>','verAdP','scrollbars=yes,resizable=yes,width=580,height=280')" value="Insertar" />
			<? if ($laUnidad == 12974) { ?>			
