...
<form action="HtiempoElBueyEtapaII.php" method="post" name="frm">
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Unidad</td>
    <td><input name="und" type="text" value="<?php echo $und; ?>" size="10" /></td>

    <td>Mes</td>
    <td><input name="mes" type="text" value="<?php echo $mes; ?>" size="10" /></td>
<td><input name="Enviar" type="submit" value="Consultar"/></td>
...
echo "<tr ><td class='tituloTabla'><b>Proyecto:</td><td class='txtTabla'>Proyecto Hidroeléctrico El Buey Etapa II</td></tr>";
...
$sql="SELECT RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto,
		...
		WHERE     (fecha BETWEEN $cadfecha) AND (unidad = '$laUnidad') and RTRIM(localizacion) + '-' + RTRIM(cargo) <> '1-1199' and id_proyecto = 852 order by dia";
