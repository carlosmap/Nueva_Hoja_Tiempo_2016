...
<tr class='TituloUsuario'><td colspan='6' bgcolor='#999999' ></td></tr>";
	...
	if($recarga==1)
	{
			...
			{ 
				$sql_fact="	select Usuarios.unidad, Upper(Usuarios.nombre+' '+ Usuarios.apellidos) nombre ,total_facturacion, hombresMes, upper(Departamentos.nombre) nombre_depto ,upper(Divisiones.nombre) nombre_div,vigencia  from (
			...
			if ($facturacion==1)
			{
				 $sql_fact=$sql_fact." and  hombresMes<total_facturacion";
			}
