      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td width="22%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
			...
			if (($_SESSION["sesUnidadUsuario"] == 12974 ) OR ($_SESSION["sesUnidadUsuario"] == 15712 ) OR ($_SESSION["sesUnidadUsuario"] == 900047 )) {
			?>
            <tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
              <td class="menu"><a href="lstProyectosViaticosHT.php">Aprobaci&oacute;n de vi&aacute;ticos </a></td>
            </tr>
			<? } ?>
            <tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
