...
$sql01=$sql01." 		UNION SELECT DISTINCT unidad ";
...
if( trim( $pfDivision ) != "" )
	$sql01 .= " AND E.id_division = ".$pfDivision;
#####	Filtros por division de estructura organizativa
if( trim( $pfDivisionOrg ) != "" )
	$sql01 .= " AND E.id_division = ".$pfDivisionOrg;
####	
if( trim( $miDpto ) != "" )
	$sql01 .= " AND D.id_departamento = ".$miDpto;
if( trim( $pFiltro ) != "" )
	$sql01 .= " AND B.id_categoria = ".$pFiltro;
##
if( trim( $pOrdena ) == "2" )
	$sql01 .= " Order by B.id_categoria ";
if ( trim( $pOrdena ) == "1" )
	$sql01 .= " Order by B.apellidos, B.nombre";
$cursor01 = mssql_query($sql01);

#echo "Filtro : ".$pFiltro."<br />".$sql01;
//--------HASTA AQUI
//10Jun2008
      ...
      <tr>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <tr>
              <td class="TituloTabla">Divisi&oacute;nes EDT</td>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla">
			...
			<?
				...
				##	Lote de control
				#if( trim( $lc ) != "" )
				#	$sql02 .= " AND A.id_actividad in ( Select id_actividad from Actividades Where dependeDe = ".$lc." AND id_proyecto = ".$cualProyecto." ) ";
				##	Lote de trabajo
				#if( trim( $lt ) != "" )
				#	$sql02 .= " AND A.id_actividad = ".$lt;			
				##
				$sql02=$sql02." ) Z ";
			...
			<? while ($reg02=mssql_fetch_array($cursor02)) { ?>
              <tr>
				...
				$esParticipante = "NO";
				$miEstado="";
				$sql03 = "SELECT * FROM ParticipantesActividad ";
