...
if ($Horas != "") {
	...
	if ($Horas == 0) {
		...
		$query = $query . " id_proyecto = ".$pProyecto . ", ";	
		$query = $query . " clase_tiempo=".$pClase . ", ";	
		$query = $query . " localizacion=".$pLocaliza. ", " ;	
		$query = $query . " comentario = '". $Comentarios. "', " ;	
		$query = $query . " cantidadHoras=".$Horas;
...
//		$sql2="Select * from Proyectos order by nombre " ;
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="Horas" type="text" class="CajaTexto" id="Horas" value="<? echo $mcantidadHoras; ?>" size="20"></td>
  </tr>
  <tr>
    <td class="TituloTabla">Comentarios</td>
    <td class="TxtTabla"><textarea name="Comentarios" cols="50" class="CajaTexto" id="Comentarios"><? echo $mcomentario; ?></textarea></td>
  </tr>
  <tr>
