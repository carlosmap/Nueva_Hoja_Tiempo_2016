...
if(trim($recarga) == "2"){
	...
	//id_proyecto, id_actividad, unidad, vigencia, mes, 
...
//parseFloat(1) = Campos fijos DESPUES de la parte dinámica
totVar = parseFloat(5) + parseFloat(document.Form1.cantMeses.value) + parseFloat(2);
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td class="TxtTabla"><strong>$ 20.000.000 </strong></td>
        </tr>
        <tr>
          <td class="TituloTabla">Valor total planeado</td>
          <td class="TxtTabla">$ 5.560.000 </td>
        </tr>
        <tr>
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr class="TxtTabla">
          ...
          <td width="5%"><input name="chkReplica" type="checkbox" id="chkReplica" value="1">
            Replicar<br></td>
          <td width="3%" align="center"><input name="txtHomMes<? echo $r; ?>" type="text" class="CajaTexto" id="txtHomMes<? echo $r; ?>"  size="10" onKeyPress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" ></td>
		...
		<select name="lstPartirMes<? echo $r; ?>" class="CajaTexto" id="lstPartirMes<? echo $r; ?>">
          ...
          <td width="3%" align="center"><input name="txtRepite<? echo $r; ?>" type="text" class="CajaTexto" id="txtRepite<? echo $r; ?>"  size="10" onKeyPress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" ></td>
          <td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
			  <tr class="TituloTabla2">
			  <? for ($m=$minMesP; $m<=$maxMesP; $m++) { ?>
          ...
          <td><input name="txtVlFact<? echo $r; ?>" type="text" class="CajaTexto" id="txtVlFact<? echo $r; ?>" size="15" readonly></td>
          <td>&nbsp;</td>
        </tr>
		<? 
		$r = $r + 1;
        ...
        <tr>
		  ...
		  <? } ?>	  		  
		    ...
		    <input name="cantMeses" type="hidden" id="cantMeses" value="<? echo $cantMesesDibuja ; ?>">
  		    ...
  		    <input name="Submit2" type="button" class="Boton" value="Calcular" onClick="calcularVal()" >
