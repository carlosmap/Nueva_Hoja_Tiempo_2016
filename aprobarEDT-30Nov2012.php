...
/////// temporal			
	...
	echo $error." - $sql_usu_aprueba - ".mssql_get_last_message()."<br>";
				...
				$sql_ins_solicitud="update  HojaDeTiempo.dbo.AutorizaEDT set validaVoBo=0, unidadVoBo=".$_SESSION["sesUnidadUsuario"].",comentaVoBo='".$observacion."',fechaVoBo=getdate(),usuarioMod=".$_SESSION["sesUnidadUsuario"].",fechaMod=getdate(),fechaIniProy=NULL,enviaAFirma=0";
...
echo "<br>     <t>".$sql_acti_lt."  - $error -  ".mssql_get_last_message()." ** ".$datos_usuarios["id_encargado"];
					...
					else if($datos_tipo_activi_asig["tipoActividad"]==3)
					{
						...
						) as lote_trabajo, (select macroactividad from Actividades A2 where A2.id_proyecto=".$cualProyecto." and id_actividad=A1.actPrincipal) as lote_control from Actividades  as A1
						...
						{
							$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_div["lote_control"]."</td>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_div["lote_trabajo"]."</td>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_div["macroactividad"]."</td>";
