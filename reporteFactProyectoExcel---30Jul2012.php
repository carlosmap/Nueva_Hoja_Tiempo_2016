...
*/
$sql1 = " SELECT H.unidad , U.nombre, U.apellidos, U.NombreCorto, A.nombre nomActividad, H.cargo, H.clase_tiempo, H.localizacion,
...
<table width="100%" border="1"  cellspacing="1">
  <tr>
    <td colspan="11"><strong>Reporte de Facturaci&oacute;n de Proyectos - Proyecto: <? echo $nombreProyecto; ?></strong></td>
  </tr>
  <tr>
	...
	<td><strong>Localizaci&oacute;n</strong></td>
