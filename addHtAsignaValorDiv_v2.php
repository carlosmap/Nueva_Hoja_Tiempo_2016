...
if(trim($mitotDivReal)=="")
	$mitotDivReal=0;
if(trim($mitotDivAsig)=="")
	$mitotDivAsig=0;
  ...
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="20%" class="TituloTabla">Valor Real del Proyecto para las Divisiones</td>
          <td class="TxtTabla"><? echo "$ " . number_format($miValProy, 0, ",", "."); ?>
            <input name="elValProy" type="hidden" id="elValProy" value="<? echo $miValProy; ?>"></td>
        </tr>
        <tr>
          <td class="TituloTabla">Valor  total Divisiones </td>
          <td class="TxtTabla"><strong>Real</strong>: <? echo "$ " . number_format($mitotDivReal, 0, ",", "."); ?>
            ...
            <br>
            <strong>Asignado</strong>: <? echo "$ " . number_format($mitotDivAsig, 0, ",", "."); ?>
            <input name="elValAsig" type="hidden" id="elValAsig" value="<? echo $mitotDivAsig; ?>"></td>
        </tr>
        <tr>
          <td class="TituloTabla">% para calcular el valor asignado</td>
          <td class="TxtTabla"><label for="textfield"></label>
        ...
        <tr class="TxtTabla">
          ...
          <td align="center"><input name="valReal<? echo $r; ?>" type="text" onBlur="porcentaje('<? echo $r; ?>'); total();  if((notifica())!='') { alert(notifica()); } "  disabled class="CajaTexto" id="valReal<? echo $r; ?>" onKeyPress="return acceptNum(event)"  ></td>
          <td align="center"><input name="valAsignado<? echo $r; ?>" type="text" disabled class="CajaTexto" id="valAsignado<? echo $r; ?>" onKeyPress="return acceptNum(event)" onBlur=" total(); if((notifica())!='') { alert(notifica()); }"  ></td>
        </tr>
		<? 
		$r = $r+1;
		} ?>
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td align="center" class="TxtTabla"><input name="Realprevio" type="text" value="<? echo  ($mitotDivReal); ?>" disabled class="CajaTexto" id="Realprevio" readonly></td>
          <td align="center" class="TxtTabla"><input name="Asignadoprevio" type="text" disabled class="CajaTexto" value="<? echo ($mitotDivAsig); ?>" id="Asignadoprevio" readonly></td>
        </tr>
        <tr>
