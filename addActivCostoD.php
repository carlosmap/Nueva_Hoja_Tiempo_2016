...
if ($lValor != "") {
	...
	if ($lValor == 0) {
		...
		$sqlSec="Select max(secuencia) MaxCodigo from HojaDeTiempo.dbo.ActividadesCostosD  ";
		$sqlSec=$sqlSec." where id_proyecto =" . $miProyecto ;
		$sqlSec=$sqlSec." and id_actividad =" . $miActividad ;
		...
		$query = "INSERT INTO ActividadesCostosD(id_proyecto, id_actividad, secuencia, item, valorItem, unidad) " ;
