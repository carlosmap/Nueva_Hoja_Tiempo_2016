  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="TxtTabla"><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','lstProyectosHT.php');return document.MM_returnValue" value="Listado de Proyectos" /></td>
          </tr>
        </table></td>
      </tr>
    </table>
