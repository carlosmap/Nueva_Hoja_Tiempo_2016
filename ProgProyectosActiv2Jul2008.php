...
//			echo "$ " . number_format($miTotalAsigna, 0, ',','.');
			...
			//ValorRemanente
			$valorRemanente=$miValorActiv-$miTotalAsigna;
...
<? if ($laUnidad == 12974 ) { ?>
  ...
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right"><input name="Submit6" type="submit" class="Boton" onclick="MM_openBrWindow('addActivCostoD.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $cualActividad ; ?>','adCDAct','scrollbars=yes,resizable=yes,width=500,height=280')" value="Insertar" /></td>
      </tr>
    </table>
	<? } ?>
	</td>
