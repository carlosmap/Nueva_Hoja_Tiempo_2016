...
*/
						...
						// SI SE ALMACENO, LA FECHA DE INICIO  Y FINALIZACION DE LA ULTIMA SEMANA DEL MES ANTERIOR, SE AÑANDE AL CORREO, LA COLUMNA, CON LA FECHA CORRESPONDIENTE
						if($ban==1)
						{
...
////FALTA AÑADIR LA CONSULTA, PARA TRAHER, EL EMAIL, DEL DIRECTOR DE DIVISION, PARA ENVIAR EL CORREO CORRESPONDIENTE
