...
<?
	...
	$cur_inf_factu=mssql_query("SELECT  resumen,  day(fechaFacturacion) dia, MONTH(fechaFacturacion) mes , year(fechaFacturacion) ano
...
?>
    <tr>
      ...
      <td class="TxtTabla">
        ...
        <textarea name="resumen<?=$cont ?>" cols="100%" rows="3" readonly class="CajaTexto" id="resumen<?=$cont ?>"><?=$datos_inf_factu["resumen"] ?></textarea></td>
