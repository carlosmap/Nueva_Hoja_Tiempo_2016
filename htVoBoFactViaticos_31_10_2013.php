...
//echo $error." *** <br>";
	...
	if($error=="no")
	{
		...
		echo "<script>alert('La operación se realizó con éxito')</script>";
			...
			echo "	<script>window.close();MM_openBrWindow('htFactViaticos.php?cualProyecto=".$cualProyecto."&pMes=".$pMes."&vigencia=".$vigencia."&recarga=2','winFacturacionHT','toolbar=yes,scrollbars=yes,resizable=yes,width=960,height=700');</script>";
}
?>
...
echo "Ingresooooooooooooooooooooooooooooo uni_corr ".$uni_coor." uni_dir ".$uni_dir." unida ".$laUnidad." <br>";
			...
			$sql_fac=$sql_fac."  
				...
				and FacturacionProyectos.id_proyecto=".$cualProyecto." and FacturacionProyectos.esInterno='I' and FacturacionProyectos.id_actividad not in (
...
?>
                        <tr class="TxtTabla">
                          ...
                          <textarea name="comentario<?="_via_".$datos_usu["unidad"]."_".$i."_".$j ?>" id="comentario<?="_via_".$datos_usu["unidad"]."_".$i."_".$j ?>" cols="15" rows="3"></textarea>
