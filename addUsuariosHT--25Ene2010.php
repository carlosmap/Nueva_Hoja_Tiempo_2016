...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" bgcolor="#EAEAEA">
  ...
  <form action="addUsuariosHT.php" method="post" name = "addUsr" onSubmit="MM_validateForm('Unidad','','RisNum','Nombres','','R','Apellidos','','R','SitioContrato','','R','SitioTrabajo','','R','Email','','R','NombreCorto','','R','lFechaInicio','','R','Salario','','RisNum','lFechaNacimiento','','R');return document.MM_returnValue">
...
//	  	$sqlDpto = "select * from departamentos ";
  ...
  <tr>
	...
	<input name="lFechaNacimiento" type="text" class="CajaTexto" value="<? echo $lFechaNacimiento; ?>" size="15" readonly >
