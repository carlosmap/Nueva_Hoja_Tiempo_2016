	  ...
	  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla">
            ...
            <td width="1%"><img src="img/images/actualizar.jpg" width="19" height="17" onclick="MM_openBrWindow('upEDTregLC.php?cualProyecto=<? echo $cualProyecto; ?>&cualLC=<? echo $reg02[id_actividad] ; ?>','winDedt','scrollbars=yes,resizable=yes,width=800,height=400')" /></td>
