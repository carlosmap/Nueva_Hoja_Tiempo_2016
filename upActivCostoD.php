...
if ($lValor != "") {
	...
	if ($lValor == 0) {
		...
		//id_proyecto, id_actividad, secuencia, item, valorItem, unidad
		$query = "UPDATE ActividadesCostosD SET item = '". $lCosto ."', " ;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="lCosto" type="text" class="CajaTexto" id="lCosto" value="<? echo $pitem; ?>" size="70">
	</td>
  </tr>
  <tr>
    <td class="TituloTabla">Valor</td>
    <td class="TxtTabla"><input name="lValor" type="text" class="CajaTexto" id="lValor" value="<? echo $pvalorItem; ?>"></td>
  </tr>
</table>
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
