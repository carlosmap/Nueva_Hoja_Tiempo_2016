...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td background="img/imagenes/pixBanner.jpg"><img src="img/imagenes/Banner.jpg" width="495" height="182"></td>
  </tr>
</table>
...
<FORM name='formulario' ACTION="frm-GrabaTiempo.php" METHOD="POST">
...
<div id="Layer4" style="position:absolute; left:-3px; top:63px; width:650px; height:91px; z-index:3"></div>
<div id="Layer2" style="position:absolute; left:647px; top:63px; width:81px; height:54px; z-index:2"></div>
