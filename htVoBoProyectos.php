<?php
	...
	{
		$pagina=1;
		header('Location: http://www.ingetec.com.co/NuevaHojaTiempo/htVoBoProyectos.php?pagina=1&pNombre='.$pNombre.'&cod='.$cod.'&cargo='.$cargo.'&pOrden='.$pOrden.'&pProyecto='.$pProyecto);
...
Aprobaci&oacute;n de la Facturaci&oacute;n de los Proyectos y los vi&aacute;ticos </div>
...
Especial</td>
      ...
      <tr>
        ...
        <td width="2%" class="TxtTabla"><input name="Consulta"  type="submit" onClick=" envia();" class="Boton" value="Consultar" />
										<input type="hidden"  name="ban" id="ban"  value="1" /></td>
      </tr>
    </table>
		</td>
      </tr>
...
//		}
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="3%" class="TxtTabla"><strong><? echo  trim($reg[codigo])  ; ?></strong></td>
            <td width="1%"><strong>.</strong></td>
            <td width="5%" class="TxtTabla"><strong><? echo  $reg[cargo_defecto] ; ?></strong></td>
            <td class="TxtTabla">[<? echo  $reg[descCargoDefecto] ; ?>]</td>
            </tr>
		<? while ($regCargos=mssql_fetch_array($cursorCargos)) { ?>
          <tr>
            <td width="3%" class="TxtTabla">&nbsp;</td>
            <td width="1%" class="TxtTabla">.</td>
            <td width="5%" class="TxtTabla"><? echo $regCargos[cargos_adicionales]; ?></td>
            <td class="TxtTabla">[<? echo $regCargos[descripcion]; ?>]</td>
            </tr>
		<? } ?>
        </table>
</td>
...
?>
    ...
    <form name="form2" id="form2" method="post" action="htFactViaticos.php?cualProyecto=<?=$reg[id_proyecto] ?> ">	
          <input name="Submit" type="submit" class="Boton" value="Facturaci&oacute;n y vi&aacute;ticos" />
	</form>
</td>
	    </tr>
	  <? } ?>
