...
?>
<?php
if (($_SESSION["sesUnidadUsuario"] == 15712) OR ($_SESSION["sesUnidadUsuario"] == 12974) OR ($_SESSION["sesUnidadUsuario"] == 900225) OR ($_SESSION["sesUnidadUsuario"] == 13829)) {
?>

<form action="HtiempoDibulla.php" method="post" name="frm">
...
echo "<tr ><td class='tituloTabla'><b>Proyecto:</td><td class='txtTabla'>Proyecto Puerto Carbón Dibulla</td></tr>";
...
$sql="SELECT RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto, cargo,
		...
		WHERE     (fecha BETWEEN $cadfecha) AND (unidad = '$laUnidad') and RTRIM(localizacion) + '-' + RTRIM(cargo) <> '1-1199' and id_proyecto = 1079  and cargo='420' order by dia";
