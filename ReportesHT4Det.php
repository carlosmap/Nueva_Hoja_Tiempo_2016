...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="15%" class="FichaInAct"><a href="ReportesHT2Det.php?cualProyecto=<? echo $cualProyecto; ?>&pMes=<? echo $pMes; ?>&pAno=<? echo $pAno; ?>" class="FichaInAct1">Facturaci&oacute;n del Proyecto <br />
        Usuarios Vs Actividades </a></td>
        <td width="15%" class="FichaAct">Facturaci&oacute;n del Proyecto<br />
        Actividades Vs Usuarios </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="2" colspan="3" class="TituloUsuario"> </td>
      </tr>
    </table>
  ...
  <tr>
	...
	<form name="form1" method="post" action="">
	  ...
	  <tr>
		...
		<? //Búsqueda de las actividades para mostrar en el menú
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
	  ...
	  ?>
		  <tr class="TxtTabla">
			<td width="20%" valign="top"><? echo $regAct[macroactividad]." ".$regAct[nombre]; ?></td>
			<td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
			  ...
			  ?>
				  <tr class="TxtTabla">
					<td width="15%" valign="top"><? echo ucwords(strtolower($regPart[nombre]." ".$regPart[apellidos])); ?></td>
					...
					<td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
					  ...
					  <tr class="TxtTabla">
					    ...
					    <td width="7%" align="right"><? echo $cargo; ?></td>
