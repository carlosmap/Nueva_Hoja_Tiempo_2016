...
<?php
 ...
 ?>
	  ...
	  <?
		...
		$sql_num_max_lt="select MAX(lote) as lt_max from ( select SUBSTRING(macroactividad, CHARINDEX ('.',macroactividad)+1, LEN(macroactividad)) AS lote FROM Actividades WHERE id_proyecto=".$cualProyecto." and dependeDe=".$LC." and nivel = 2 ) A";
	  ...
	  ?>
      <tr class="TxtTabla">
        <td width="5%" align="center"><input name="pLT<? echo $r; ?>" type="text" class="CajaTexto" id="pLT<? echo $r; ?>"  size="10" readonly value="<?php echo "LT".$num_lote_control.".".++$num_max_lt; ?>" ></td>
        <td align="center"><input name="pNombre<? echo $r; ?>" type="text" class="CajaTexto" id="pNombre<? echo $r; ?>"  size="70"  ></td>
        <td align="center">
