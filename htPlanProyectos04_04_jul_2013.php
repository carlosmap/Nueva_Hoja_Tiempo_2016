...
//echo $sql_division_valor_total."<br>".mssql_get_last_message();
			...
			$val_facturado[$l]=10000; //temporal para quitar y adacptar, una vez se implemente EL MODULO DE LA  FACTURACION
...
<BR >
<?
//echo " Info ".$f." -- ".$activid__inicio_fin[0][0]." -- ".$activid__inicio_fin[$f-1][1]." ";
