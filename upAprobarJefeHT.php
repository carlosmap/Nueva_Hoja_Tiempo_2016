...
?></td>
        <td width="63%" align="center"><table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr class="TituloTabla2">
            ...
            <td width="5%">VoBo</td>
            <td width="10%"><p>Total Horas</p></td>
            <td width="15%">VoBo</td>
...
<?
						...
						?>  >
								<?=$datos_fac_proy["total_horas_fact_CT"]; ?> <img src="/NuevaHojaTiempo/imagenes/icoDetalleInf.gif" title="Se totaliza la facturación, para las clases de tiempo 1, 2, 3 y 11.">
 						 </td>
