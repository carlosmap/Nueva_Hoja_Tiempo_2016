...
?></td>
  ...
  <tr>
    <td class="TxtTabla" colspan="2" ><a href="htApruebaHT.php?pMes=<?=$pMes ?>&pAno=<?=$pAno ?>&unidad_u=<?=$unidad_u ?>&nombres=<?=$nombres ?>&pRetirado=<?=$pRetirado ?>&unidades=<?=$unidades ?>"  class="menu"> << Regresar al listado de usuarios </a>
	</td>
  </tr>
</table>
