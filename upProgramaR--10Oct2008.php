...
<?
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="HorasAsignadas" type="text" class="CajaTexto" id="HorasAsignadas" value="<? echo $pTiempoMes; ?>" size="20">
      <input name="horasIni" type="hidden" id="horasIni" value="<? echo $pTiempoMes; ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="right" class="TxtTabla"><input name="recarga" type="hidden" id="recarga" value="2">      
