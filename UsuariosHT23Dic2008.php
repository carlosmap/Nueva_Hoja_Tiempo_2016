    ...
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <input name="InsertarUsr" type="button" class="Boton" onClick="MM_openBrWindow('addUsuariosHT.php','addUsr','scrollbars=yes,resizable=yes,width=600,height=350')" value="Insertar">
          &nbsp;</td>
        </tr>
      </table></td>
  </tr>
