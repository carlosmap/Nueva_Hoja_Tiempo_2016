...
echo "procesando solicitud";
	...
	include("fncEnviaMailPEAR.php");
				...
				$pTema = $pTema . "		<td width='70%'>".$_SESSION["sesNomApeUsuario"]."</td>";
				$pTema = $pTema . "	</tr>";
				$pTema = $pTema . "	<tr class='Estilo2'>";
				$pTema = $pTema . "		<td>&nbsp;</td>";
				$pTema = $pTema . "		<td>&nbsp;</td>";
...
/////// temporal			
	...
	echo $error." - $sql_usu_aprueba - ".mssql_get_last_message()."<br>";
				...
				$sql_ins_solicitud="update  HojaDeTiempo.dbo.AutorizaEDT set validaVoBo=0, unidadVoBo=".$_SESSION["sesUnidadUsuario"].",comentaVoBo='".$observacion."',fechaVoBo=getdate(),usuarioMod=".$_SESSION["sesUnidadUsuario"].",fechaMod=getdate(),fechaIniProy=".$fechaInicio;
...
echo "procesando solicitud seccion 2";	
	...
	//echo $inf_proy."<br>";
				...
				$pTema = $pTema . "	<tr class='Estilo2'>";
				$pTema = $pTema . "		<td width='30%'>Fecha de aprobaci&oacute;n:</td>";
				$pTema = $pTema . "		<td width='70%'>".$fecha."</td>";
				$pTema = $pTema . "	</tr>";
				$pTema = $pTema . "	<tr class='Estilo2'>";
				$pTema = $pTema . "		<td>&nbsp;</td>";
				...
				$pTema = $pTema . "	<tr class='Estilo2'>";
				$pTema = $pTema . "		<td width='30%'>Fecha de Inicio del proyecto:</td>";
			...
			while($datos_usuarios=mssql_fetch_array($cur_usuarios_edt))
			{
				...
				while($datos_tipo_activi_asig=mssql_fetch_array($cur_tipo_activi_asig))
				{
					...
					if($datos_tipo_activi_asig["tipoActividad"]==1)
					{
						...
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td  colspan='2'>Lotes de control</td>";
						$pTema2 = $pTema2 . "	</tr>";
		
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td width='40%'>Lote de control</td>";
					...
					else if($datos_tipo_activi_asig["tipoActividad"]==2)
					{
						...
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td colspan='3'>Lotes de trabajo</td>";
						$pTema2 = $pTema2 . "	</tr>";
		
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td width='30%'>Lote de control</td>";
						$pTema2 = $pTema2 . "		<td width='30%'>Lote de trabajo</td>";
						$pTema2 = $pTema2 . "		<td>Nombre</td>";
						$pTema2 = $pTema2 . "	</tr>";
						...
						{
							$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
							$pTema2 = $pTema2 . "		<td width='30%'>".$dato_acti_lt["lote_control"]."</td>";
							$pTema2 = $pTema2 . "		<td width='30%'>".$dato_acti_lt["macroactividad"]."</td>";
					...
					else if($datos_tipo_activi_asig["tipoActividad"]==3)
					{
						...
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td  colspan='4'>Divisones</td>";
						$pTema2 = $pTema2 . "	</tr>";
		
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td width='25%'>Lote de control</td>";
						$pTema2 = $pTema2 . "		<td width='25%'>Lote de trabajo</td>";
						$pTema2 = $pTema2 . "		<td width='25%'>Divis&oacute;n</td>";
						$pTema2 = $pTema2 . "		<td >Nombre</td>";
						$pTema2 = $pTema2 . "	</tr>";
						...
						) as lote_trabajo, (select macroactividad from Actividades A2 where A2.id_proyecto=".$cualProyecto." and id_actividad=A1.actPrincipal) as lotes_control from Actividades  as A1
						where id_proyecto=".$cualProyecto." and id_encargado=".$datos_usuarios["id_encargado"]."  and nivel=3
						ORDER BY cast((substring(A1.macroactividad,3,charindex('.', (A1.macroactividad))-3)) as int)";
						...
						{
							$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_lt["lote_control"]."</td>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_lt["lote_trabajo"]."</td>";
							$pTema2 = $pTema2 . "		<td width='25%'>".$dato_acti_lt["macroactividad"]."</td>";
							$pTema2 = $pTema2 . "		<td >".$dato_acti_lt["nombre"]."</td>";
							$pTema2 = $pTema2 . "	</tr>";							
						}	
						$pTema2 = $pTema2 . "		</table>";
...
// colspan='3'
					else if($datos_tipo_activi_asig["tipoActividad"]==4)
					{
						...
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td  colspan='5'>Actividades</td>";
						$pTema2 = $pTema2 . "	</tr>";
		
						$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
						$pTema2 = $pTema2 . "		<td width='20%'>Lote de control</td>";
						$pTema2 = $pTema2 . "		<td width='20%'>Lote de trabajo</td>";
						$pTema2 = $pTema2 . "		<td width='20%'>Divis&oacute;n</td>";
						$pTema2 = $pTema2 . "		<td width='20%'>Actividad</td>";
						$pTema2 = $pTema2 . "		<td >Nombre</td>";
						$pTema2 = $pTema2 . "	</tr>";
						...
						$sql_acti="select A1.macroactividad,A1.nombre,A1.dependeDe,(select macroactividad from Actividades A2 where A2.id_proyecto=".$cualProyecto." and id_actividad=A1.dependeDe
						  ...
						  from Actividades  as A1 where id_proyecto=".$cualProyecto." and id_encargado=".$datos_usuarios["id_encargado"]." and nivel=4
						ORDER BY cast((substring(A1.macroactividad,3,charindex('.', (A1.macroactividad))-3)) as int)";
						...
						{
							$pTema2 = $pTema2 . "	<tr class='Estilo2'>";
							$pTema2 = $pTema2 . "		<td width='20%'>".$dato_acti["lote_control"]."</td>";
							...
							if($datos_lt_acti=mssql_fetch_array($cur_lt_acti))
								$pTema2 = $pTema2 . "		<td width='30%'>".$datos_lt_acti["lote_trabajo"]."</td>";
							$pTema2 = $pTema2 . "		<td width='20%'>".$dato_acti["division"]."</td>";
							$pTema2 = $pTema2 . "		<td width='20%'>".$dato_acti["macroactividad"]."</td>";
...
///temporal
					$sql_usu_acti=" select email from HojaDeTiempo.dbo.Usuarios where unidad=18121";
//temporal
	...
	echo $error." - $sql_secuen - ".mssql_get_last_message()."<br>";			
				...
				//inserta  la informacion de respuesta, que le da el director del proyecto
				$sql_up_solicitud="update  HojaDeTiempo.dbo.AutorizaEDT set validaVoBo=1, unidadVoBo=".$_SESSION["sesUnidadUsuario"].",comentaVoBo='".$observacion."',fechaVoBo=getdate(),usuarioMod=".$_SESSION["sesUnidadUsuario"].",fechaMod=getdate(),fechaIniProy=".$fechaInicio;
...
//		$mes= array("","Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
		...
		$sql_fecha_ini="select secuencia,fechaIniProy from HojaDeTiempo.dbo.AutorizaEDT  where id_proyecto=" . $cualProyecto." order by (secuencia) desc";
		$cur_fecha_ini=mssql_query($sql_fecha_ini);
		if($datos_fecha_ini=mssql_fetch_array($cur_fecha_ini))
			$fecha_ini=$datos_fecha_ini["fechaIniProy"];
?>
          <td class="TxtTabla"><input name="fecha" type="text" class="CajaTexto" id="fecha" value="<? echo $datos_fech["dia"]."/".$datos_fech[mes]."/".$datos_fech["ano"]; ?>" size="17" readonly ></td>
        </tr>
        <tr>
          <td  class="TituloTabla">Fecha de Inicio del Proyecto </td>
          <td class="TxtTabla"><input name="fechaInicio" type="text" class="CajaTexto" id="fechaInicio" value="<?php echo $fecha_ini; ?>" readonly /> <!-- readonly-->
<a href="javascript:cal.popup();"><img src="imagenes/cal.gif" width="16" height="16" border="0" /></a>
        ...
        <tr>
          ...
          <td class="TxtTabla"><input type="radio" name="enviar" id="enviar" value="1" <?php if(($enviar==1)){ echo "checked";  } ?>   onClick="document.Form1.submit();" >No <input type="radio" <?php if(($enviar==2)){ echo "checked";  } ?>  name="enviar" id="enviar" value="2"  onClick="document.Form1.submit();">Si
	      </td>
        </tr>
...
?>
        ...
        <tr>
          <td class="TituloTabla" colspan="2" align="center">
            <textarea name="observacion" id="observacion" cols="100%" rows="5"  maxlength="490" onKeyUp="return ismaxlength(this)"  onKeyPress=" return acceptComilla(event)"  ></textarea></td>
        </tr>
...
//				alert ("si");
				...
				document.write("enviando peticion 1 no ");
				document.Form1.submit();
				document.write("enviando peticion 2 no ");
		...
		if(document.Form1.enviar[1].checked)
		{
			...
			else
			{
				...
				document.Form1.recarga.value="2";
				document.write("enviando peticion 1 si ");
				document.Form1.submit();
				document.write("enviando peticion 2 si ");
			}
		}
