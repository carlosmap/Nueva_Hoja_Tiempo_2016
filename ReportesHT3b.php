...
$sql00=$sql00." H.id_proyecto, P.nombre nomProyecto, H.clase_tiempo, sum(H.horas_registradas) hFacturadas, A.salarioBase, U.id_categoria, C.nombre nomCat, P.codigo, P.cargo_defecto  ";
$sql00=$sql00." , H.cargo ";
...
$sql00=$sql00." group by H.unidad, U.nombre, U.apellidos, D.nombre, D.id_departamento, Z.nombre, Z.id_division, H.id_proyecto, P.nombre, H.clase_tiempo, A.salarioBase, U.id_categoria, C.nombre, P.codigo, P.cargo_defecto  ";
$sql00=$sql00." , H.cargo ";
$sql00=$sql00." UNION ";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  con facturaci&oacute;n </a></td>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right"><input type="submit" class="Boton" onclick="MM_openBrWindow('ReportesHT3bNovedades.php','wVentana','scrollbars=yes,resizable=yes,width=800,height=400')" value="Facturaci&oacute;n Proyectos de novedades" /></td>
      </tr>
    </table>
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
