...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><input name="BotonReg" type="submit" class="Boton" id="BotonReg" onclick="MM_goToURL('parent','ApruebaHT.php');return document.MM_returnValue" value="P&aacute;gina Principal Hoja de tiempo" />
    &nbsp;&nbsp;
<?
