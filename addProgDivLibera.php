...
if ($Comentario != "") {
	...
	if 	($pLibera == 1) {
		...
		$query2= "INSERT INTO BitacoraSumaGlobal (id_proyecto, unidadProgramador, comentaProgramador) " ;
	...
	echo ("<script>window.close();MM_openBrWindow('ProgDivisionDet.php?cualProyecto=$miProyecto','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');</script>");	
