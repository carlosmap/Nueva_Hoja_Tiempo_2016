...
function enviarCorreo($Para, $Asunto, $elTema, $laFirma){
	...
	$hdrs["From"] = "intranet@ingetec.com.co";
	$hdrs["To"] =  $Para ;
	$hdrs["Subject"] = $Asunto ;
	...
	//$smtpinfo["host"] = "200.26.137.33";
		//11Sep2014
	//Se bloqueó el siguinte código para habilitar el correo con Exchange.
	/*
	...
	*/
	...
	$smtpinfo["host"] = "192.168.30.145";
	$smtpinfo["port"] = "587";
	$smtpinfo["auth"] = true;
	
	$smtpinfo["username"] = "intranet@ingetec.com.co";
	$smtpinfo["password"] = "intr@2007";
...
function enviarCorreoSinHtml($Para, $Asunto, $elTema, $laFirma){
	...
	//$headers["From"] = "maildeveloper@ingetec.com.co";
	$hdrs["From"] = "intranet@ingetec.com.co";
