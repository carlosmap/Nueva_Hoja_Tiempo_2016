...
//--Consulta para traer los usuarios que no tienen aprobación de contratos 
//--o fue negada la aprobación de la HT
$sql2="Select U.* , C.nombre nomCategoria, D.nombre nomDpto, V.nombre nomDivision ";
$sql2=$sql2." from usuarios  U, categorias C, Departamentos D, Divisiones V ";
$sql2=$sql2." where NOT EXISTS  ";
$sql2=$sql2." 	( ";
$sql2=$sql2." 	Select *  ";
$sql2=$sql2." 	from AutorizacionesHT ";
$sql2=$sql2." 	where unidad = U.unidad ";
...
if ($pMes == "") {
	$sql2= $sql2. " AND mes = month(getdate()) ";
	$sql2= $sql2. " and vigencia = year(getdate()) ";
}
else {
	$sql2= $sql2. " AND mes = " . $pMes;
	$sql2= $sql2. " and vigencia =  " . $pAno;
}

$sql2=$sql2." 	and validaContratos = 1 ";
$sql2=$sql2." 	) ";
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr class="TxtTabla">
        ...
        <td width="5%">
		<?  if ($muestraJefe == "1") { ?>
		<a href="#"><img src="imagenes/imgPrint.gif" alt="Estado Impresi&oacute;n" width="14" height="14" border="0" onClick="MM_openBrWindow('upAutorizaHTimprime3.php?cualUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $miMesHT; ?>&cualAno=<? echo $MiAnnoHT; ?>','verUPImp','scrollbars=yes,resizable=yes,width=400,height=200')"></a>
		<? if ($cualImprimio == "1") {
				echo "OK";
			}
		 ?>		
