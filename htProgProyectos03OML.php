...
ASOCIADO    </option>
        ...
        <?
			$sqlEDT = "Select id_actividad, nombre, fecha_fin, fecha_inicio, macroactividad, nivel, id_encargado 
					   From HojaDeTiempo.dbo.TMPactividadesHT2 act Where id_proyecto = ".$cualProyecto;
			$qryEDT = mssql_query( $sqlEDT );
		?>
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr class="TituloTabla2">
            <td width="3%">ID</td>
            <td width="1%" align="center">
            <img src="img/images/imgInfoG.gif" alt="Seleccionar las macroactividades donde se har&aacute; programaci&oacute;n" width="29" height="23" />
            </td>
          ...
          <?	while( $row = mssql_fetch_array( $qryEDT ) ){	?>
          <tr class="TxtTabla">
            <td width="3%"><?=	$row[id_actividad]	?></td>
            <td width="1%" align="center">
            <input type="checkbox" name="id[]" value="<?= $row[id_actividad] ?>"  />             
            </td>
			...
			<?php	
				switch( $row[nivel] ){
					case 1:
						$tabla = "<tr> <td>  <b>".$row[nombre]."</b> </td></tr>";
					break;	
					
					case 2:
						$tabla = "<tr> <td width='25px'>&nbsp;</td> <td>".$row[nombre]."</td></tr>";
					break;	
					
					case 3:
						$tabla = "<tr> <td width='25px'>&nbsp;</td> <td width='25px'>&nbsp;</td> <td>".$row[nombre]."</td> </tr>";
					break;	
					
					case 4:
						$tabla = "<tr> <td width='25px'>&nbsp;</td> <td width='25px'>&nbsp;</td> <td width='25px'>&nbsp;</td> <td>".$row[nombre]."</td> </tr>";
					break;	
            ...
            <td width="15%"><?=	$row[id_encargado]	?></td>
            <td width="5%">$ 00.000.000 </td>
            <td width="1%">
            <?	
				$long = count( explode( '.', $row[macroactividad] ) );
				if( $long == 1 || $long == 2 ){
			?>
            <a href="#">
            <img src="img/images/icoAdd.gif" alt="Ingresar Lote de trabajo / Actividad" width="16" height="15" border="0" onclick="MM_openBrWindow('pnfaddLT.php','winHH','scrollbars=yes,resizable=yes,width=900,height=400')" />
            </a>
            <?	}	?>
            </td>
            <td width="1%">
			...
			?>
            <a href="#">            
            <img src="img/images/imgSeguimiento.gif" alt="Actividad en seguimiento" width="18" height="17" border="0" /></a>
            <?	}	?>
            </td>
            <td width="1%" class="TituloTabla2">&nbsp;</td>
            <td width="8%">
			<? 	
				#	 fecha_inicio, , 
				if( $row[fecha_inicio] != "" ){ 
					echo date( "M d Y ", strtotime( $row[fecha_inicio] ) ); 
				}else { 
			?>
		            aaaa/mm/dd
			<? } ?>
			...
			<? 	
				#	 , fecha_fin, 
				if( $row[fecha_fin] != "" ){ 
					echo date( "M d Y ", strtotime( $row[fecha_fin] ) ); 
				}else { 
			?>
		            aaaa/mm/dd
            <? } ?>
            </td>
            <td width="8%">$ 00.000.000 </td>
            <td width="1%">&nbsp;</td>
            <td width="1%">&nbsp;</td>
          </tr>
          <?	}	?>
          ...
          <tr>
            ...
            <input name="Submit10" type="submit" class="Boton" 
             onclick="MM_openBrWindow('pnfaddFechasValoresOML.php?proy=<?= $cualProyecto ?>','wAFV','width=900,height=400, scrollbars=1, resizable=1')" value="Relacionar Fechas y Valor del recurso" />
            </td>
          </tr>
        </table>
