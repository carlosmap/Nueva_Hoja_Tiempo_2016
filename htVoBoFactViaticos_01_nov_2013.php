...
//echo $error." *** <br>";
	...
	if($error=="no")
	{
		...
		echo "<script>alert('La operación se realizó con éxito')</script>";
			...
			echo "	<script>window.close();MM_openBrWindow('htFactViaticos.php?cualProyecto=".$cualProyecto."&pMes=".$pMes."&vigencia=".$vigencia."&recarga=2&activi=".$activi."','winFacturacionHT','toolbar=yes,scrollbars=yes,resizable=yes,width=960,height=700');</script>";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<input type="hidden" name="zz" id="zz" value="<?=$z ?>" >
		...
		<input name="Submit2" type="button" class="Boton" onClick="valida_2()" value="Aprobar facturación" /></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
  </tr>
