  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla"><input name="Submit6" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivARusu.php?cualProyecto=<? echo $cualProyecto; ?>','vadDP','scrollbars=yes,resizable=yes,width=500,height=350')" value="Ingresar" />
