...
if ($lPlazo != "") {
	...
	//Verifica que no exista programación en una fecha (mes y vigencia) posterior a la duración indicada
	//si hay programación no permite modificar el plazo con un valor menor
	$existeProgramacion = 0;
	$sql9="select count(*) hayProg from ProgSumaGlobalUsu ";
	...
	if ($existeProgramacion == 0) {
		...
		$query = "UPDATE  ProgSumaGlobal SET plazo= " . $lPlazo . ", ";	
		$query = $query . " valorSumaGlobal = " . $lvalor . " " ;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla"><? echo $pfechaInicio ;	?>
      <input name="miFecha" type="hidden" id="miFecha" value="<? echo $laFecha; ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="lvalor" type="text" class="CajaTexto" id="lvalor" value="<? echo $pvalorSumaGlobal; ?>">
