...
<table width="100%"  border="1" cellpadding="5" cellspacing="1" bordercolor="#D6D6D6">
      ...
      <tr align="center" bgcolor="<? echo $ColorOUT ?>"  >
		...
		<tr align="center" bgcolor="<? echo $ColorOUT ?>"  >
        <td height="30" class="menu" onClick=mClk(this); onMouseOver="mOvr(this,'<? echo $colorOVR ?>');" onMouseOut="mOut(this,'<? echo $ColorOUT ?>');"><a href="#" class="menu" onClick="MM_openBrWindow('htVoBoProyectos.php','winHojaTiempo','scrollbars=yes,resizable=yes,width=960,height=550')"> Aprobaci&oacute;n de la Facturaci&oacute;n de los Proyectos y los vi&aacute;ticos </a> </td>
      </tr>	  
	  <tr align="center" bgcolor="<? echo $ColorOUT ?>"  >
        <td height="30" class="menu" onClick=mClk(this); onMouseOver="mOvr(this,'<? echo $colorOVR ?>');" onMouseOut="mOut(this,'<? echo $ColorOUT ?>');"><a href="#" class="menu" onClick="MM_openBrWindow('htApruebaHT.php','winHojaTiempo','scrollbars=yes,resizable=yes,width=960,height=550')"> Aprobaci&oacute;n de la Hoja de Tiempo </a> </td>
      </tr>
	  <tr align="center" bgcolor="<? echo $ColorOUT ?>"  >
        <td height="30" class="menu" onClick=mClk(this); onMouseOver="mOvr(this,'<? echo $colorOVR ?>');" onMouseOut="mOut(this,'<? echo $ColorOUT ?>');"><a href="#" class="menu" onClick="MM_openBrWindow('htContratosHT.php','winHojaTiempo','scrollbars=yes,resizable=yes,width=960,height=550')"> Aprobaci&oacute;n de la Hoja de Tiempo - contratos </a> </td>
      </tr>
</table>
<table width="100%"  border="0" cellspacing="1" cellpadding="0">
  <tr>
