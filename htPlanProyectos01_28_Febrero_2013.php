	  ...
	  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla">
            ...
            <td width="1%"><img src="img/images/actualizar.jpg" width="19" height="17" onclick="MM_openBrWindow('upHtAsignaValorDiv.php?cualProyecto=<? echo $cualProyecto; ?>&cualLC=<? echo $reg02[id_actividad] ; ?>','winDedt','scrollbars=yes,resizable=yes,width=800,height=400')" /></td>
            <td width="1%"><img src="img/images/Del.gif" width="14" height="13" onclick="MM_openBrWindow('delEDTregLC.php?cualProyecto=<? echo $cualProyecto; ?>&cualLC=<? echo $reg02[id_actividad] ; ?>','winDedt','scrollbars=yes,resizable=yes,width=800,height=400')" /></td>
          </tr>
		  <? } ?>
        </table>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
