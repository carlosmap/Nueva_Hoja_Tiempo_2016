...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    &nbsp;
    <input name="Submit4" type="submit" class="Boton" onClick="MM_goToURL('parent','ContratosHTNoAprob.php');return document.MM_returnValue" value="Reporte Usuarios sin aprobaci&oacute;n"></td>
  </tr>
</table>
