...
$cursor = mssql_query($sql);
if ($reg=mssql_fetch_array($cursor)) {
	$mconCodNivel = $reg[conCodNivel] ;
	$mconCodProyecto = $reg[conCodProyecto] ;
	$mconCodTema = $reg[conCodTema] ;
	$mconCodLote = $reg[conCodLote] ;
	...
	$mconConsecutivoExt = $reg[conConsecutivoExt] ;
	  ...
	  <form action="" method="post" name="Form1" >
	    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
			...
			?>
			<input name="codNiv" type="radio" value="1" <? echo $SelSI; ?> disabled >
            Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            <input name="codNiv" type="radio" value="0" <? echo $SelNO; ?> disabled >
            No	
			</td>
          </tr>
          <tr>
          ...
          <tr>
			...
			?>
			<input name="codTem" type="radio" value="1" <? echo $SelSI; ?> disabled >
            Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            <input name="codTem" type="radio" value="0" <? echo $SelNO; ?> disabled >
            No			</td>
          </tr>
          <tr>
			...
			?>
			<input name="codLC" type="radio" value="1" <? echo $SelSI; ?> disabled >
            Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            <input name="codLC" type="radio" value="0"  <? echo $SelNO; ?> disabled >
            No			</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="TituloTabla">Tiene Consecutivo por proyecto? </td>
            <td class="TxtTabla">
			<?
			if ($mconConsecutivoExt == 1) {
				$SelSI="checked";
				$SelNO="";
			}
			else {
			...
			<input name="codSecE" type="radio" value="1" <? echo $SelSI; ?> disabled >
            Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            <input name="codSecE" type="radio" value="0" <? echo $SelNO; ?> disabled >
            No
			</td>
          </tr>
          <tr>
