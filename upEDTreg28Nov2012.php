...
if(trim($recarga) == "2")
{
		...
		if(trim($encargado)=="")
			$encargado="NULL";
//	        				nombre pJefe valor
		$sql_up_act="update Actividades set nombre='".$nombre."', id_encargado=".$encargado." where id_proyecto=".$cualProyecto." and id_actividad=".$cualACtividad." and dependeDe=".$cualDiv." and nivel=4";
...
?>
		...
		<tr>
			...
			<td class="TxtTabla"><input name="nombre" type="text" class="CajaTexto" id="nombre" value="<?php echo $nom_act; ?>" ></td>
