...
if ($recarga == "2") {
	...
	//id_proyecto, id_actividad, identificacion, servicio, valor, factor, unidad, fechaCrea
	$query = "UPDATE ActividadesPersonalExt SET servicio = '". $servicio ."', " ;
	$query = $query . " valor = " . $valor . ", " ;
	$query = $query . " factor = " . $factor . ", " ;
	$query = $query . " unidad =" . $laUnidad . ", ";
	$query = $query . " fechaCrea = '" . gmdate ("n/d/y") . "' ";		
    ...
    <td>    
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td class="TxtTabla"><input name="lNombre" type="text" class="CajaTexto" id="lNombre" value="<? echo $pnombre; ?>" size="50" readonly></td>
        </tr>
        <tr>
          <td class="TituloTabla">Apellidos</td>
          <td class="TxtTabla"><input name="lApellido" type="text" class="CajaTexto" id="lApellido" value="<? echo $papellidos; ?>" size="50" readonly></td>
        </tr>
        <tr>
          <td class="TituloTabla">Servicio</td>
          <td class="TxtTabla"><textarea name="servicio" cols="50" class="CajaTexto" id="servicio"><? echo $pservicio; ?></textarea></td>
        </tr>
        <tr>
          <td class="TituloTabla">Valor</td>
          <td class="TxtTabla"><input name="valor" type="text" class="CajaTexto" id="valor" value="<? echo $pvalor; ?>"></td>
        </tr>
        <tr>
          <td class="TituloTabla">Factor</td>
          <td class="TxtTabla"><input name="factor" type="text" class="CajaTexto" id="factor" value="<? echo $pfactor; ?>"></td>
        </tr>
      </table>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        <tr>
