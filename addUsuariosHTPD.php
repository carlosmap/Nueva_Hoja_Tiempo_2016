...
*/
		...
		//Información Departamento
		$ceSql02="Select UPPER(REPLACE(nombre, ' ', '')) nomDepto , id_division from HojaDeTiempo.dbo.Departamentos " ;
		$ceSql02=$ceSql02." where id_departamento = " . $Departamento ;
		$ceCursor02 = mssql_query($ceSql02);
		if ($ceReg02 = mssql_fetch_array($ceCursor02)) {	
		...
		$ceSql03="Select upper(REPLACE(nombre, ' ', '')) nomDivision from HojaDeTiempo.dbo.Divisiones " ;
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" bgcolor="#EAEAEA">
  ...
  <form action="addUsuariosHTPD.php" method="post" name = "addUsr" onSubmit="MM_validateForm('Unidad','','RisNum','Nombres','','R','Apellidos','','R','SitioContrato','','R','SitioTrabajo','','R','Email','','R','NombreCorto','','R','lFechaInicio','','R','Salario','','RisNum','lFechaNacimiento','','R','Documento','','RisNum');return document.MM_returnValue">
