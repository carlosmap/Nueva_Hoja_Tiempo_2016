...
<?
			//	include("grafico.php");
?>
				<img src='grafico.php?val_proy=<?=$val_proye ?>&val_fact=<?=$val_proye; ?>&val_planea=<?=$val_planea; ?>&titulo=<?='VL proyecto / VL facturado / VL planeado' ?>' border='0' width="695" height="289" />
			<?php //$url=
...
// graficos_barra( $val_proye,$val_proye,'Valores del proyecto'); ?>
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TituloTabla2">
            ...
            <td >Valor planeado Vs Facturado por Divisi&oacute;n </td>
          </tr>
<?
...
//echo $sql_division_valor_total."<br>".mssql_get_last_message();
	...
	?>
			 <tr class="TxtTabla">
						<td><?php echo $nom_div[$i]; ?></td>
						<td align="right" ><? echo  number_format($val_asignado[$i], "2", ",", "." ); ?></td>
	
						<td width="10%" align="right">$<?php echo number_format($val_planeado[$i], "2", ",", "." ); ?>
						</td>
                    ...
                    <?php
                     ...
                     if ($i==0)
                        { ?>
                       		 <td  align="right" rowspan="<? echo $cant_filas; ?>">  
			<?php
                ...
                ?>
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                <img src='grafico2.php?val_planeado=<?=$val_planeados; ?>&val_facturado=<?=$val_facturados; ?>&titulo=<?='Totales divisi&oacute;n' ?>&nom_div=<?=$arr_div[$id_div]  //$nom_divs; ?>' border='0' width="795" height="389" />
                                            </td>
                                        </tr>
                                    </table>
