...
/////// temporal			
				...
				$sql_usu_aprueba="select * from HojaDeTiempo.dbo.Usuarios where unidad IN(".$usu_firma." ,18121,20400 ) and retirado is null";
...
/*
			...
			$sql_usu_aprueba="select * from HojaDeTiempo.dbo.Usuarios where unidad in(".$usu_firma.",20400,18121) and retirado is null";
...
//////////////////////////////////////////////////////////////////temporal			
echo $error." -- <br>".$sql_usu_aprueba."<br> -- ".mssql_get_last_message();
*/
...
//echo "<br> *********************///////////////////////////////////ENTRO";
				...
				$sql_usu_acti=" select email from HojaDeTiempo.dbo.Usuarios where unidad IN (".$datos_usuarios["id_encargado"]." ,18121,20400 ) ";
///temporal
...
//echo "comit ";
					$cursorTran2 = mssql_query(" COMMIT TRANSACTION ");		
					include("email_activi_sin_responsable.php");
					echo ("<script>alert('Operaci\xf3n realizada satisfactoriamente.');</script>"); 
				} 
				else 
				{
