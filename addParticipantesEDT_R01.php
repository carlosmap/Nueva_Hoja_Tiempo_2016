...
//		$mail = "mail" . $i;
	...
	$division=0; //DEJA EL CAMPO DIVISION DE LA EMPRESA, CON LA OPCION "Seleccione una Division"
	if($okGuardar == "Si"){
...
///se ejecuta, cada vez que se seleeciona la division de la EDT
function selecciono()
{
	document.Form1.selecDivis.value="si";
}
function envia1()
{
...
*/
	...
	if(trim(document.Form1.unidad.value)=="")
	{
...
?>
				...
				<tr>
				  ...
				  <td class="TxtTabla"><span class="TxtTabla">
				    ...
				    <select name="Division" class="CajaTexto" id="Division" onChange="selecciono(); document.Form1.submit();" >
...
//								$division=$datos_div["id_division"]; 
								// SI SE HA SELECCIONADO LA DIVISION DE LA EDT, Y LA DIVISION DE LA EMPRESA, NO ESTA SELECCIONADA SE CARGA ESTE CAMPO CON LA DIVI DE LA EDT
								if((trim($division)==0)and(trim($selecDivis)=="si") ) //si se selecciona la division de la EDT (selecDivis=si)
								{
									$division=$datos_div["id_division"]; 
...
?>
  ...
  <tr>
	...
	<input name="selecDivis" type="hidden" id="selecDivis" value="no"> 
