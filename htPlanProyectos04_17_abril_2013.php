...
?>
				  <tr class="TxtTabla">
					<td><? echo strtoupper( $datos_div_asignado["nombre"]); ?></td>
					<td align="right" ><? echo  number_format($datos_div_asignado["valorAsignado"], "2", ",", "." ); ?></td>
<?php
...
echo $z;
		?>
			<tr class="TituloTabla">
				...
				<td  align="right">$<? echo number_format($total_valor_planeado_division, "2", ",", "." )  ?></td>
				<td  align="right">$0</td>
				<td></td>
			</tr>
