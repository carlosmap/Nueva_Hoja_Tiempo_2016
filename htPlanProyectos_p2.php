...
function envia()
{
	window.location="http://www.ingetec.com.co/NuevaHojaTiempo/htPlanProyectos_p2.php?pagina=1&pNombre="+document.form1.pNombre.value+"&cod="+document.form1.cod.value+"&cargo="+document.form1.cargo.value+"&pOrden="+document.form1.pOrden.value+"&pProyecto="+document.form1.pProyecto.value+"";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	for ($p=1; $p<= $totalPaginas; $p++) 
	{
		...
		echo "<a href='htPlanProyectos_p2.php?pagina=".$p."&pNombre=".$pNombre."&cod=".$cod."&cargo=".$cargo."&pOrden=".$pOrden."&pProyecto=".$pProyecto."' class='".$clase."'>".$p."</a> | ";
	}
	?>
	</td>
  </tr>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="TxtTabla"><strong>Número de resultados:&nbsp;<? echo mssql_num_rows($cursor); ?></strong></td>
  </tr>
</table>
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
