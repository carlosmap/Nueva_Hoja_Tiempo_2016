...
if ($lNombre != "") {
	...
	$query = $query . " id_encargado, avance_reportado, resumen_avance, actPrincipal, tipoActividad, nivelesActiv) ";
	...
	echo ("<script>window.close();MM_openBrWindow('ProgProyectosActivSS.php?cualProyecto=$miProyecto&cualActividad=$pIdActiv','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');</script>");	
