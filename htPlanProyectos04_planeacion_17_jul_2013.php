...
*/
		...
		$sql_parti="
			...
			where PlaneacionProyectos.id_actividad=".$datos_act_edt["id_actividad"]." and PlaneacionProyectos.id_proyecto=".$cualProyecto." and PlaneacionProyectos.vigencia=".$lstVigencia;
