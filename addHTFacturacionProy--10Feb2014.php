...
//							alert (horasFactPrevias);
						...
						/*
						if (parseFloat(regTiempoNormal) == 0) {
							//alert (horasFactPrevias);
							document.Form1.elements[d].value = "";
							alert("No puede grabar tiempo extra si no registra tiempo normal en el formulario de captura de horas facturadas. Por favor corrija la información. Debe registrar previamente facturación en clase de tiempo 1, 2 y/o 3 para registrar tiempo extra.");
						}
						*/
