...
if ($fechaI != "") {
	...
	$query = "INSERT INTO ProgSumaGlobal(id_proyecto, unidadProgramador, fechaInicio, plazo, valorSumaGlobal)   " ;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="lvalor" type="text" class="CajaTexto" id="lvalor">
