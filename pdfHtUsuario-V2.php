<?php
	...
	$sqlNombre = 'SELECT A.nombre, A.apellidos FROM Hojadetiempo.dbo.Usuarios A WHERE unidad ='.$cualUnidadUsu;
	...
	$fName = $cualUnidadUsu.'-'.ucfirst($info['nombre']).' '.ucfirst($info['apellidos']).'-'.$mesesFile[$cualMesUsu].'_'.$cualVigenciaUsu;
	...
	*/
	...
	##	***
	$html = cabecera($cualUnidadUsu, $cualMesUsu, $cualVigenciaUsu);
	
	$pdf->writeHTML($html, true, false, true, false, '');

	$tabla = infoHTUsuario($cualUnidadUsu, $cualMesUsu, $cualVigenciaUsu);
	$pdf->writeHTML($tabla, true, false, true, false, '');
	
	$firmas = firmasHt($cualUnidadUsu, $cualMesUsu, $cualVigenciaUsu);
	...
	$detalle = detalleHt($cualUnidadUsu, $cualMesUsu, $cualVigenciaUsu);
