...
//			echo "El Horario=" . $vRegv03[IDhorario] ;
	...
	if ($tReg=mssql_fetch_array($tCursor)) {
		...
		//12Mar2014
		//PBM
		//Se agrega la siguiente línea para exceptuar de la validación vertical de las personas que hacen uso del horario 10x3 de Proyecto Quimbo
		$exceptuarValidacion=$tReg[haceValidacion]; 
	}
...
//	if (trim($elTipoContrato) == "TC" ) {
	if ( (trim($elTipoContrato) == "TC" ) AND ($exceptuarValidacion != 0) ) {
		$fechaAsumar="";
		$esDiaValido="";
		$mensajeDia="";
		$esFestivo="";
