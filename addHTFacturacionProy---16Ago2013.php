...
function validaFila(fila, horasValidaDia){ 
...
//					}
            ...
            <table width="100%"  border="0" cellspacing="1" cellpadding="0">
              ...
              <tr class="TxtTabla">
                ...
                <td width="7%"><select name="lstHorario<? echo $r; ?>" class="CajaTexto" id="lstHorario<? echo $r; ?>" style='width:100px; ' onChange="envia1()" >
                  <option value=""> </option>
				  <?
				  ...
				  ?>
				  <option value="<? echo $reg05['IDhorario']; ?>" <? echo $sellstHorario; ?> ><? echo strtoupper($reg05['NomHorario']) . "[" . $reg05['Lunes'] . "-" . $reg05['Martes'] . "-" . $reg05['Miercoles'] . "-" . $reg05['Jueves'] . "-" . $reg05['Viernes'] . "-" . $reg05['Sabado'] . "-" . $reg05['Domingo'] . "]"; ?></option>
				  <? } // cierra while reg05 ?>
                </select>
				<?
			  ...
			  ?>
				...
				?>
				<input name="<? echo $d2; ?>regDia<? echo $r; ?>" type="text" class="CajaTexto" id="<? echo $d2; ?>regDia<? echo $r; ?>" size="1" onKeyPress="return acceptNum(event)" onBlur="validaFila(<? echo $r;?>, <? echo $horasAvalidarDia; ?>)">
				<? 
