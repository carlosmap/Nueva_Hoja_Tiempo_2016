...
//	else
	...
	//echo ${$elpJefe}."  ---<br>";
			...
			$sqlIn1=$sqlIn1."dependeDe, actPrincipal, tipoActividad, nivelesActiv, nivel,id_division,usuarioCrea,fechaCrea  ";
			...
			$sqlIn1 = $sqlIn1 . " '4' ";
			$sqlIn1 = $sqlIn1 . " ,".$divi_selec.",".$_SESSION["sesUnidadUsuario"].",getdate()  ";
			if(trim(${$valor})!="")
			{
					$sqlIn1=$sqlIn1."," . ${$valor};			
			}
