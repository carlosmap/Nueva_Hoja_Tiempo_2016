...
{
	$valor_actividades_division=$datos_valor_actividades_division["sumaLT"];
}
//echo "valor de las actividades de la division ".$valor_actividades_division;
...
/*
	...
	if(($valor_total_act+$valor_actividades_division)>$valor_division)
	{
		echo "<script type='text/javascript'> alert('El valor de las actividades supera el valor asignado a la division, por favor verifique el valor asignado a cada actividad.');</script>";
	}
*/
?>
