...
$sqlB=$sqlB." FROM BitacoraAsignaRecursos B, Usuarios P, Usuarios C ";
	  ...
	  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
         ...
         <? while ($reg4=mssql_fetch_array($cursor4)) {  ?>
          <tr class="TxtTabla">
            ...
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivARusu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=500,height=350')" /></a>
			<? } ?>
			</td>
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivARusu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=600,height=350')" /></a>
			<? } ?>
			</td>
          </tr>
		<? } ?>  
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<input name="Submit7" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivLiberaAR.php?cualProyecto=<? echo $cualProyecto; ?>','vaPL','scrollbars=yes,resizable=yes,width=500,height=100')" value="Liberar Programaci&oacute;n" />
			<? } ?>
			</td>
          </tr>
        </table>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
         ...
         <? while ($reg6=mssql_fetch_array($cursor6)) {  ?>
          <tr class="TxtTabla">
            ...
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<span class="TxtTabla"><a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivCat.php?cualProyecto=<? echo $cualProyecto; ?>&cualItem=<? echo $reg6[id_categoria] ?>','vPDC','scrollbars=yes,resizable=yes,width=500,height=100')"  /></a></span>
			<? } ?>
			</td>
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<span class="TxtTabla"><a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivCat.php?cualProyecto=<? echo $cualProyecto; ?>&cualItem=<? echo $reg6[id_categoria] ?>','vPDC','scrollbars=yes,resizable=yes,width=500,height=100')" /></a></span>
			<? } ?>
			</td>
          </tr>
		  <? } ?>
