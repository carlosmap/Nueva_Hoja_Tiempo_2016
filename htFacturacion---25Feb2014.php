...
//				}
              ...
              <td width="1%" class="TxtTabla"><img src="img/images/Del.gif" width="14" height="13" onclick="MM_openBrWindow('delHTporReg.php?cualProyecto=<? echo $reg02['id_proyecto']; ?>&cualActiv=<? echo $reg02['id_actividad']; ?>&cualHorario=<? echo $reg02['IDhorario']; ?>&cualLocaliza=<? echo $reg02['localizacion']; ?>&cualClaseT=<? echo $reg02['clase_tiempo']; ?>&cualCargo=<? echo $reg02['cargo']; ?>&cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winDelReg','scrollbars=yes,resizable=yes,width=700,height=500')" /></td>
            </tr>
			<? 
			} //while $reg02
			?>
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right" class="TxtTabla"><input name="Submit5" type="submit" class="Boton" onclick="MM_openBrWindow('delHTtodaHT.php?cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winDelHTHT','scrollbars=yes,resizable=yes,width=1400,height=500')" value="Eliminar toda la Hoja de tiempo" /></td>
            </tr>
          </table></td>
      </tr>
    </table>
