...
//Si todas las validaciones fueron correctas, el formulario hace submit y permite grabar
	if ( (v1=='s') && (v2=='s') && (v3=='s') && (v4=='s') && (v5=='s') && (v6=='s') && (v7=='s') && (v8=='s')) {
		document.Form1.recarga.value="2";
		document.Form1.submit();
	}
	else {
		mensaje = msg1 + msg2 + msg3 + msg4 + msg5 + msg6 + msg7 + msg8;
		alert (mensaje);
	}
}
...
//					}
  ...
  <tr>
	...
	<input name="frmErr02" type="hidden" id="frmErr02" value="<? echo $error02; ?>">
	<input name="frmErr01" type="hidden" id="frmErr01" value="<? echo $error01; ?>">
