...
if ($miSecuencia != "") {
	...
	$query = "DELETE FROM SolicitudHoras " ;
...
//		$sql2="Select * from Proyectos order by nombre " ;
  ...
  <tr align="center">
    <td colspan="2" class="TxtTabla"><strong>&iquest;Est&aacute; seguro de eliminar este registro?</strong></td>
  </tr>
  <tr>
    <td colspan="2" align="right" class="TxtTabla"><input name="Submit2" type="button" class="Boton" onClick="MM_callJS('window.close()')" value="Cancelar">      <input name="Submit" type="submit" class="Boton" value="Borrar"></td>
  </tr>
</table>
      </form>
  	</td>
