...
<?
  ...
  <tr>
	...
	<input name="recarga" type="hidden" id="recarga" value="2">      
      ...
      <? if ($pHorasRep <= 0)  { ?>
	  <input name="Submit" type="submit" class="Boton" onClick="envia3()" value="Borrar y Continuar">
	  <input name="Submit" type="submit" class="Boton" onClick="envia2()" value="Borrar y Cerrar">
	  <? }?>
	</td></tr>
</table>
      </form>
