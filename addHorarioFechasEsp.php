...
if ($miHorario != "") {
	...
	$vSql1="select * from FechasEspeciales " ;
	...
	if ($vReg1=mssql_fetch_array($vCursor1)) {
		...
		$query = "INSERT INTO FechasEspeciales (IDhorario, Fecha, CuantasHoras ) " ;
	...
	echo ("<script>window.close();MM_openBrWindow('fechasEspeciales.php?cualHorario=$miHorario','winFechas','toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=400');</script>");	
}
