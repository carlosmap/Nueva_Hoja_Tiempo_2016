...
//echo "-4 ".$sql_div_lt."  --  ".mssql_get_last_message()." <br><br>";
			...
			if($datos_div_lt=mssql_fetch_array($cur_div_lt))
			{
				...
				echo ("<script>alert('No se puede mover la divisi\xf3n seleccionada porque en el lote de trabajo destino existe una divisi\xf3n con el mismo nombre.');</script>");
