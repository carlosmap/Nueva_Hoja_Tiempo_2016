		...
		$val_proye=0;
          ...
          <tr class="TxtTabla" >
			<td valign="top" width="35%" >
        	    ...
        	    <td  align="center" colspan="4"><img src='grafico.php?val_proy=<?=$val_proye ?>&val_fact=<?=$val_proye; ?>&val_planea=<?=$val_planea; ?>&titulo=<?='Vl proyecto vs Vl planeado vs Vl facturado ' ?>' border='0' width="765" height="329" />
			<?php //$url=
...
?>
			  <tr valign="top" >
			    <td width="35%" valign="top" >
				  ...
				  <table width="100%">
			        ...
			        <td class="TituloTabla2" width="35%" >Fecha de Inicio </td>
                          ...
                          <tr class="TxtTabla">
                            <td class="TituloTabla2" width="35%" >Fecha Finalizaci&oacute;n (Maxima fecha planeada)</td>
			    ...
			    <td align="center" class="TxtTabla" ><?php
                                                    ...
                                                    $val_facturados=array_url($val_facturado);
                                    ?>
								<img src='grafico3.php?duracion=<?=$cant_meses; ?>&m_transcurridos=<?=$cant_meses_transcurridos; ?>&amp;titulo=<?='Valor planeado Vs Facturado por 
...
<?
	...
	{
?>
<img src='gant_chars5.php?act_array=<?=$url ?>&F=<?=$f ?>&f_i=<?=$activid__inicio_fin[0][0] ?>&f_f=<?=$activid__inicio_fin[$f-1][1] ?>'  width="765" height="119">
<?
	}
?>
