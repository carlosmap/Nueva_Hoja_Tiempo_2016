...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?
	//13Nov2007
	//Para que no aparezca el botón Tramite contratos para el reporte de sin aprobación del jefe o sin envio a jefe
	if ($Muestra == "Aqui es") {
	?>
...
//										echo "<td>$viaticos[$i]</td>";
		...
		<TD COLSPAN=6> $kfechaEnvio <br>  $miFechaIngreso <br> $miFechaRetiro </TD>
