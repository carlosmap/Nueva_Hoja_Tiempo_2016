...
//echo $inf_proy."<br>";
			...
			$pTema = $pTema . "	</tr>";
			$pTema = $pTema . "	<tr class='Estilo2'>";
			$pTema = $pTema . "		<td width='30%'>Fecha prevista para el inicio del proyecto:</td>";
			$pTema = $pTema . "		<td width='70%'>".$fechaPrevista."</td>";
			$pTema = $pTema . "	</tr>";
			$pTema = $pTema . "	<tr class='Estilo2'>";
			$pTema = $pTema . "		<td>&nbsp;</td>";
			$pTema = $pTema . "		<td>&nbsp;</td>";
			$pTema = $pTema . "	</tr>";
			$pTema = $pTema . "	<tr class='Estilo2'>";
			$pTema = $pTema . "		<td width='30%'>Fecha de solicitud:</td>";
			...
			$pTema = $pTema . "	</tr>";
			$pTema = $pTema . "	<tr class='Estilo2'>";
			$pTema = $pTema . "		<td colspan='2'><br>Ya se encuentra  finalizada la EDT del proyecto. ".strtoupper($inf_proy).". Se requiere su VoBo para proceder a la planificaci&oacute;n del recurso. </td>";
			$pTema = $pTema . "	</tr>";
...
//			while($datos_hora=mssql_fetch_array($cur_hora))
	...
	echo $error." - $sql_secuen - ".mssql_get_last_message()."<br><br>";			
			if($datos_secuen=mssql_fetch_array($cur_secuen))
				...
				$sql_ins_solicitud=$sql_ins_solicitud.",enviaAFirma,validaElabora,fechaMod,usuarioCrea,fechaCrea,usuarioMod,unidadVoBo)";
				...
				$sql_ins_solicitud=$sql_ins_solicitud.", 1,1,getdate(),".$_SESSION["sesUnidadUsuario"].",getdate(),".$_SESSION["sesUnidadUsuario"].",".$usu_firma." ) ";
...
?>
        ...
        <tr>
          ...
          <td class="TxtTabla"><input name="fechaPrevista" type="text" class="CajaTexto" id="fechaPrevista" readonly />
        ...
        <tr>
          ...
          <td class="TxtTabla">
            <select name="usu_firma" id="usu_firma">
              <option value=""></option>
<?php
/*
...
?>
        ...
        <tr>
          <td class="TituloTabla" colspan="2" align="center">
            <textarea maxlength="999" onKeyUp="return ismaxlength(this)"  name="observacion" id="observacion" cols="100%" rows="5" value="<?php echo $observacion; ?>"   onKeyPress=" return acceptComilla(event)"  ></textarea></td>
        </tr>
