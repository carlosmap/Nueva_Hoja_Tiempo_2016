...
<script language="javascript" type="text/javascript">
	...
	function valida()
	{
		...
		{
			msg = msg + 'El ADP que esta intentando registrar abarca 2 meses.\nRegistre primero el día que inicia, hasta el día que finaliza en el mes. Y en el siguiente mes,  ingresa desde el primer día hasta el día que finaliza.';
		}
/*
		else
		{
          ...
          <td colspan="5"  class="TxtTabla"><!-- readonly-->
            ...
            <!--
              ...
              <tr>
                ...
                <td align="left" class="TxtTabla"><input type="text" class="CajaTexto" name="adp" id="adp" value="<?= $adp ?>" onKeyPress="return acceptNum(event);" /></td>
                </tr>
