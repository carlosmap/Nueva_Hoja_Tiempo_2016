...
//	alert(filaVacia);
	...
	//alert(horasUsuario);	
	if (parseFloat(horasUsuario) < parseFloat(document.Form1.mesHorasOfi.value)) {
		v10='n';
		msg10 = 'Las personas de tiempo completo deben relacionar al menos la cantidad de horas de oficina para el mes y vigencia seleccionados. \n';
	}
...
//				echo $pFechaFacturacionTime . "<br>"; 
				...
				echo "vA=" . $pvalorActividadFila . "<br>";
				echo "vDe=" . $pvalorDivDependeDeFila . "<br>";
				...
				echo "vfA=" . $pvalActFacturadoFila . "<br>";
				...
				echo "vfAx=" . $pvalDependeDeFacturadoFila . "<br>"; 
