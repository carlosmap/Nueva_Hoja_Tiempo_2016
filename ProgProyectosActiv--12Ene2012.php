  ...
  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<? if (($laUnidad == 12974) OR ($laUnidad == 15712)) { ?>	
			<input name="Submit4" type="button" class="Boton" onclick="MM_openBrWindow('addProgramaRetirados.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $cualActividad ; ?>&pfDivision=<? echo $pfDivision; ?>&miDpto=<? echo $miDpto; ?>&pFiltro=<? echo $pFiltro; ?>','verAdP','scrollbars=yes,resizable=yes,width=580,height=350')" value="Programar Retirados" />		
