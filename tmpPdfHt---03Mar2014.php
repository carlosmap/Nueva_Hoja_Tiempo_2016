<?php
	...
	function infoHTUsuario($unidad, $mes, $vigencia)
	{
		...
		$tabla = $tabla .'<th width="3%" align="center"><strong>'.$total.'</strong></th>
						...
						<th width="12%">&nbsp;<strong></strong></th>
				</tr>';
		#	*****

		$col = 5 + $totalDiasMes;
		$tabla = $tabla .'<tr class="TituloTabla2"><th colspan="'.$col.'"> RELACI&Oacute;N DE VIÁTICOS</th></tr>';
...
//					echo $reg12['diaIniV'] . " - " . $reg12['diaFinV'] . "<br>";
				...
				$tabla = $tabla .'<th width="3%" align="center"><strong>'.$totCantViaticos.'</strong></th>
								<th width="4%" align="center"><strong></strong></th>
								<th width="12%">&nbsp;<strong>'.$reg11['NomTipoViatico'].'</strong></th>
							  </tr>';
	...
	function detalleHt($unidad, $mes, $vigencia)
	{
		$sqlInfo = '';
		$detalle = '
				<table rules="all" border="1" width="100%" cellpadding="5" cellspacing="0" style="border: solid double 1px;">
					<tr>
						<td width="5%">&nbsp;<strong>Dia</strong></td>
						<td width="95%">&nbsp;<strong>Resumen</strong></td>
					</tr>';
		$totalDiasMes = date("t",$mes);
	...
	function resumen()
	{
		...
		<table width="100%" rules="all" border="1" style="border: double solid 2px;" cellspacing="0" cellpadding="0">
				<tr>
					<td width="11%" align="center">CT CLASE DE TIEMPO</td>						
					<td width="11%" align="center">HORARIO</td>					
					<td width="11%" align="center">CT CLASE DE TIEMPO</td>						
					<td width="11%" align="center">HORARIO</td>					
					<td width="12%" align="center">FIRMA DEL EMPLEADO</td>					
					<td width="11%" align="center">Vo.Bo. JEFE INMEDIATO</td>					
					<td width="11%">Vo.Bo. JEFE DEPARTAMENTO</td>						
					<td width="11%" align="center">CONTRATOS</td>					
					<td width="11%" align="center">PERSONAL</td>					
				</tr>
				<tr>
					<th>
						&nbsp;1 Ordinario<br />
