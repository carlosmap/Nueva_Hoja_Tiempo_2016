...
*/
$sql2 = " SELECT H.unidad , U.nombre, U.apellidos, U.NombreCorto, A.nombre nomActividad, H.cargo, H.clase_tiempo, 
...
<table width="100%"  cellspacing="1" class="fondo">
  <? if($cantRegistros == 0){ ?>
  <tr align="center">
    <td colspan="10" class="TxtTabla">La b&uacute;squeda no obtuvo resultados </td>
  </tr>
  <tr align="center">
    <td colspan="10" class="TxtTabla"><input name="Submit3" type="button" class="Boton" onClick="MM_callJS('window.close();')" value="Cerrar Ventana"></td>
  </tr>
  <? } else { ?>
  <tr align="right">
  ...
  <tr class="TxtTabla">
    ...
    <td><? echo strtoupper($reg2['NombreCorto']); ?></td>
