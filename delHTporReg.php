...
include "validaUsrBd.php";
		...
		if($recarga==2)
		{
			...
			$sql_elimi_Vobo="delete from  VoBoFirmasHT where vigencia=".$cualVigencia." and unidad=".$laUnidad." and mes=".$cualMes;
...
//echo $sql_update."<br>".mssql_get_last_message()."<br><br>";
			...
			//CONSULTA SI EXITE FACTURACION, PARA LA ACTIVIDAD
			$sql_consu=" select * from  FacturacionProyectos
				  WHERE FacturacionProyectos.unidad = ".$laUnidad." AND mes =  ".$cualMes." AND vigencia = ".$cualVigencia." AND FacturacionProyectos.id_proyecto = ".$cualProyecto." AND FacturacionProyectos.id_actividad = ".$cualActiv."  and esInterno='I' ";
			$cur_consu=mssql_query($sql_consu);

//echo $sql_consu."<br>".mssql_get_last_message()."<br>-- ".mssql_num_rows($cur_consu)."<br>";

			//SI NO HAY REGISTROS DE FACTURACION, SE ELIMINA EL VOBO DE LA ACTIVIDAD
			if(mssql_num_rows($cur_consu)==0)
			{
				$sql_del="delete FROM VoBoFactuacionProyHT WHERE id_proyecto=".$cualProyecto." and id_actividad=".$cualActiv." and unidad=".$laUnidad." and vigencia=".$cualVigencia." and mes= ".$cualMes."  and esInterno='I' ";
...
<table width="100%"  border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td align="center" class="TxtTabla">
      ...
      <strong>Al proceder, tambien se eliminara el VoBo del jefe inmediato</strong><br>
	 <strong>&#191;Esta seguro de eliminar los registros seleccionados?</strong>
	</td>
  </tr>
  <tr>
