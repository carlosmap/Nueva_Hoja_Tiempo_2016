  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="TituloTabla2">
        ...
        <td width="30%">Proyecto /  Horas facturadas Mes actual </td>
        <td width="5%">&nbsp;</td>
        </tr>
       <?
	  ...
	  <tr class="TxtTabla">
		...
		$sQry="select H.id_proyecto, sum(H.horas_registradas) horasFact, P.nombre ";
		...
		$sQry=$sQry." group by H.id_proyecto, P.nombre ";
  ...
  <tr>
    <td align="left" bgcolor="#FFFFFF" class="TxtTabla">
	  <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
          ...
          <tr>
            <td align="left"><? echo ucwords(strtolower($regQry[nombre])); ?></td>
