...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td class="TxtTabla"><input name="pUnidad" type="text" value="<?= $pUnidad ?>" class="CajaTexto" id="pUnidad"></td>
  </tr>
  <tr>
...
?>
        ...
        <td width="1%">
		<?  if ($muestraJefe == "1") { ?>
		<img src="img/images/actualizar.jpg" alt="Editar VoBo Contratos" width="19" height="17" style="cursor: hand"  onclick="MM_openBrWindow('upVoBoContratosHT.php?cualUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $pMes; ?>&cualAno=<? echo $pAno; ?>','vUPjef','scrollbars=yes,resizable=yes,width=600,height=300')" >
		<? } ?>
		</td>
        <td width="1%">
		<?  if ($muestraJefe == "1") { ?>
        ...
        <td width="5%">
		<?  if ($muestraJefe == "1") { ?>
		<img src="imagenes/imgPrint.gif" style="cursor:hand;" alt="Estado Impresi&oacute;n" width="14" height="14" border="0" onClick="MM_openBrWindow('upHTimprime.php?cualUnidad=<? echo $reg[unidad]; ?>&cualMes=<? echo $miMesHT; ?>&cualAno=<? echo $MiAnnoHT; ?>','verUPImp','scrollbars=yes,resizable=yes,width=400,height=200')">
		<? 
		if ($cualImprimio == "1") {
				echo "OK";
			}
        ...
        <tr>
          <td align="right" class="TxtTabla">
            ...
            <?
				...
				if($revision!='')
				{
					$link2 = $link2 .'&revision='.$revision;
				}
				if($pEmpresa!='')
				{
					$link2 = $link2 .'&pEmpresa='.$pEmpresa;
				}
				if($pDivision!='')
				{
					$link2 = $link2 .'&pDivision='.$pDivision;
				}
				if($pDepto!='')
				{
					$link2 = $link2 .'&pDepto='.$pDepto;
				}
				if($pUnidad!='')
				{
					$link2 = $link2 .'&pUnidad='.$pUnidad;
				}
				if($pCategoria!='')
				{
					$link2 = $link2 .'&pCategoria='.$pCategoria;
				}
				if($pRetirado!='')
				{
					$link2 = $link2 .'&pRetirado='.$pRetirado;
				}
				if($pNombre!='')
				{
					$link2 = $link2 .'&pNombre='.$pNombre;
				}
		  ?>
            <input onClick="MM_openBrWindow('xlsReporteUsuarios.php?cualVigencia=<?= $pAno ?>&cualMes=<?= $pMes.$link2 ?>','winPDFht','scrollbars=yes,resizable=yes')" type="button" value="Reporte usuarios" class="Boton" />
