	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td class="TituloTabla">Cantidad de Horas Mes-Vigencia </td>
...
//					}
  ...
  <tr>
    <td align="right" class="TxtTabla"><input name="usuDepartamentoUsu" type="hidden" id="usuDepartamentoUsu" value="<? echo $miDepartamentoUsu; ?>">    <input name="mesHorasOfi" type="hidden" id="mesHorasOfi" value="<? echo $miHorasOficina; ?>">    <input name="usuSalarioUsu" type="hidden" id="usuSalarioUsu" value="<? echo $miSalarioUsu ; ?>">
