...
///temporal
				$sql_usu_acti=" select email from HojaDeTiempo.dbo.Usuarios where unidad in (18121,20400)";
//temporal
...
?>
        ...
        <tr>
          ...
          <td class="TxtTabla"><input name="fechaInicio" type="text" class="CajaTexto" id="fechaInicio" value="<?php echo date("n/d/Y ", strtotime($fecha_ini)); ?>" readonly /> <!-- readonly-->
