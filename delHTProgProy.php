...
if ($elProyecto != "") {
	...
	//Realiza la eliminación de los programadores del proyecto
	$query = "DELETE FROM Programadores  " ;
	...
	echo ("<script>window.close();MM_openBrWindow('htPlanProyectos01.php?cualProyecto=$elProyecto','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');</script>");	
}
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Planeaci&oacute;n de Proyectos - Programadores del proyecto </td>
  </tr>
</table>
