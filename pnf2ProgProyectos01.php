                  ...
                  <table width="100%"  border="0" cellspacing="1" cellpadding="0">
                    <tr>
                      ...
                      <td align="left" class="TxtTabla"><select name="select" class="CajaTexto">
                        ...
                        <option value="1">GERENCIA DE PROYECTOS</option>
                        <option value="2">GEOTECNIA</option>
                        <option value="3">PLANEAMIENTO</option>
                        <option value="4">VIAS</option>
...
ASOCIADO    </option>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla">
            ...
            <td><strong>GERENCIA DE PROYECTOS</strong></td>
            ...
            <td width="1%"><a href="#"><img src="img/images/icoAdd.gif" alt="Ingresar Lote de trabajo / Actividad" width="16" height="15" border="0" onclick="MM_openBrWindow('pnfaddLT2.php','winHH','scrollbars=yes,resizable=yes,width=1200,height=400')" /></a></td>
          ...
          <tr class="TxtTabla">
            ...
            <td>[4417] Hector Alfredo L&oacute;pez
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right"><? 
			//Solo es visible por los responsables y/p programadores de la actividad
          ...
          <tr class="TxtTabla">
            ...
            <td>[12974] Gonzalo rodr&iacute;guez
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right"><? 
			//Solo es visible por los responsables y/p programadores de la actividad
          ...
          <tr class="TxtTabla">
            <td>11</td>
            <td align="center"><input type="checkbox" name="checkbox11" value="checkbox" /></td>
            <td>LT1.2</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            ...
            <td>[17206] Fernando Garz&oacute;n
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right"><? 
			//Solo es visible por los responsables y/p programadores de la actividad
          ...
          <tr class="TxtTabla">
            <td>15</td>
            <td align="center"><input type="checkbox" name="checkbox15" value="checkbox" /></td>
            <td>&nbsp;</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            <td>20</td>
            <td align="center"><input type="checkbox" name="checkbox20" value="checkbox" /></td>
            <td>&nbsp;</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            ...
            <td align="center">&nbsp;</td>
            <td>&nbsp;</td>
            <td><strong>PLANEAMIENTO</strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr class="TxtTabla">
            <td>14</td>
            <td align="center"><input type="checkbox" name="checkbox14" value="checkbox" /></td>
            <td>&nbsp;</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            <td>13</td>
            <td align="center"><input type="checkbox" name="checkbox13" value="checkbox" /></td>
            <td>LT2.1</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            <td>17</td>
            <td align="center"><input type="checkbox" name="checkbox17" value="checkbox" /></td>
            <td>&nbsp;</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
          ...
          <tr class="TxtTabla">
            <td>18</td>
            <td align="center"><input type="checkbox" name="checkbox18" value="checkbox" /></td>
            <td>LT2.2</td>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="3%">&nbsp;</td>
            ...
            <td>[15252] Julio Gonz&aacute;lez
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right"><? 
			//Solo es visible por los responsables y/p programadores de la actividad
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla"><input name="Submit2" type="submit" class="Boton" onclick="MM_openBrWindow('pnfaddLC2.php','winHH','scrollbars=yes,resizable=yes,width=900,height=400')" value="Asignaci&oacute;n de recursos por Divisi&oacute;n" /></td>
          </tr>
        </table>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
