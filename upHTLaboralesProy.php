...
//		echo $query2; 
	...
	echo ("<script>window.close();MM_openBrWindow('htPlanProyectoConfig.php?cualProyecto=$miProyecto&pAno=$miVigencia','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');</script>");	
}

?>
<html>
<head>
<title>Configuraci&oacute;n del Proyecto - D&iacute;as y Horas laborales del proyecto</title>
