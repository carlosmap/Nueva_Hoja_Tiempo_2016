...
*/
		...
		//03Sep2013
		//Convierte la empresa segun lo solicitado por Guillermo para el envio de correo 
		if($pEmpresa == 1) {
			$pEmpresaMail="SA";
		}
		if($pEmpresa == 2) {
...
//		$pPara= "mhtiempo@ingetec.com.co";
		$pPara= "usuarioshtd@ingetec.com.co";
		$pAsunto= "Novedades de personal - NUEVO ";
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    ...
    <td width="68%" class="TxtTabla"><label>
      <input name="Unidad" type="text" class="CajaTexto" id="Unidad" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" >
    </label></td>
  </tr>
  <tr>
...
//	  	$sqlDpto = "select * from departamentos ";
  ...
  <tr>
    <td class="TituloTabla">Email sin dominio (SIN caracteres especiales, tildes, &ntilde;) </td>
    <td class="TxtTabla"><input name="Email" type="text" class="CajaTexto" id="Email" onKeyPress="if (event.keyCode < 97 || event.keyCode > 122) event.returnValue = false;" ></td>
  </tr>
  <tr>
	...
	<option value = "1/4">Cuarto de Tiempo
	<option value = "1/8">Octavo de Tiempo
        </select></td>
  </tr>
  <tr>
