...
$sql2="Select A.unidad , U.nombre, U.apellidos, C.nombre nomCategoria, D.nombre nomDpto, V.nombre nomDivision   ";
...
$sql2= $sql2." UNION ";
$sql2= $sql2." Select U.unidad, U.nombre, U.apellidos, C.nombre nomCategoria, D.nombre nomDpto, V.nombre nomDivision  ";
...
$sql2= $sql2."  	)  ";
$sql2= $sql2."  and U.unidad <> 20400 and U.unidad <> 52979709  ";
$sql2= $sql2."  and U.retirado is null  ";
$sql2= $sql2."  and U.id_categoria = C.id_categoria ";
$sql2= $sql2."  and U.id_departamento = D.id_departamento ";
$sql2= $sql2."  and D.id_division = V.id_division ";
$sql2= $sql2." and D.id_division <> 11 ";
$sql2= $sql2."  and U.fechaIngreso <= CONVERT(DATETIME, '".$estaFecha."', 102) ";
$sql2= $sql2."  and U.fechaIngreso  is not null ";
