...
$sql02=$sql02." AND A.vigencia = " . $cualVigencia ;
...
//echo $sql_update."<br>".mssql_get_last_message()."<br><br>";
			...
			echo "	<script>window.close();MM_openBrWindow('htFacturacion.php?cualMes=".$cualMes."','winFacturacionHT','toolbar=yes,scrollbars=yes,resizable=yes,width=960,height=700');</script>";
...
<script language="javascript" type="text/javascript">
	...
	function valida(mes)
	{
		if(confirm('Desea eliminar toda la facturaci\xf3n para el mes '+mes+'?'))
		{
...
<table width="100%"  border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td align="center" class="TxtTabla"><strong>Atención: Esta operación es irreversible. No podra recuperar la información de la vigencia y mes seleccionado.</strong></td>
  </tr>
  <tr>
    <td align="center" class="TxtTabla"><strong>&#191;Esta seguro de eliminar toda la información asociada 
...
?>
          <input name="guardar" type="button" class="Boton" id="guardar" value="Eliminar" onClick="valida('<?=$mes[$cualMes] ?>')" >
<?
			//PENDIENTE
?>
