...
?>
<?php
if ($_SESSION["sesUnidadUsuario"] == 15061) {
?>

<form action="HtiempoDiquis.php" method="post" name="frm">
...
echo "<tr ><td class='tituloTabla'><b>Proyecto:</td><td class='txtTabla'>Proyecto El Diquis</td></tr>";
...
$sql="SELECT RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto,
		...
		WHERE     (fecha BETWEEN $cadfecha) AND (unidad = '$laUnidad') and RTRIM(localizacion) + '-' + RTRIM(cargo) <> '1-1199' and id_proyecto = 869 order by dia";
