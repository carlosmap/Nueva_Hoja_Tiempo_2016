...
$sql=$sql." and id_proyecto = 824 " ; //Quitar esta línea para que aparezcan todos los proyecto
//9Jul2008
...
$sql=$sql." and P.id_proyecto = 824 " ; //Quitar esta línea para que aparezcan todos los proyecto
...
<title>Aprobaci&oacute;n de vi&aacute;ticos de hojas de tiempo</title>
</head>


<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<? include("bannerArriba.php") ;  ?>
	<div class="TxtNota1" style="position:absolute; left:141px; top:11px; width: 652px; height: 25px;">
	  <div align="center"> 
		  Aprobaci&oacute;n de Vi&aacute;ticos de los <br>
	    proyectos a cargo 
		</div>
</div>
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="TituloTabla2">
        ...
        <td width="10%">Cantidad de personas que viaticaron </td>
        <td width="10%">Cantidad de personas con autorizaci&oacute;n </td>
...
<?		}		?>
        ...
        <td width="5%"><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','lstApruebaViaticosHT.php?cualProyecto=<? echo $reg[id_proyecto]; ?>&pMes=<? echo $pMes; ?>&pAno=<? echo $pAno ;?>');return document.MM_returnValue" value="Detalle" /></td>
        </tr>
	  ...
	  <tr class="TxtTabla">
	    ...
	    <td align="center">&nbsp;</td>
	    <td>
		<input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','lstApruebaViaticosHT.php?cualProyecto=42&pMes=<? echo $pMes; ?>&pAno=<? echo $pAno ;?>');return document.MM_returnValue" value="Detalle" />
		</td>
	    </tr>
