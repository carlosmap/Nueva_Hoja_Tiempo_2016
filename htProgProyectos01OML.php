...
$sql02=$sql02." from TMPActividadesHT2 A, Usuarios U";
...
Programaci&oacute;n de proyectos - TMPActividadesHT2 </div>
                ...
                <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table width="100%"  border="0" cellspacing="1" cellpadding="0">
                    <tr>
					  ...
					  $lstSqlLC="SELECT * FROM TMPActividadesHT2 ";
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla">
			...
			<a href="#"><img src="img/images/icoNew.gif" alt="Ingresar TMPActividadesHT2" width="16" height="15" border="0" onclick="MM_openBrWindow('addHtTMPActividadesHT2.php?cualProyecto=<? echo $cualProyecto; ?>&cualLC=<? echo $reg02[actPrincipal] ; ?>&cualLT=<? echo $reg02[dependeDe] ; ?>&cualDiv=<? echo $reg02[id_actividad] ?>&cualIDdiv=<? echo $reg02[id_division] ?>','winHH','scrollbars=yes,resizable=yes,width=900,height=400')" /></a>
			<? } ?>			
			</td>
            <td>
			<table width="100%"  border="0" cellspacing="1" cellpadding="0">
			...
			$sql03=$sql03." FROM TMPActividadesHT2 ";
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <input name="Submit7" type="submit" class="Boton" onclick="MM_openBrWindow('delEDTtotal.php?cualProyecto=<? echo $cualProyecto; ?>','winDelEDT','scrollbars=yes,resizable=yes,width=500,height=400')" value="Eliminar EDT" /></td>
            </tr>
          </table>
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
          ...
          <tr class="TxtTabla">
            ...
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td width="3%">&nbsp;</td>
                <td>TMPActividadesHT2 DE SOPORTE A LA GERENCIA DEL PROYECTO</td>
              </tr>
            </table></td>
