...
if(trim($recarga) == "2")
{
	...
	$sql_del="update HojaDeTiempo.dbo.Actividades set valor=NULL where id_proyecto=".$cualProyecto;
...
-->
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
		...
		<tr>
          ...
          <td  align="center" class="TxtTabla">Nota: Se eliminaran, todos los recursos asigandos a las actividades y divisiones. Esta operaci&oacute;n es irreversible.<br/><br />
¿Esta seguro de eliminar los recursos de las actividades y divisiones? </td>
