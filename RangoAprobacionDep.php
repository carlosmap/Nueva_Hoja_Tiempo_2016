...
function regresa(){
	location.href='rpte_director_departamento.php';
}
var newwindow;
...
<form name=reporte action="RangoAprobacionDep.php" method="post">
	<table>
...
if($valor=="generar"){
	...
	if($mesI[0] == $mesF[0]){
		...
		Si en el rango de fechas todas las horas están aprobadas, el sistema visualizará la APROBADO</td></tr>
		<tr><td> </td></tr></table>
		...
		WHERE (Departamentos.id_departamento = $dirDep and usuarios.retirado is null) order by nombre";
