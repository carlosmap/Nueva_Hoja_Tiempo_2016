  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="TituloTabla2">
        ...
        <td width="60%">Actividades Programadas / Clase tiempo / Cargo / Horas / Horas facturadas mes </td>
    ...
    <td align="left" bgcolor="#FFFFFF" class="TxtTabla">
	  <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
          ...
          <tr>
            ...
            <td width="20%" align="right"><? echo $regQry[clase_tiempo]; ?></td>
            <td width="20%" align="right"><? echo $regQry[cargo]; ?></td>
            <td width="20%" align="right"><? echo $regQry[tiempo_asignado]; ?></td>
	  ...
	  <tr class="TxtTabla">
	    <td colspan="4" bgcolor="#999999"><img src="img/images/Pixel.jpg" width="1" height="1" /></td>
	    </tr>
	  <? } ?>
    </table>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
