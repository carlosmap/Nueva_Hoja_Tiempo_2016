...
if($recarga==1)
{
	...
	//SI NO SE HA SELECCIONADO  NINGUNA ACTIVIDAD, SE CONSULTA TODA LA INFORMACION DE LOS PARTICIPANTES, EN LAS DIFERENTES ACTIVIDADES
...
//PARA ADECUAR LA PAGINACION, SE DEBE REALIZAR UNA CONSULTA SUPERIOR,  CON LAS ACTIVIDADES QUE TIENEN PLANEACION EN LA EDT, TRAYENDO EL ID DE LAS ACTIVIDADES
		...
		//CONSULTA TODAS LAS ACTIVIDADES DE LA EDT
 ...
 from PlaneacionProyectos
		...
		//		if( ( (isset ( $Lote_control))&&( isset($Lote_trabajo))&&( isset($Division))&&( isset($Actividad)) )   )
			...
			?>
				...
				<form name="Form2" id="Form2" method="post" action="http://www.ingetec.com.co/NuevaHojaTiempo/htPlanProyectos04_planeacion_detalle_total.php?cualProyecto=<?=$cualProyecto; ?>&V=<?=$lstVigencia; ?>">
                      ...
                      <tr class="TituloTabla2">
                        <td colspan="17" align="left" >
							<table width="100%">
								...
								<? $ll=0; while( $ll<((int)$datos_act_edt["nivel"]) ){ echo " &nbsp;"; $ll++; } echo $macros; ?>
									</td>
...
?>
                      ...
                      <tr class="TxtTabla">
                        ...
                        <td width="5%">
<?
						$sql_total="select  SUM(hombresMes) as total_H_M from PlaneacionProyectos where id_proyecto=".$datos_parti["id_proyecto"]." and id_actividad=".$datos_parti["id_actividad"]." and vigencia=".$datos_parti["vigencia"]." and  unidad=".$datos_parti["unidad"] . " and esInterno='".$datos_parti["esInterno"]."' ";
...
<?
						$sql_total="select  SUM(hombresMes) as total_H_M  , mes  from PlaneacionProyectos where id_proyecto=".$datos_parti["id_proyecto"]." and id_actividad=".$datos_parti["id_actividad"]." and vigencia=".$datos_parti["vigencia"]." and  unidad=".$datos_parti["unidad"] . " and esInterno='".$datos_parti["esInterno"]."'   group by mes ";
//echo $sql_total." *********** <br><br>";
						...
						{
							$total_perso=$datos_total["total_H_M"];		
...
?>
                	        <td width="4%"   background="<?  echo $imagene_P[$ind]; ?>" ></td>                        
<?
						}		
						if($ban==0)
						{
