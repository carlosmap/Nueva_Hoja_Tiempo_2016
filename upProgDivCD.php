...
if ($lValor != "") {
	...
	if ($lValor == 0) {
		...
		//Realiza la actualización del costo en la tabla ProgSumaGlobalCostosD
		//id_proyecto, unidadProgramador, secuencia, item, valorItem
		$query = "UPDATE ProgSumaGlobalCostosD SET " ;
		$query = $query . " item = '" . $lCosto . "',  ";	
		$query = $query . " valorItem = " . $lValor ;			
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="TxtTabla">
	<input name="lCosto" type="text" class="CajaTexto" id="lCosto" value="<? echo $pitem; ?>" size="70">
	<input name="cualProyecto" type="hidden" id="cualProyecto" value="<? echo $cualProyecto; ?>">
	</td>
  </tr>
  <tr>
    <td class="TituloTabla">Valor</td>
    <td class="TxtTabla"><input name="lValor" type="text" class="CajaTexto" id="lValor" value="<? echo $pvalorItem; ?>">
