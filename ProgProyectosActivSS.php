...
//			echo "=" . $cuantasAsignaciones;
            ...
            <td width="1%">
			<? if ($verProyecto=="SI") {   ?>
			<a href="#"><img src="img/images/icoSubActv.gif" alt="Insertar Subactividad" width="25" height="23" border="0" onclick="MM_openBrWindow('addSubActivSS.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $reg2[id_actividad] ; ?>','adSA','scrollbars=yes,resizable=yes,width=500,height=300')" /></a>
			<? }
				else {		?>
			<a href="#"><img src="img/images/icoSubActv.gif" alt="Insertar Subactividad" width="25" height="23" border="0" onclick="MM_openBrWindow('addSubActivRespSS.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $reg2[id_actividad] ; ?>','adSA','scrollbars=yes,resizable=yes,width=500,height=300')" /></a>				
			<? } ?>
			</td>
          </tr>
		  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<? if ($verProyecto=="SI") {   ?>
            <input name="Submit" type="submit" class="Boton" onclick="MM_openBrWindow('addActivSS.php?cualProyecto=<? echo $cualProyecto ; ?>','vAddA','scrollbars=yes,resizable=yes,width=500,height=300')" value="Insertar" />
			<? } 
			else {
			?>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla">
			<input name="Submit4" type="submit" class="Boton" onclick="MM_openBrWindow('addProgramaR.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $cualActividad ; ?>','verAdP','scrollbars=yes,resizable=yes,width=580,height=280')" value="Insertar" />			</td>
          </tr>
        </table></td>
      </tr>
    </table>
