...
if(trim($recarga) == "2")
{
	...
	$sql_del="delete  HojaDeTiempo.dbo.ParticipantesActividad where id_proyecto=".$cualProyecto;
...
//echo mssql_get_last_message(); 
	...
	if  ($error=="no")  
	{	
		$sql_del2="delete from ParticipantesExternos where id_proyecto=".$cualProyecto;
		$cur_del2=mssql_query($sql_del2);
	//echo mssql_get_last_message(); 
		if  (trim($cur_del2) == "")  
		{
			$error="si";
...
//$cursorTran2 = mssql_query(" ROLLBACK TRANSACTION ");
	...
	echo ("<script>window.close();MM_openBrWindow('htPlanProyectos02.php?cualProyecto=".$cualProyecto."','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=950,height=600');</script>");
...
-->
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
		...
		<tr>
          ...
          <td  align="center" class="TxtTabla">Nota: Se eliminaran, todos los participantes asigandos en las actividades y divisiones. Esta operaci&oacute;n es irreversible.<br/><br />
¿Esta seguro de eliminar  los participantes asignados en las actividades y divisiones? </td>
