...
//27Sep2013
//Si la persona ya tiene VoBo de Contratos, no se puede modificar el VoBo de personal
$sql=$sql." and H.unidad not in( ";
$sql=$sql." 	select unidad  ";
$sql=$sql." 	from HojaDeTiempo.dbo.AutorizacionesHT  ";
$sql=$sql." 	where validaContratos = '1' ";
$sql=$sql." 	and mes = " . $pMes;
$sql=$sql." 	and vigencia = " . $pAno;
$sql=$sql." ) ";
...
if ($pProyecto != "") {
	...
	while ($s <= $pCantidadItem) {
		...
		if (${$elTipoOperacion} == 0) {
			...
			//id_proyecto, vigencia, mes, unidad, unidadEncargado, validaEncargado, comentaEncargado, fechaAprEnc
			$query2 = "INSERT INTO AprobacionFacHT(id_proyecto, vigencia, mes, unidad, unidadEncargado, validaEncargado, comentaEncargado, fechaAprEnc) ";
