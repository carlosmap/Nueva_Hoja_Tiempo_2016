	  ...
	  <? } ?>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
         ...
         <? while ($reg4=mssql_fetch_array($cursor4)) {  ?>
          <tr class="TxtTabla">
            ...
            <td width="1%"><a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivUsu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=500,height=350')" /></a></td>
            <td width="1%"><a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivUsu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=600,height=350')" /></a></td>
          </tr>
		<? } ?>  
        </table>
        <? if ($existeAsignaRec == 0) { ?>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr class="TxtTabla">
            ...
            <td width="1%"><a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivCD.php?cualProyecto=<? echo $cualProyecto; ?>&cualCosto=<? echo $reg6[secuencia] ; ?>','vUpPDCD','scrollbars=yes,resizable=yes,width=500,height=100')" /></a></td>
            <td width="1%"><a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivCD.php?cualProyecto=<? echo $cualProyecto; ?>&cualCosto=<? echo $reg6[secuencia] ; ?>','vUpPDCD','scrollbars=yes,resizable=yes,width=500,height=100')" /></a></td>
          </tr>
		  <? } ?>
		  <tr class="TxtTabla">
		    <td>&nbsp;</td>
