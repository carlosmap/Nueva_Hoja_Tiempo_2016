...
//echo $sql_up_act."<br><br>".mssql_get_last_message();
		...
		if($cualDIvision==$datos_div["id_actividad"])  //si el registro que se esta extrayendo de la BD es el que se va a eliminar
		{
					...
					///eliminamos los recursos asignados
					$sql_del_act="delete ActividadesRecursos where id_proyecto=".$cualProyecto." and id_actividad=".$cualDIvision;
...
//echo $sql_ele_act."<br><br>".mssql_get_last_message();
					...
					$sql_part_act="delete from ParticipantesActividad   where id_proyecto=".$cualProyecto." and id_actividad=".$cualDIvision." ";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="TituloUsuario">Eliminar Divisi&oacute;n </td>
  </tr>
</table>
