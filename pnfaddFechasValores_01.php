...
$cur_fecha_ini_proyecto=mssql_query("select DAY(fechaIniProy) as dia,  month(fechaIniProy) as mes, YEAR(fechaIniProy) as ano from HojaDeTiempo.dbo.AutorizaEDT where id_proyecto=".$cualProyecto);
...
//alert(document.getElementById(fechai).value);
	...
	//, por favor verifique las fechas ingresadas
						...
						//valida que la fecha de inicio de la  actividad, no sea superior a la fecha de inicio del proyecto
						else if (compare_fecha(document.getElementById(fechai).value,"<? echo $datos_fecha_ini_proyecto[mes]."/".$datos_fecha_ini_proyecto[dia]."/".$datos_fecha_ini_proyecto[ano]; ?>"))
						{  
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
	...
	<td class="TxtTabla"><? echo $datos_fecha_ini_proyecto[mes]."/".$datos_fecha_ini_proyecto[dia]."/".$datos_fecha_ini_proyecto[ano]; ?></td>
  </tr>
        <tr>
          <td></td>
        </tr>
