...
$sql3=$sql3." 	where unidad = Usuarios.unidad  ";
//filtra el resultado de la consulta si la página se carga por primera vez con el mes y año actual
//sino con lo seleccionado en las listas mes y año
if ($pMes == "") {
...
$sql3=$sql3." 	) ";
$sql3=$sql3." and unidad <> 20400 and unidad <> 52979709 "; //Para que no aparezca Patricia Barón y Jeimi Suarez
$sql3=$sql3." and retirado is null  ";
