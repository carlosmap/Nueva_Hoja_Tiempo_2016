...
//				}
			  ...
			  ?></td>
                  <td width="1%"><img src="img/images/alertaAzul.gif" alt="ADP" width="15" height="16" onclick="MM_openBrWindow('htVtnAdp.php?cualProyecto=<? echo $reg02['id_proyecto']; ?>&cualActiv=<? echo $reg02['id_actividad']; ?>&cualHorario=<? echo $reg02['IDhorario']; ?>&cualLocaliza=<? echo $reg02['localizacion']; ?>&cualClaseT=<? echo $reg02['clase_tiempo']; ?>&cualCargo=<? echo $reg02['cargo']; ?>&cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winvtnres1','scrollbars=yes,resizable=yes,width=400,height=600')" /></td>
                </tr>
              </table>
</td>
