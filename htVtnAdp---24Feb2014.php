...
?>
    <tr>
      <td colspan="4" align="right" class="TxtTabla">
		<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addVtnAdp.php?cualProyecto=<?= $cualProyecto ?>&cualActiv=<?= $cualActiv ?>', '', 'scrollbars=yes,resizable=yes,width=350,height=250')" value="Agregar ADP">
		<!--
