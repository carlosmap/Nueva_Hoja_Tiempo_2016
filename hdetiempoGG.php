...
<form action="hdetiempoGG.php" name=reporte method="post">
<?
...
*/
			...
			if($resultado=mssql_query($sql)){
				...
				if(mssql_num_rows($resultado)>0){
					...
					$codigo=$filas[codigo];
					$idActividad=$filas[id_actividad];  //20140325
...
*****************************************************************************************************/
 ...
 $tipoViatico = $filas[IDTipoViatico];
								...
								*/
								...
								$viaticos[-1]="<font face='Arial' size=2>".$codigo." [".substr($nomdelProyecto,0,10)."]"."</font>";
								//$viaticos[-1] = $codigo;
