...
//	if ($difMkt <= 5529600){
//	if ($difMkt <= 8035200){
//Para 180 días (180*24*60*60) = 15552000
//Para 8 meses 240 días (240*24*60*60)
	//if ($difMkt <= 31104000){
	
	//25Nov2013
	//Levantar la restricción por instrucción de GRM
	//if ($difMkt <= 62104000){
...
/*	
//25Nov2013
//Quitar la restricción por instrucción de GRM
	else{
...
//		echo "<script>alert('No esta permitido eliminar un registro con más de tres mes de antigüedad')</script>"; 
		echo "<script>alert('No esta permitido eliminar un registro con más de 12 mes de antigüedad')</script>";
	}
*/	
}
?>
