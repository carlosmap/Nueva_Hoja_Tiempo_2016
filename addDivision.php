...
if($Nombre != "") {
	...
	//Valida que el nombre de la división exista
	...
	if(mssql_num_rows($cursorDep) > 0) {
		echo "<script>alert('Este nombre de división ya existe en esta dependencia. Por favor corríjalo')</script>";
	...
	$insDep="INSERT INTO Divisiones (nombre, id_dependencia, id_director ) " ;
	$insDep=$insDep." VALUES ( " ;
	$insDep=$insDep." '" . $Nombre . "', "  ;
	$insDep=$insDep.$miDependencia . ", "  ;
	if (trim($pJefe) == "") {
		$insDep=$insDep."NULL" ;
	}
	else {
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Ingreso de Divisiones </td>
  </tr>
</table>
