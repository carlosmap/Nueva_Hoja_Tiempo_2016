...
<?php
	...
	if( $recarga == 2 )
	{
		...
		$sql_elimina_participantes="delete  from ParticipantesActividad WHERE  id_proyecto=".$cualProyecto ;
		$cur_elimina_particiapntes=mssql_query($sql_elimina_participantes);
//echo mssql_get_last_message()."*** ".$cur_elimina_particiapntes;
		if  (trim($cur_elimina_particiapntes) != "")
		{
...
<form action="" method="post" enctype="multipart/form-data"  name="Form1">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="TituloUsuario">Eliminar participantes </td>
    </tr>
</table>
...
?>
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
            <tr>
                <td class="TxtTabla" align="center"><strong>¿Desea eliminar todos los participantes asociados a las actividades de la EDT?</strong></td>
	        </tr>
    	    <tr>
