...
//  if($_SESSION["sesUnidadUsuario"] == 15712 or $_SESSION["sesUnidadUsuario"] == 16374 or $_SESSION["sesUnidadUsuario"] == 15850 or $_SESSION["sesPerfilUsuario"] == 1){ 
  ...
  //11Sep2013 EniraMaria Mejia y Aleyda Cerquera
  if($_SESSION["sesUnidadUsuario"] == 15712 or $_SESSION["sesUnidadUsuario"] == 16374 or $_SESSION["sesUnidadUsuario"] == 15850 or $_SESSION["sesPerfilUsuario"] == 1 or $_SESSION["sesUnidadUsuario"] == 18897  or $_SESSION["sesUnidadUsuario"] == 14319){   
  ?>
  <tr>
    <td align="right">
