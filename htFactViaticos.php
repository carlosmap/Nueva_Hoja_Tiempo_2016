...
//--unidadContratos, validaContratos, comentaContratos, fechaContratos, seImprimio, usuarioCrea, fechaCrea, usuarioMod, fechaMod
  ...
  $sql15 = $sql15 . " AND A.unidad = " . $datos_usu["unidad"] ;
  ...
  if ($reg15 = mssql_fetch_array($cursor15)) {
	...
	?>
	<? 
			//Si la Hoja de tiempo ya tiene VoBo no se puede facturar más. ni cambiar los VoBo de los proyectos.
			if ($tieneVBJefe != '1') { ?>
...
?>
	<img src="img/images/Si.gif" alt="VoBo Jefe que aprueba la Hoja de tiempo" width="16" height="14" /> <br>
  <?
