...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="TxtNota2" style="position:absolute; left:3px; top:55px; width: 639px; height: 30px;"> CONSOLIDADO POR DIVISION
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr>
	        <td width="15%" height="20" class="FichaAct"><a href="htPlanProyectoConsolidadoDiv.php" class="FichaInAct1" >Divisi&Oacute;n VS Proyectos</a>
    	    <td width="15%" height="20" class="FichaInAct" >Usuarios por Proyecto</td>
...
?>
                ...
                <tr class="TxtTabla" >
                  <td  align="center" class="TituloTabla2">Proyecto</td>
