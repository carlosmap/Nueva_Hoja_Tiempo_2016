...
if ($recarga == 2)
{
	...
	$sqlIns = "INSERT INTO HojaDeTiempo.dbo.horasydiasLaboralesProy
			   (id_proyecto, vigencia, mes, hOficina, hCampo, diasLaborales)
			   VALUES
			   ($id_proyecto, $vigencia, $mes, '$hOficina', '$hCampo', $diasLaborales)";
	//echo $sqlIns;
	//exit;
...
function enviar(){ 
var v1, v2, v3, v4, v5, msg1, msg2, msg3, msg4, msg5, mensaje;
v1='s';
v2='s';
v3='s';
v4='s';
...
msg5='';
	...
	if (isNaN(document.Form1.oficina.value)) {
		document.Form1.recarga.value="1";
		v4='n';
		msg4='El campo Oficina debe ser numérico. \n'
	}if (isNaN(document.Form1.campo.value)) {
		document.Form1.recarga.value="1";
		v5='n';
		msg5='El campo de Campo debe ser numérico. \n'
	}
  ...
  <tr>
    <td bgcolor="#FFFFFF">
	  <form action="" method="post" name="Form1" >
	    ...
	    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td width="25%" align="right" class="TxtTabla"><input name="miProyecto" type="hidden" id="miProyecto" value="<? echo $cualProy; ?>">
