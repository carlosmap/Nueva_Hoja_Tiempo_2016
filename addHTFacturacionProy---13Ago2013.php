...
//					}
            ...
            <table width="100%"  border="0" cellspacing="1" cellpadding="0">
			  ...
			  ?>
				...
				<input name="<? echo $d2; ?>regDia<? echo $r; ?>" type="text" class="CajaTexto" id="<? echo $d2; ?>regDia<? echo $r; ?>" size="1" onKeyPress="return acceptNum(event)" onBlur="validaFila(<? echo $r;?>)"></td>
				<? 
				} //cierra for d2
				?>
