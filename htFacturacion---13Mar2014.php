...
//				}
			...
			?>
			  <img src="img/images/icoCuantia.gif" alt="Vi&aacute;ticos" width="16" height="16" style="cursor: hand" onclick="MM_openBrWindow('addHtViaticosP.php?cualProyecto=<? echo $reg02['id_proyecto']; ?>&cualActiv=<? echo $reg02['id_actividad']; ?>&cualHorario=<? echo $reg02['IDhorario']; ?>&cualLocaliza=<? echo $reg02['localizacion']; ?>&cualClaseT=<? echo $reg02['clase_tiempo']; ?>&cualCargo=<? echo $reg02['cargo']; ?>&cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winvtnres1','scrollbars=yes,resizable=yes,width=500,height=580')" />
...
//					echo $reg12['diaIniV'] . " - " . $reg12['diaFinV'] . "<br>";
	...
	?>			
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right" class="TxtTabla"><input name="Submit62" type="submit" class="Boton" onclick="MM_openBrWindow('pdfHtUsuario-V2.php?cualUnidadUsu=15712&cualVigenciaUsu=<? echo $pAno; ?>&cualMesUsu=<? echo $pMes; ?>','winPDFht','scrollbars=yes,resizable=yes,width=700,height=500')" value="Generar PDF v2" />                <input name="Submit6" type="submit" class="Boton" onclick="MM_openBrWindow('pdfHtUsuario.php?laUnidad=<? echo $laUnidad; ?>&cualVigencia=<? echo $pAno; ?>&cualMes=<? echo $pMes; ?>','winPDFht','scrollbars=yes,resizable=yes,width=700,height=500')" value="Generar PDF" />
                <? 
			//Si la Hoja de tiempo ya tiene VoBo no se puede facturar más.
			if ($tieneVBJefe != '1') { ?>
