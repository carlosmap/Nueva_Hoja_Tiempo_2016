...
//13Nov2007
//Mostrar los usuarios que facturaron el el proyecto Acta Modificación Bilateral No 10 Porce III (12.12)
//para Heidy Zambrano
$sql="Select distinct h.unidad , u.nombre , u.apellidos ";
$sql=$sql." from horas h, usuarios u " ;
$sql=$sql." where h.unidad = u.unidad " ;
//corresponde al proyecto Acta Modificación Bilateral No 10 Porce III o Porce III - Amb 11 o Porce III - AMB 12 o Porce Iii-amb 13
$sql=$sql." and (h.id_proyecto = 393 or  h.id_proyecto = 697 or  h.id_proyecto = 905 or  h.id_proyecto = 1168 or  h.id_proyecto = 1464) " ; 
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr class="TxtTabla">
        ...
        <td width="5%">
		<input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','verhdetiempoPorceIII.php?zUnidad=<? echo $reg[unidad]; ?>&Flmes=<? echo $zMesActual; ?>&Flano=<? echo $zVigenciaActual; ?>');return document.MM_returnValue" value="Ver Hoja" /></td>
        </tr>
	  <? } ?>
    </table>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
