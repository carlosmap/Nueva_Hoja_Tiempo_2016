...
<table width="100%"  border="1" cellspacing="1" cellpadding="0">
  <tr>
    <td colspan="9"><strong>::: Directores y Coordinadores de Proyectos Hoja de Tiempo::: </strong></td>
  </tr>
  <tr>
    <td width="5%"><strong>C&oacute;digo</strong></td>
    <td><strong>Proyecto</strong></td>
    <td width="12%"><strong>Director/Coordinador</strong></td>
    <td width="12%"><strong>Mail Director/Coordinador</strong></td>
  ...
  <tr valign="top" class="TxtTabla">
    ...
    <td width="12%" align="center"><table width="100%"  border="0" cellspacing="1" cellpadding="0">
      <tr>
