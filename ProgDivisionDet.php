...
$sql7=$sql7." and unidadProgramador =" . $laUnidad ;
...
$sql8=$sql8." and unidadProgramador =" . $laUnidad ;
...
//24Abr2008
//Determina si ya hay asignación de recursos para el proyecto o no y de esta manera habilitar o no los botones de ingreso de información
$existeAsignaRec = 0 ;
$SqlV="select sum(cuantos) hayAsignaRec from ( ";
$SqlV=$SqlV." SELECT COALESCE(COUNT(*), 0) cuantos FROM ProgAsignaRecursos ";
$SqlV=$SqlV." where id_proyecto = " . $cualProyecto ;
$SqlV=$SqlV." and unidadProgramador =" . $laUnidad ;
$SqlV=$SqlV." union ";
$SqlV=$SqlV." SELECT COALESCE(COUNT(*), 0)  cuantos FROM ProgAsignaRecursosUsu ";
$SqlV=$SqlV." where id_proyecto = " . $cualProyecto ;
$SqlV=$SqlV." and unidadProgramador =" . $laUnidad ;
$SqlV=$SqlV." union ";
$SqlV=$SqlV." SELECT COALESCE(COUNT(*), 0) cuantos FROM ProgAsignaRecursosCat ";
$SqlV=$SqlV." where id_proyecto = " . $cualProyecto ;
$SqlV=$SqlV." and unidadProgramador =" . $laUnidad ;
$SqlV=$SqlV." ) A ";
$cursorV = mssql_query($SqlV);
if ($regV=mssql_fetch_array($cursorV)) {	 
	$existeAsignaRec = $regV[hayAsignaRec] ;
}
...
$sqlB=$sqlB." AND B.unidadProgramador =" . $laUnidad ;
...
Programaci&oacute;n de personal - Suma Global </div>
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right"><input name="Submit9" type="submit" class="Boton" onclick="MM_goToURL('parent','ProgDivisionRec.php?cualProyecto=<? echo $cualProyecto; ?>');return document.MM_returnValue" value="Ir a Asignaci&oacute;n por Recursos" /></td>
      </tr>
    </table>
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <? } ?>
        ...
        <? if ($existeAsignaRec == 0) { // Para determinar qi ya hay asignación de recursos ?>
		<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla">
			<? if (trim($pfechaInicio == "")) { ?>
			<input name="Submit" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivProy.php?cualProyecto=<? echo $cualProyecto; ?>','vAdPP','scrollbars=yes,resizable=yes,width=500,height=200')" value="Ingresar" />
			<? } 
			else { ?>
            <input name="Submit4" type="submit" class="Boton" onclick="MM_openBrWindow('upProgDivProy.php?cualProyecto=<? echo $cualProyecto; ?>','vUPPD','scrollbars=yes,resizable=yes,width=500,height=200')" value="Modificar" />
            <? 
			//Muestra el botón eliminar si no existen usuarios con programación
			if ($pExisteUsuarios == 0) { ?>
			<input name="Submit5" type="submit" class="Boton" onclick="MM_openBrWindow('delProgDivProy.php?cualProyecto=<? echo $cualProyecto; ?>','vDPD','scrollbars=yes,resizable=yes,width=500,height=200')" value="Eliminar" />
			<? } ?>
			<? } ?>
			</td>
          </tr>
        ...
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
         ...
         <? while ($reg4=mssql_fetch_array($cursor4)) {  ?>
          <tr class="TxtTabla">
            ...
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivUsu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=500,height=350')" /></a>
			<? } ?>
			</td>
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivUsu.php?cualProyecto=<? echo $cualProyecto; ?>&cualUnidad=<? echo $reg4[unidad] ; ?>','vUpDU','scrollbars=yes,resizable=yes,width=600,height=350')" /></a>
			<? } ?>
			</td>
          </tr>
		<? } ?>  
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla">
			<input name="Submit10" type="submit" class="Boton" onclick="MM_openBrWindow('verProgTodos.php?cualProyecto=<? echo $cualProyecto; ?>','winProgTodos','scrollbars=yes,resizable=yes,width=700,height=400')" value="Ver Programaci&oacute;n " />
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<input name="Submit6" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivUsu.php?cualProyecto=<? echo $cualProyecto; ?>','vadDP','scrollbars=yes,resizable=yes,width=500,height=350')" value="Ingresar" />
			<input name="Submit7" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivLibera.php?cualProyecto=<? echo $cualProyecto; ?>','vaPL','scrollbars=yes,resizable=yes,width=500,height=100')" value="Liberar Programaci&oacute;n" />
			<? } ?>
			</td>
          </tr>
        </table>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr class="TxtTabla">
            ...
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/actualizar.jpg" alt="Modificar" width="19" height="17" border="0" onclick="MM_openBrWindow('upProgDivCD.php?cualProyecto=<? echo $cualProyecto; ?>&cualCosto=<? echo $reg6[secuencia] ; ?>','vUpPDCD','scrollbars=yes,resizable=yes,width=500,height=100')" /></a>
			<? } ?>
			</td>
            <td width="1%">
			<? if ($pliberar <> 1) { // Para establecer si ya se liberó la programación ?>
			<a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onclick="MM_openBrWindow('delProgDivCD.php?cualProyecto=<? echo $cualProyecto; ?>&cualCosto=<? echo $reg6[secuencia] ; ?>','vUpPDCD','scrollbars=yes,resizable=yes,width=500,height=100')" /></a>
			<? } ?>
			</td>
          </tr>
		  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla"><input name="Submit8" type="submit" class="Boton" onclick="MM_openBrWindow('addProgDivCD.php?cualProyecto=<? echo $cualProyecto; ?>','vPCD','scrollbars=yes,resizable=yes,width=500,height=100')" value="Ingresar" /></td>
          </tr>
        </table>
		<? } ?>
		<? } //if liberar ?>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="TituloUsuario">Bit&aacute;cora</td>
          </tr>
        </table>
        <table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr class="TituloTabla2">
		  ...
		  <tr class="TxtTabla">
            ...
            <td width="15%"><? echo ucfirst(strtolower($regB[apellidos])) . ", " . ucfirst(strtolower($regB[nombre])) ; ?></td>
