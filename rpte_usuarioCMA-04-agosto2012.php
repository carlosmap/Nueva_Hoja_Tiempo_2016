<?php
	...
	$indi=0;
	$sql2="select distinct Year(fechaIngreso) as ano  from Usuarios where fechaIngreso is not null order by (ano)";
...
if((isset($ano))) //verificamos si la variable ha sido creada para cargar los datos predefinidos que se cargaran al consultar la pagina
{
...
<table align="center" border=0 width="100%">
  ...
  <tr> 
    ...
    <td class='TxtTabla' align='center'> <?php echo $usu_activos; ?></td>
  </tr>
     <tr>
     	<td class="TituloTabla">Busqueda por a&ntilde;o</td>
        <td class="TxtTabla" align="center"><select name="Anoss" id="Anoss" onChange="document.form1.submit();">
        <?php	
  ...
  <tr>
	...
	<?php
		...
		echo "<tr><td rowspan=13 class='TxtTabla' align='center'>".$ano."</td>";	
		$mes2=1;

		while($mes2<=12)
		{
			echo "<tr class='TxtTabla' align='center'><td >".$meses_ano[$mes2]."</td>";
			...
			{
				echo "<td class='TxtTabla' align='center'>".$dato5["canti_ingresos"]."</td>";
			}
			...
			{
				echo "<td class='TxtTabla' align='center'>".$dato6["canti_retiro"]."</td></tr>";				
			}
		...
		echo "<tr> <td class='TxtTabla'>&nbsp;</td> 
		<td class='TituloTabla2' align='center'>Total</td> <td class='TxtTabla' align='center'>".$cantidad_ingresos."</td>";
		echo "<td class='TxtTabla' align='center'>".$cantidad_retiros."</td></tr>";
	  ?>
