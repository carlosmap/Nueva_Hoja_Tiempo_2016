...
<form action="HtiempoElBuey.php" method="post" name="frm">
...
echo "<tr ><td class='tituloTabla'><b>Proyecto:</td><td class='txtTabla'>Proyecto Hidroeléctrico El Buey</td></tr>";
...
$sql="SELECT RTRIM(localizacion) + '-' + RTRIM(cargo) AS codigoproyecto, cargo,
		...
		WHERE     (fecha BETWEEN $cadfecha) AND (unidad = '$laUnidad') and RTRIM(localizacion) + '-' + RTRIM(cargo) <> '1-1199' and id_proyecto = 627  and cargo=200 order by dia";
