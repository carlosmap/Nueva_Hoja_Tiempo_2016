	  ...
	  <? } ?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<? } ?>
			<input name="Submit4" type="submit" class="Boton" onclick="MM_openBrWindow('addPrograma.php?cualProyecto=<? echo $cualProyecto ; ?>&cualActividad=<? echo $cualActividad ; ?>','verAdP','scrollbars=yes,resizable=yes,width=580,height=280')" value="Insertar" /></td>
          </tr>
        </table></td>
      </tr>
    </table>
