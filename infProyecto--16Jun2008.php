...
//		echo "<br>" 
		...
		?>
			...
			?>
		<a href="#"><img src="img/images/imgFiles.gif" alt="Definir Estructura de nombre de archivos para el proyecto" width="14" height="14" border="0" onclick="MM_openBrWindow('addEstrucNombreArchivo.php?cualProyecto=<? echo $reg[id_proyecto]; ?>','adEstNA','scrollbars=yes,resizable=yes,width=500,height=300')" /></a>
		<? } // if session?>
		<? }
		else {
		?>
		<a href="#"><img src="img/images/Si.gif" alt="Ver Estructura definida para el archivo" border="0" onclick="MM_openBrWindow('verEstrucNombreArchivo.php?cualProyecto=<? echo $reg[id_proyecto]; ?>','adEstNA','scrollbars=yes,resizable=yes,width=500,height=300')" /></a>
		<? } // else ?>
		</td>
	  </tr>
	  <? } ?>
