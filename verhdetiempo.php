...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><input name="Submit2" type="submit" class="Boton" onclick="MM_goToURL('parent','frm-GrabaTiempo.php');return document.MM_returnValue" value="P&aacute;gina principal Hoja  de tiempo" />
    &nbsp;&nbsp;<input name="BotonReg" type="submit" class="Boton" id="BotonReg" onclick="MM_callJS('history.back()')" value="Listado de usuarios" />&nbsp;&nbsp;
<?
//El botón sólo aparec si la Hoja de tiempo no ha sido aprobada por el jefe
//if ($muestraBoton == 0) {

//7Feb2008
//PBM el boton solo aparece si contrayos no ha aprobado
if ($muestraContratos == 0) {
?>    <input name="BotonHT" type="submit" class="Boton" id="BotonHT" onclick="MM_openBrWindow('upAutorizaHTjefe.php?cualUnidad=<? echo $verUnidadDe; ?>&cualMes=<? echo $Flmes; ?>&cualAno=<? echo $Flano; ?>','vUPjef','scrollbars=yes,resizable=yes,width=400,height=250')" value="Tr&aacute;mite de Aprobaci&oacute;n" />
	<? } ?>
<?
//Para que este botón solo le aparezca a Janeth Mahecha
if ($laUnidad == 13925) {
//El botón sólo aparec si la Hoja de tiempo no ha sido aprobada por el jefe
if ($muestraBoton == 0) {
?>
<input name="Submit" type="button" class="Boton" onclick="MM_openBrWindow('addAutorizaHT2.php?cualAno=<? echo $Flano ; ?>&cualMes=<? echo $Flmes ; ?>&cualUnidad=<? echo $verUnidadDe; ?>','vAut','scrollbars=yes,resizable=yes,width=400,height=150')" value="Especificar Jefe Inmediato-Revisión" />
<? } 
}
?>
   	</td>
