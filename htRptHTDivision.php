...
<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr>
	        <td width="15%" height="20" class="FichaInAct"> <a href="htPlanProyectoConsolidadoDiv.php?division=<?=$pDivision; ?>&departamento=<?=$miDpto ?>&categoria=<?=$pFiltro ?>&empleado=<?=$empleado ?>" class="FichaInAct1" >Divisi&oacute;n VS Proyectos</a>
<td width="15%" height="20" class="FichaInAct" > <a href="htPlanProyectoConsolidadoProy.php?division=<?=$pDivision; ?>&departamento=<?=$miDpto ?>&categoria=<?=$pFiltro ?>&empleado=<?=$empleado ?>" class="FichaInAct1" >Usuarios por Proyecto</a></td>
    	    <td width="15%" height="20" class="FichaInAct" ><a href="htPlanProyectoConsolidadoUsu.php?division=<?=$pDivision; ?>&departamento=<?=$miDpto ?>&categoria=<?=$pFiltro ?>&empleado=<?=$empleado ?>" class="FichaInAct1" >Usuarios por Divisi&oacute;n</a></td>
    	    <td width="15%"    class="FichaInAct"><a href="htPlanProyectoFacturacionProy.php?division=<?=$pDivision; ?>&departamento=<?=$miDpto ?>&categoria=<?=$pFiltro ?>&empleado=<?=$empleado ?>" class="FichaInAct1" >Facturaci&oacute;n por Proyecto</a></td>

    	    <td width="15%"    class="FichaInAct"><a href="htReporFactHT.php?pDivision=<?=$pDivision; ?>&pDepto=<?=$miDpto ?>&pCategoria=<?=$pFiltro ?>&lstVigencia=<?=$lstVigencia ?>" class="FichaInAct1" >Facturaci&oacute;n por Divisi&oacute;n</a></td>
    	    <td width="15%"    class="FichaAct">Hoja de tiempo por División</td>
	  ...
	  <tr valign="top" class="TxtTabla">
        ...
        <?
			...
			*/
			...
			if($fProyectos=='')
			{
			$sqlNomProye = 'SELECT DISTINCT B.nombre, A.id_proyecto, A.unidad, A.vigencia, A.mes, A.esInterno, B.codigo ,B.cargo_defecto 
							FROM FacturacionProyectos A, Proyectos B
							WHERE 
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr class="TituloTabla2">
            ...
            ?>
                    ...
                    <td width="40%" valign="top"><?="[".$rwNomProye[codigo].".".$rwNomProye[cargo_defecto]."] ".$rwNomProye[nombre].'.<br />'	?></td>
                    ...
                    <?
						...
						{
							echo ucwords( strtolower(trim($rwEncProye[nombre])).' '.strtolower(trim($rwEncProye[apellidos])) ).'<br />';
						}
                    ?>
                    </td>
				</tr>
