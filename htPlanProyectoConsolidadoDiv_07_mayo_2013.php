...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="TxtNota2" style="position:absolute; left:3px; top:55px; width: 639px; height: 30px;"> CONSOLIDADO POR DIVISION
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          <tr>
	        <td width="15%" height="20" class="FichaAct">Divisi&Oacute;n VS Proyectos    	    <td width="15%" height="20" class="FichaInAct" > <a href="htPlanProyectoConsolidadoProy.php" class="FichaInAct1" >Usuarios por Proyecto</a></td>
          ...
          <tr class="TxtTabla" >
            ...
            <td width="40%" rowspan="2"   align="center">
              <table width="100%" border="0" cellpadding="0" cellspacing="1">
				<tr>
					<td width="20%" align="left" class="TituloTabla">Divisi&oacute;n</td>
					<td align="left">
...
?>
                ...
                <tr>
<td width="20%"  align="left" class="TituloTabla">Departamento</td>
...
?>
          ...
          <tr class="TxtTabla" >
            <td width="20%"  align="left" class="TituloTabla">Categoria</td>
...
?>
          ...
          <tr class="TxtTabla" >
            <td width="20%" align="left" class="TituloTabla">Empleado</td>
                ...
                <? 
					...
					while($datos_emple=mssql_fetch_array($cursor3))
					{
						...
						if($datos_emple["unidad"]==$empleado)
							$sel="selected";
				?>
                	  <option value="<? echo $datos_emple["unidad"]; ?>" <? echo $sel; ?> > <? echo $datos_emple["apellido"]." ".$datos_emple["nom_usu"]."[".$datos_emple["unidad"]."] "; ?></option>
                <? 	} ?>
                </select></td>
          </tr>
...
?>
              <tr>
                ...
                <td width="5%" rowspan="3" class="TxtTabla"><? echo $datos_usuarios_planeados["categoria"]; ?></td>
