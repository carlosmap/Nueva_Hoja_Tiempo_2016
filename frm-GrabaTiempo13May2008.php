      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td width="22%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
            ...
            <? if (($laUnidad == 12974) OR ($laUnidad == 20400) OR ($laUnidad == 14384) OR ($laUnidad == 15340) ) { ?>
			<tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
			...
			if (($laUnidad == 12974) OR ($laUnidad == 20400) OR ($laUnidad == 15320) OR ($laUnidad == 14384)) { ?>
			<tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
			...
			if (($_SESSION["sesUnidadUsuario"] == 12974 ) OR ($_SESSION["sesUnidadUsuario"] == 20400 ) ) {
			?>
            <tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
			...
			if (($_SESSION["sesUnidadUsuario"] == 12974 ) OR ($_SESSION["sesUnidadUsuario"] == 20400 ) OR ($_SESSION["sesUnidadUsuario"] == 14194 )) {
			?>
            <tr>
              <td class="menu"><img src="img/images/mnuFlecha.gif" width="12" height="13" /></td>
