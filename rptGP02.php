...
$sql=$sql." and P.id_coordinador *= C.unidad ";
$sql=$sql." and P.id_estado = 2  ";
$sql=$sql." and P.id_proyecto not in (56, 60, 61, 62, 63, 64, 65, 546, 359) ";
$sql=$sql." AND (CAST(P.codigo AS int) >= 81 AND CAST(P.codigo AS int) <= 87 ) ";
...
if (trim($pMes) != "") {
	$sql=$sql." and Month(P.fechaCrea) =" . $pMes ;
}

if (trim($pAno) != "") {
	$sql=$sql." and Year(P.fechaCrea) =" . $pAno ;
}

$cantDias= 0;
if (trim($pUltSemana) != "") {
	$cantDias= $pUltSemana * 8 ;
	$sql=$sql." and P.fechaCrea between DATEADD(day, -".$cantDias.", GETDATE()) and GETDATE()  " ;
}
...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
      ...
      Activos</a> </td>
        <td width="15%"  class="FichaAct">Propuestas <br />
      Activas </td>
        <td width="15%" bgcolor="#FFFFFF" class="FichaInAct"> <a href="rptGP03.php" class="FichaInAct1">Proyectos<br />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <? } ?>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Propuestas activas</td>
  </tr>
</table>
