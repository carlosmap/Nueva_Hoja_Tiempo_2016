...
/*
		...
		$sql_parti="
			...
			inner join ParticipantesActividad on PlaneacionProyectos.unidad=ParticipantesActividad.unidad 	and 
...
*/
			...
			(
				select distinct(PlaneacionProyectos.unidad),PlaneacionProyectos.id_proyecto ,PlaneacionProyectos.id_actividad,  UPPER(Usuarios.nombre) nombre,UPPER(Usuarios.apellidos) apellidos,fechaRetiro,
				PlaneacionProyectos.unidad,vigencia, ParticipantesActividad.estado,PlaneacionProyectos.esInterno from PlaneacionProyectos
				 inner join Actividades on PlaneacionProyectos.id_actividad=Actividades.id_actividad and PlaneacionProyectos.id_proyecto=Actividades.id_proyecto 
				inner join Usuarios on PlaneacionProyectos.unidad=Usuarios.unidad 
				...
				where PlaneacionProyectos.esInterno='I' and PlaneacionProyectos.id_actividad=".$act." and PlaneacionProyectos.id_proyecto=".$cualProyecto." and PlaneacionProyectos.vigencia=".$V."
			)
			union
			(
				...
				inner join TrabajadoresExternos on 	 ParticipantesExternos.consecutivo=TrabajadoresExternos.consecutivo
				 where PlaneacionProyectos.esInterno='E' and PlaneacionProyectos.id_proyecto=".$cualProyecto." and PlaneacionProyectos.id_actividad=".$act."  and PlaneacionProyectos.vigencia=".$V."
			)";
...
?>
                      <tr class="TxtTabla">
                        <td width="3%" rowspan="2" align="center" ><? if(trim($datos_parti["fechaRetiro"])!="") { ?> <img src="imagenes/Inactivo.gif" title="Retirado de la compañia" /> <? } ?></td>
