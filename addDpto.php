...
if($Nombre != "") {
	...
	//Valida que el nombre del departamento exista
	...
	//Realiza la inserción del Departamento
	//Tabla:  Departamentos
	//id_departamento, nombre, id_director, id_division
	$insDep="INSERT INTO Departamentos (nombre, id_division, id_director ) " ;
	$insDep=$insDep." VALUES ( " ;
	$insDep=$insDep." '" . $Nombre . "', "  ;
	$insDep=$insDep.$miDivision . ", "  ;
	if (trim($pJefe) == "") {
		$insDep=$insDep."NULL" ;
	}
	else {
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Ingreso de Departamentos </td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    ...
    <td width="68%" class="TxtTabla">
      ...
      <input name="miDivision" type="hidden" id="miDivision" value="<? echo $cualDivision; ?>">
      <input name="miDependencia" type="hidden" id="miDependencia" value="<? echo $cualDependencia; ?>"></td>
  </tr>
  <tr>
