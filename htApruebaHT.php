...
$sql_aprobados=$sql." and  ( validaJefe IS NULL or validaJefe=0 ) ";
...
Aprobaci&oacute;n de la Hoja de Tiempo</div>
...
?>          <img src="imagenes/Inactivo.gif" width="20" height="22" title="Retirado de la compa&ntilde;ia" />
          <?
			}
?></td>
...
//		if (trim($reg[validaJefe]) != "") {
		if ( (trim($reg[validaJefe]) != "") AND (trim($reg[validaContratos]) != "1")) {
...
<!--			
				<input name="BotonReg" type="submit" class="Boton" id="BotonReg" value="P&aacute;gina Principal Hoja de tiempo" />
-->
<?
//echo $cant_aproba." ---- ";
