    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td class="TxtTabla"> [LT1.1] ACTIVIDADES DE SOPORTE A LA GERENCIA DEL PROYECTO </td>
        </tr>
        <tr>
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="TituloTabla2">DIVISI&Oacute;N / ACTIVIDAD </td>
        </tr>
      ...
      <tr class="TxtTabla">
        ...
        <td width="5%" align="center"><input name="pNombre<? echo $r; ?>" type="text" class="CajaTexto" id="pNombre<? echo $r; ?>"  size="10"  ></td>
