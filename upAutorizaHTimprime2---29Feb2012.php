...
/*		echo ("<script>window.close();MM_openBrWindow('ContratosHTAprob.php?pMes=$elMes&pAno=$elAno','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=*,height=*');</script>");*/
		echo ("<script>window.close();MM_openBrWindow('ContratosHTAprob.php?pMes=$elMes&pAno=$elAno#ancla$laUnidadUsu','winHojaTiempo','toolbar=yes,scrollbars=yes,resizable=yes,width=*,height=*');</script>");
}
