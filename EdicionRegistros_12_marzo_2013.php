...
<body bgcolor="#EAEAEA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="TxtNota1" style="position:absolute; left:258px; top:11px; width: 365px;">
		<div align="center"> EDICIÓN DE REGISTROS </div>
	</div>
...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	<TR><TD> </TD></TR>
	<TR><TD> </TD></TR>
     <td class="TituloUsuario">Corrección de eventuales errores en el ingreso de los datos de facturaci&oacute;n </td>
</table>
...
if($ConsultarDatos=="Consultar"){
	...
	if ($difMkt <= 5529600){
		...
		if($NumReg<=0){
			...
			echo "<tr><td>En la fecha $timestamp se encontraron $NumReg registros. Seleccione el que desea actualizar:</td></tr>";
			echo "<tr><td> </td></tr>";
			echo "<tr><td> </td></tr>";
			echo "</table>";
			echo "<table class='TxtTabla'>";
			while($reg = mssql_fetch_array($rpta)){
				...
				echo "<tr><td>$i) <a href='EdicionRegistros-2.php?idPry=$idPry&&idAct=$idAct&&idLoc=$idLoc&&idCar=$idCar&&idCtp=$idCtp&&fecha=$timestamp'>$idRst</a> ($timestamp)</td></tr>";
				$i++;
			}
			echo "</table>";
		}
	}else{
		echo "<script>alert('No esta permitido modificar la información con más de dos meses de antigüedad')</script>";
	}
}
?>
</div>
