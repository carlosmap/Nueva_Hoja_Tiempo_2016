...
function envia0()
{
	...
	if((document.Form1.Lote_control.value == '')&&(document.Form1.Lote_trabajo.value == '')&&(document.Form1.Division.value == '')&&(document.Form1.Actividad.value == ''))
	{
                        ...
                        <td colspan="17" align="left" >
							<table width="100%">
								...
								<? $ll=0; while( $ll<((int)$datos_act_edt["nivel"]) ){ echo " &nbsp;"; $ll++; } echo $macros; ?>
									...
									<td width="10%">Fecha Finalización</td> <td width="10%" class="TxtTabla"><? echo date("M d Y ", strtotime ($datos_act_edt["fecha_fin"])); ?></td>
							  </tr>
							</table>
						</td>
                      </tr>
...
<?php
	...
	if(($reg_encontrados=="No")&&($recarga==1))
	{
