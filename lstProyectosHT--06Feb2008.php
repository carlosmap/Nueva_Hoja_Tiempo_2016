...
<?		}		?>
        ...
        <td width="5%"><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','lstProyectosHTDetalle.php?cualProyecto=<? echo $reg[id_proyecto]; ?>');return document.MM_returnValue" value="Detalle" /></td>
        </tr>
...
<?		}		?>
	    ...
	    <td>
		<input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','lstProyectosHTDetalle.php?cualProyecto=42');return document.MM_returnValue" value="Detalle" />
		</td>
	    </tr>
