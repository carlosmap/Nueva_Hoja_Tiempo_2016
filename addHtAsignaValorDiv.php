    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        ...
        <tr class="TxtTabla">
          ...
          <td align="center"><input name="valReal<? echo $r; ?>" type="text" class="CajaTexto" id="valReal<? echo $r; ?>" onKeyPress="return acceptNum(event)"></td>
          <td align="center"><input name="valAsignado<? echo $r; ?>" type="text" class="CajaTexto" id="valAsignado<? echo $r; ?>" onKeyPress="return acceptNum(event)"></td>
        </tr>
		<? 
		$r = $r+1;
		} ?>
