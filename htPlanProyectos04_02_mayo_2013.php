...
//echo $sql_proyecto_valor_total."<br>".mssql_get_last_message();
	...
	$datos_divs=mssql_fetch_array(mssql_query("select  SUM(valor) as valor_planeado_divisiones FROM HojaDeTiempo.dbo.Actividades WHERE id_proyecto = ".$cualProyecto." and nivel=3"));
		...
		$val_proye=0;
          ...
          <tr class="TxtTabla" >
			<td valign="top" width="35%" >
        	    ...
        	    <td  align="center" colspan="4"><img src='grafico.php?val_proy=<?=$val_proye ?>&val_fact=<?=$val_proye; ?>&val_planea=<?=$val_planea; ?>&titulo=<?='Vl proyecto vs Vl planeado vs Vl facturado ' ?>' border='0' width="775" height="289" />
			<?php //$url=
                        ...
                        ?>
                                 <tr class="TxtTabla">
                                   ...
                                   <td align="right" >$<? echo  number_format($val_asignado[$i], "2", ",", "." ); ?></td>
                                        ...
                                        <td width="10%" align="right">$<?php 	echo $val_facturado[$i]; ?>                                        </td>		
                    </tr>
                    <?
                            }
                            $i++;
                                                                ...
                                                                <td>
                                                                    <table width="100%"  cellspacing="1" cellpadding="1" border="0" >
                                                                        <tr class="TituloTabla2">
                                                                                <?php
/*
                                                                                    //SIGNA LOS IDENTIFICADORES A LAS DIVISIONES, PARA MOSTRA LOS ID EN LA GRAFICA
                                                                                    $id_div=1;
                                                                                    mssql_data_seek($cur_div_asignado,0);
                                                                                    while($datos_div_asignado=mssql_fetch_array($cur_div_asignado))
                                                                                    {
                                                                                    ?>
                                                                                        <td >
                                                                                        <?  echo  $id_div.".".strtoupper($datos_div_asignado["nombre"]); ?>
                                                                                        </td>
                                                                                    <?php
                                                                                        if(($id_div%7)==0)
                                                                                        {
...
-->
			  ...
			  <tr>
			    <td colspan="2" class="TxtTabla2">&nbsp;</td>
		      </tr>
			  <tr>
...
?>
			  <tr valign="top" >
			    <td width="35%" valign="top" class="TxtTabla"><table width="100%" border="0" cellpadding="0" class="TituloUsuario">
			      <tr>
			        <td>&nbsp;</td>
		          </tr>
			      </table>
			     <table width="100%">
			        ...
			        <td class="TituloTabla2" width="35%" >Fecha de Inicio </td>
                            <td width="30%" align="right" class="TxtTabla"><? echo date("M d Y" , strtotime( $fecha_inicio ));  ?></td>
                            <td class="TituloTabla2" width="35%" >&nbsp;  </td>
                    </tr>
                

                          <tr class="TxtTabla">
                            <td class="TituloTabla2" width="35%" >Fecha Finalizaci&oacute;n (Maxima fecha actividad)</td>
                            <td width="30%" align="right"><? echo date('M d Y', strtotime( $fecha_finalizacion));  ?></td>
                            <td class="TituloTabla2" width="35%" >&nbsp;  </td>
                          </tr>
                          <tr class="TxtTabla">
                            <td class="TituloTabla2" width="35%" >Fecha Actual</td>
                            <td width="30%" align="right"><?  echo date("M d Y" , strtotime( $fecha_actual));   ?></td>
                            <td class="TituloTabla2" width="35%" >ghghgh  </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
			    ...
			    <td width="65%" ><table width="100%" class="TxtTabla">
			      <tr>
			        <td width="65%" rowspan="<? echo $cant_filas; ?>"  align="center"><?php
                                                    $nom_divs=array_url($nom_div);
                                                    $val_planeados=array_url($val_planeado);
                                                    $val_facturados=array_url($val_facturado);
                                    ?>
...
-->
			            <tr>
			              <td width="65%"><img src='grafico3.php?duracion=<?=$cant_meses; ?>&m_transcurridos=<?=$cant_meses_transcurridos; ?>&amp;titulo=<?='Valor planeado Vs Facturado por Divisi&oacute;n ' ?>' border='0' width="765" height="329" /></td>
		                </tr>
		              </table></td>
			        <?  
			...
			<tr>
			  <td colspan="2" class="TxtTabla">Sumatoria de facturaci&oacute;n y viaticos por Categoria
		     </td>
			  </tr>
            </table>		
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
