    ...
    <td bgcolor="#FFFFFF">
	    ...
	    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
		  ...
		  <tr class="TxtTabla">
            ...
            <td width="1%"><a href="#"><img src="img/images/Del.gif" alt="Eliminar" width="14" height="13" border="0" onClick="MM_openBrWindow('delHorarioFechasEspProy.php?cualHorario=<? echo $pIDhorario; ?>&cualFecha=<? echo $miFecha; ?>&cualProy=<? echo $cualProy; ?>','vdFE','scrollbars=yes,resizable=yes,width=400,height=250')"></a></td>
          </tr>
		  <? } ?>
        </table>		
	    ...
	    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="TxtTabla"><input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addHorarioFechasEspProy.php?cualHorario=<? echo $pIDhorario; ?>&cualProy=<? echo $cualProy; ?>','adFE','scrollbars=yes,resizable=yes,width=400,height=300')" value="Ingresar"></td>
          </tr>
        </table>
		</td>
  </tr>
