...
$sql=$sql." where id_dependencia = " . $cualDependencia ;
...
if($miDependencia != "") {
	//Realiza la eliminación de la dependencia
	//Tabla:  Dependencias
	//id_dependencia, nombre, id_director
	$insDep="DELETE FROM Dependencias " ;
	$insDep=$insDep." WHERE id_dependencia = " . $miDependencia ;
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td colspan="2" align="center" class="TxtTabla"><strong>&iquest;Est&aacute; seguro que desea eliminar este registro?</strong></td>
    </tr>
  <tr>
