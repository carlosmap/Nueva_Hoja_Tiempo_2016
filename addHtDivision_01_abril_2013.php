...
//	echo $sql_val_div_lt."<br>".mssql_get_last_message()." --- ".$val_asig_div."-".$val_div_lt."<br>";	
	...
	//SI LOS VALORES DE LAS DIVISIONES CUMPLEN LAS CONDICIONES, SE REGISTR LA INFORMACION DE TODAS LAS DIVISIONES
	else
	{	
		$s=1;
		...
		while ($s <= $pCantReg) {
			...
			$sqlIn1 = $sqlIn1 . " '3' ,".$_SESSION["sesUnidadUsuario"].",getdate()  ";
			if(trim(${$valor})!="")
			{
