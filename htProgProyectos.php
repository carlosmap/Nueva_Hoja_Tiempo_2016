    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  ?>
	   <tr class="TxtTabla">
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right"><input name="Submit" type="submit" class="Boton" onclick="MM_goToURL('parent','htProgProyectos01.php?cualProyecto=<? echo $reg[id_proyecto]; ?>');return document.MM_returnValue" value="Gesti&oacute;n del Proyecto" /></td>
          </tr>
          <tr>
            <td align="right">&nbsp;</td>
          </tr>
