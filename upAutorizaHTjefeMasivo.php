...
*/
	...
	if  (trim($cursor) != "") {
		...
		echo ("<script>alert('No se llevó a cabó ninguna grabación');</script>");
	};
...
//		@mssql_select_db("HojaDeTiempo",$conexion);
  ...
  <tr>
    <td colspan="2" class="TxtTabla"><strong>Hay <? echo $cantVoBoPendiente; ?> hojas de tiempo por aprobar. Está seguro que quiere aprobar TODAS las Hojas de tiempo? </strong></td>
    </tr>
  <tr>
