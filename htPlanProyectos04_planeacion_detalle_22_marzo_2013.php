	...
	<form name="Form1" id="Form1" method="post" action="">
      ...
      <tr>
        ...
        <table  width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
	        <td width="15%" height="20" class="FichaAct"><a href="htPlanProyectos04.php?cualProyecto=<? echo $cualProyecto; ?>" class="FichaInAct1" >Valores</a>
    	    <td width="15%" height="20" class="FichaInAct" >PLANEACI&Oacute;N</td>
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
          ...
          <tr class="TxtTabla" >
            <td width="30%"  align="center"></td>
            <td width="20%" rowspan="2"  align="center" class="TituloTabla2">Lote de Control</td>
            <td width="10%" rowspan="2"  align="left"><label for="LC"></label>
...
?>
                <input type="text" class="CajaTexto" value="<? echo strtoupper("[".$datos_lote_lc["macroactividad"]."] ".$datos_lote_lc["nombre"]); ?> " size="50"  readonly="readonly" >
                <?
						}
...
?>
          ...
          <tr class="TxtTabla" >
            <td width="30%" rowspan="6"  align="center"></td>
          </tr>
          <tr class="TxtTabla" >
...
?>
              <input type="text" class="CajaTexto" value="<? echo strtoupper("[".$datos_lote_lt["macroactividad"]."] ".$datos_lote_lt["nombre"]); ?>" size="50" readonly > </option>
              <?
						}
?>
           </td>
...
?>
              <INPUT type="text" class="CajaTexto" value="<? echo strtoupper("[".$datos_div["macroactividad"]."] ".$datos_div["nombre"]); ?> " size="50"  readonly="readonly" />
              <?
						}
?>
           </td>
          ...
          <tr class="TxtTabla" >
            ...
            <td  align="left">
              <?
						...
						{
?>
              <input type="text" class="CajaTexto" value="<? echo strtoupper("[".$datos_act["macroactividad"]."] ".$datos_act["nombre"]); ?>" size="50" readonly="readonly" >
              <?
						}
						else
			   	    	  echo '   <input type="text" class="CajaTexto" value="" size="50" readonly="readonly" > ';
...
?>
          ...
          <tr class="TxtTabla" >
        	    ...
        	    <td colspan="4"  align="left"><a href="htPlanProyectos04_planeacion.php?cualProyecto=<?=$cualProyecto; ?>&Lote_control=<?=$LC ?>&Lote_trabajo=<?=$LT ?>&Division=<?=$DIV; ?>&Actividad=<?=$ACT ?>" class="menu">&lt;&lt; Regresar a la planeaci&oacute;n</a></td>
        	    </tr>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="4" align="left" class="TituloUsuario"><p>.: Planeaci&oacute;n Actividad</p></td>
          </tr>
          <tr>
