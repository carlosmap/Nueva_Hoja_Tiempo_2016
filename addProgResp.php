...
if ($elProyecto != "") {
	...
	if (trim($pJefe) == "") {
		...
		//Realiza la inserción de los responsables de la actividad
		$query = "INSERT INTO ResponsablesActividad(id_proyecto, id_actividad, unidad) " ;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="TituloUsuario">Programación de Proyectos - Responsable de la actividad </td>
  </tr>
</table>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="25%" class="TituloTabla">Responsable  del proyecto </td>
