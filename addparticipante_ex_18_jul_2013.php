...
if(trim($recarga) == "2")
{
	...
	$sql_verif="select * from ParticipantesExternos where id_proyecto=".$cualProyecto." and id_actividad=".$id_ac." and consecutivo=".$usuario;
	$cur_veri=mssql_query($sql_verif);	
//echo $sql_verif." <br> ".mssql_get_last_message()." ***** ".mssql_num_rows($cur_veri);
	if( (0< (int) mssql_num_rows($cur_veri)) &&(trim($consecutivo)!="") )
	{
