...
?>
  ...
  <tr>
	...
	<td class="TxtTabla">
    	 <input name="Submit3" type="button" class="Boton" onClick="MM_openBrWindow('Listado_report_hojatiempo.php?t=<?=$_REQUEST['lstTematica'];?>&l=<?=$_REQUEST['lstLote'];?>&r=<?=$_REQUEST['lstRev'];?>&n=<?=$_REQUEST['nombrePlano'];?>&d=<?=$_REQUEST['descrPlano'];?>','wRPT1','scrollbars=yes,resizable=yes,width=500,height=400')" value="XLS planos">
    </td>
