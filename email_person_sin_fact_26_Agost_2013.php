...
*/
	...
	$cur_division=mssql_query("select *, convert(nvarchar,getdate(),103) as fecha ,MONTH(GETDATE()) mes, year(getdate()) ano from HojaDeTiempo.dbo.Divisiones where estadoDiv='A' and id_division=14  ");
...
select DATEADD(DAY,-7, GETDATE() ) fecha_inicio_semana 
)fechas "));
...
*/
								...
								$semana_mes_ant =$dato_semana_mes_ant["No_semana_ant"];
...
//-------------------------------------
			...
			//echo $cantidad_dias_fina."**** <br><br>";
									...
									$fecha_fin_semana[$cont_semana]=$datos_fechas["fecha_fin_semana"];
										...
										$pTema2= $pTema2.'<td align="center">Semana '.$cont_semana.' <br /> 
