...
$sql00=$sql00." H.id_proyecto, P.nombre nomProyecto, H.clase_tiempo, sum(H.horas_registradas) hFacturadas, A.salarioBase, cat.nombre cate ";
$sql00=$sql00." from Horas H, Proyectos P, Asignaciones A, Usuarios U, Departamentos D, Divisiones Z, Categorias cat ";
...
$sql00=$sql00." group by H.unidad, U.nombre, U.apellidos, D.nombre, D.id_departamento, Z.nombre, Z.id_division, H.id_proyecto, P.nombre, H.clase_tiempo, A.salarioBase, cat.nombre";
$sql00=$sql00." UNION ";
$sql00=$sql00." Select H.unidad, U.nombre, U.apellidos, D.nombre nomDpto, D.id_departamento,Z.nombre nomDiv, Z.id_division, cat.nombre";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right" class="TituloTabla">Valor Facturado = (Salario / 185) * Horas Facturadas <br />
        <?php	echo $sql00;	?></td>
      </tr>
    </table>
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr class="TxtTabla">
        ...
        <td>
		<? 
			echo ucwords( strtolower( $reg00[cat] ) );  
			$categoria= ucwords( strtolower( $reg00[cat] ) ); 
			$excel.="$categoria\t"; 
		?></td>
        <td width="10%"><? echo $reg00[nomDpto]; ?>
		<? $excel.="$reg00[nomDpto]\t"; ?>
		</td>
        <td width="20%"><? echo $reg00[nomProyecto]; ?>
