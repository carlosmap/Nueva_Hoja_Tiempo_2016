...
//echo $sql_update."<br>".mssql_get_last_message()."<br><br>";
					...
					if(trim($error)=="no")
					{
						...
						$sql_elimi_viatico="delete from ViaticosProyectosHT where unidad=".$laUnidad." and mes=".$cualMes." 
							and vigencia=".$cualVigencia." and esInterno='I' ";
					...
					if(trim($error)=="no")
					{
						...
						$sql_elimi_adp="delete from  AdpHT where unidad=".$laUnidad." and mes=".$cualMes." 
...
<tr >
			...
			$sql11 = $sql11 . " AND A.vigencia = " . $cualVigencia ;
			$sql11 = $sql11 . " AND A.mes = " . $cualMes;
