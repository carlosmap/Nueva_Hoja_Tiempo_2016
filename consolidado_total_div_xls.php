...
header("Content-Disposition: attachment; filename=Consolidado_planeación_facturación_usuarios_por_division_" . $fecha . ".xls");
echo "</head>";
...
?> 
en todos los proyectos para el a&ntilde;o <?=$lstVigencia; ?> </h3></b>
</td>
